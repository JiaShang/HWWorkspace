...
<%
    ...
    boolean showIcon = isEmpty(inner.get("showIcon"));
    ...
    bodyTop = inner.pictureUrl("images/bg-2019-01-24-top.jpg", column.getPosters(), "7",0 );
    bodyLeft = inner.pictureUrl("images/bg-2019-01-24-left.jpg", column.getPosters(), "7",1 );
    bodyRight = inner.pictureUrl("images/bg-2019-01-24-right.jpg", column.getPosters(), "7",2 );
    bodyBottom = inner.pictureUrl("images/bg-2019-01-24-bottom.jpg", column.getPosters(), "7",3 );
...
<script language="javascript" type="text/javascript">
    ...
    var initialize = {
        ...
        goBack : function(){
            if( cursor.fullmode ){ cursor.call("enterSmallMode");cursor.call("show"); cursor.call("lazyShow");  return;}
        ...
        lazyShow : function(){
            ...
            cursor.calcStringPixels(text, <%= fontSize %>, function(width){
                if( cursor.blocked == blocked && width <= <%= itemWidth - 50 - 16 %> ) return;
        ...
        show : function(){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                var id = i + 1;
                if( i === played && i === focus ) {
                    if( <%= showIcon %> ) html += "<div class='itemIconFocus'></div>";
                    html += "<div class='item'>";
                    html += "<span class='itemPlayFocusedText' id='txt" + id + "'></span><span class='itemPlayed'></span>";
                } else if(i === played ) {
                    if( <%= showIcon %> )html += "<div class='itemIcon'></div>";
                    html += "<div class='item'>";
