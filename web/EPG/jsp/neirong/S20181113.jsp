...
<head>
    ...
    <style>
        ...
        .mark {width:89px;height:37px;left:43px;position:absolute;background:transparent url("images/mask-2018-11-13.png") no-repeat;background-position: 0px -220px;}

        .mark1 {top:215px;background-position: 0px -220px;}
        .mark2 {top:351px;background-position: 0px -260px;}
        .mark3 {top:488px;background-position: 0px -300px;}
        .mark4 {top:626px;background-position: 0px -340px;}

    </style>
    <script language="javascript" type="text/javascript" src="player/common.js"></script>
</head>
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2018-11-13.jpg') no-repeat left top;" onUnload="exit();">
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        show:function(){
            ...
            $("bg").style.backgroundImage = "url('images/item-2018-11-13-" + String( page ) + ".png')";
