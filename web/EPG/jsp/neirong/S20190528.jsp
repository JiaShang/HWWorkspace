...
<%
    String typeId = "10000100000000090000000000111824";
    ...
    String body = "images/bg-2019-05-28.png";
    if( column != null ) body = inner.pictureUrl(body, column.getPosters(), "7",0 );
%>
<html>
<meta name="page-view-size" content="1280*720">
<head>
    <title><%=column == null ? "考察" : column.getName()%></title>
    <style>
        .body {position: absolute;z-index:0;overflow: hidden; left:0px;top:0px;width:1280px;height:720px;}

        .major {width:479px;height:360px;position:absolute;left:104px;top:238px;overflow: hidden;}
        .majorContainer,.majorContainerFocus{width:479px;height:59px;float: left;overflow: hidden;background:transparent url('images/mask-2019-05-28.png') no-repeat;background-position: 0px 0px;}
        ...
        .flowedContainer,.flowedContainerFocus{width:882px;height:63px;float:left;overflow: hidden;background:transparent url('images/mask-2019-05-28.png') no-repeat;background-position: 0px 0px;}
        .flowedContainer {background-position:0px -242px;}
        .flowedContainerFocus {background-position:0px -152px;background-color: white;}
        ...
        .mask{position:absolute;background:transparent url('images/mask-2019-05-28.png') no-repeat;background-position: 0px 0px;}

        .mask1{width:145px;height:119px;}
        .mask11{background-position: -605px -590px;}
        .mask12{background-position: -755px -590px;}
        .mask13{background-position: -610px -737px;}
        .mask14{background-position: -760px -737px;}
        ...
        .title{width:600px;height: 60px; position: absolute; left:250px;top:165px; background:transparent url('images/mask-2019-05-28.png') no-repeat;background-position: 0px 0px;}
        .title1{background-position: -33px -1069px; }
        .title2{background-position: -33px -1069px; }
        .title3{background-position: -33px -938px; }
        .title4{background-position: -33px -1006px; }
...
<script language="javascript" type="text/javascript">
    ...
    var initialize = {
        ...
        init : function(){
            ...
            //第三个是专题连接
            cursor.focusable[0].items.insertAt(1,{'name':'爱国情 奋斗者','linkto':'/EPG/jsp/neirong/S20190423.jsp?typeId=10000100000000090000000000111561&ps=445,280,727,229&bp=385,180,210,ffffff&loop=0&pg=8&fc=cab061&split=0&mk=56,45,ff4040&fcbr=2,cab061&item=545,400,80,210,450,40,transparent,ffffff,18'});

            cursor.playIndex = cursor.focusable[0].focus;
            cursor.focusable.insertAt(3,{});
        ...
        select: function() {
            ...
            cursor.focusable[blocked].items[focus].startTime = "00:01:13";
            var item = cursor.focusable[blocked].items[focus];
            var url = '';
            if( blocked === 0 && focus !== 1) {
        ...
        show: function(){
            ...
            switch (blocked) {
                case 0 : top = 517;
                    if( focus == 0 ) left = 643;
                    else if( focus == 1 ) left = 778;
                    else left = focus == 2 ? 914 : 1050;
                    break;
                case 1 : left = 100; top = index * 59 + 231; break;
        ...
        showItems : function(blocked){
            ...
            if( blocked >= 2 ) {
                $("flowed").style.backgroundImage = 'url("images/focusBg-2019-05-28.jpg")';
