...
<%
    ...
    String area = inner.get("AREA","YZ");
    int voteId = inner.getInteger("VOTEID",0);
    String startTime = inner.get("START","01-01");
    String endTime = inner.get("END","01-01");
%>
<html>
<head>
    ...
    <style>
        .mask {width:59px;height:437px;top:214px;position:absolute;background:transparent url('images/mask-2019-06-04.png') no-repeat;background-position: -700px 0px;}
        ...
        .voteBtn{width:256px;height:51px;background-position:-700px -200px;left:0px;top:181px;overflow:hidden;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-06-04-VoteBg.jpg') no-repeat;" onUnload="exit();">
<div id="mask"></div>
...
<script language="javascript" type="text/javascript">
    ...
    var initialize = {
        ...
        init        :   function(){
            ...
            cursor.enabled = now >= "2019-<%=startTime%> 00:00:00" && now < "2019-<%=endTime%> 23:59:59";
            cursor.row = 2;
            cursor.column = 4;
            ...
            cursor.focusable[1] = {focus : 0 ,items:[ {name:'活动详情',linkto:'/EPG/jsp/neirong/S20190604Role.jsp?AREA=<%=area%>'}]};
