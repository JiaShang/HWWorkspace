...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000112240";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-08-01.jpg') no-repeat;" onUnload="exit();">
