...
<%
    ...
    String defaultPic = "images/bg-2019-04-13-Column.jpg";
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        move : function(index){
            ...
            cursor.moveTimer = setTimeout(function(){ clearTimeout(cursor.moveTimer);cursor.call('lazyShow'); cursor.moveTimer = undefined;}, 1200);
            cursor.call('show');
        },
        show:function(){
