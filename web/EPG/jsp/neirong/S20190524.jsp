    ...
    var initialize = {
        ...
        init        :   function(){
            ...
            cursor.focusable[0] = {
                ...
                items : [
                    {'name':'重庆广播教育学校渝中校区','linkto':'/EPG/jsp/neirong/S20190524Role.jsp'},
                    {'name':'重庆广播教育学校远洋校区','linkto':'/EPG/jsp/neirong/S20190524Role.jsp'},
                    {'name':'重庆广播教育学校沙坪坝校区','linkto':'/EPG/jsp/neirong/S20190524Role.jsp'}
                ]
            };
            cursor.call('show');
            cursor.call('prepare');
