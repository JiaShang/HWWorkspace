...
<%
    ...
    final String[] types = {"10000100000000090000000000105834"};
...
<head>
    <title>星球大战原力觉醒</title>
    <style>
        .mask {position:absolute;height:25px; background:transparent url('images/mask-2016-01-05.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:246px; left:64px; top:457px; background-position: 0px 0px;}
        .mask2 {width:141px; left:64px; top:494px; background-position: 0px -60px;}
        .mask3 {width:142px; left:64px; top:531px; background-position: 0px -120px;}
        .mask4 {width:142px; left:64px; top:568px; background-position: 0px -180px;}
        .mask5 {width:174px; left:64px; top:605px; background-position: 0px -240px;}
        .mask6 {width:126px; left:64px; top:643px; background-position: 0px -300px;}
        .mask7 {width:326px; left:392px; top:457px; background-position: 0px -30px;}
        .mask8 {width:374px; left:392px; top:494px; background-position: 0px -90px;}
        .mask9 {width:434px; left:391px; top:532px; background-position: 0px -150px;}
        .mask10 {width:254px; left:391px; top:569px; background-position: 0px -210px;}
        .mask11 {width:261px; left:391px; top:606px; background-position: 0px -270px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked === 0 && ( ( focus == 0 || focus == 6 ) && index == 11 || (focus === 5 || focus === 10) && index == -11 || focus <= 5 && index == -1 ) ) return;
                    if( blocked == 0 ) {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-01-05.jpg') no-repeat;" onUnload="exit();"></body>
</html>