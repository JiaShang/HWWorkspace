...
<%
    ...
    final String[] types = {"10000100000000090000000000106320"};
...
<head>
    <title>X战警 强者生存</title>
    <style>
        .mask {width:310px;height:35px;left:849px;position:absolute;background:transparent url('images/mask-2016-05-27.png') no-repeat;background-position: 0px 0px;}
        .mask1{top:82px;background-position: 0px 0px;}
        .mask2{top:128px;background-position: 0px -40px;}
        .mask3{top:173px;background-position: 0px -80px;}
        .mask4{top:218px;background-position: 0px -120px;}
        .mask5{top:265px;background-position: 0px -160px;}
        .mask6{top:310px;background-position: 0px -200px;}
        .mask7{top:357px;background-position: 0px -240px;}
        .mask8{top:403px;background-position: 0px -280px;}
        .mask9{top:450px;background-position: 0px -320px;}
        .mask10{top:495px;background-position: 0px -360px;}
        .mask11{top:540px;background-position: 0px -400px;}
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                                   "style:'mask mask" + (j + ( j <= 4 ? 1 : 2)) + "'" + "," +
                                 "playType:" + vod.getIsSitcom() ;
                            str += "}" ;
                        str += ( j + 1 < vodList.size()  ? "," : "");
                        value += str;
                        if( j == 4 ) {
                            value += "{style:'mask mask6',playType:-3,link:'http://192.168.34.81/HiFi_cq/album.html?albumId=14'},";
                        }
                    }
                    value += "]},";
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-27.jpg') no-repeat;" onUnload="exit();"></body>
</html>