...
<%
    ...
    final String[] types = {"10000100000000090000000000105367"};
...
<head>
    <title>国产动画巅峰代表</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-08-07.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{width:273px;height:27px;left:389px;top:176px;background-position: 0px 0px;}
        .mask2{width:59px;height:31px;left:694px;top:176px;background-position: 0px -360px;}
        .mask3{width:151px;height:27px;left:805px;top:179px;background-position: 0px -180px;}
        .mask4{width:59px;height:31px;left:1123px;top:181px;background-position: 0px -360px;}

        .mask5{width:202px;height:27px;left:389px;top:210px;background-position: 0px -30px;}
        .mask6{width:59px;height:31px;left:694px;top:209px;background-position: 0px -360px;}
        .mask7{width:245px;height:27px;left:805px;top:213px;background-position: 0px -210px;}
        .mask8{width:59px;height:31px;left:1123px;top:213px;background-position: 0px -360px;}

        .mask9{width:308px;height:27px;left:389px;top:244px;background-position: 0px -60px;}
        .mask10{width:59px;height:31px;left:694px;top:242px;background-position: 0px -360px;}
        .mask11{width:118px;height:27px;left:805px;top:246px;background-position: 0px -240px;}
        .mask12{width:59px;height:31px;left:1123px;top:247px;background-position: 0px -360px;}

        .mask13{width:287px;height:27px;left:389px;top:277px;background-position: 0px -90px;}
        .mask14{width:59px;height:31px;left:694px;top:274px;background-position: 0px -360px;}
        .mask15{width:316px;height:27px;left:805px;top:280px;background-position: 0px -270px;}
        .mask16{width:59px;height:31px;left:1123px;top:279px;background-position: 0px -360px;}

        .mask17{width:202px;height:27px;left:389px;top:311px;background-position: 0px -120px;}
        .mask18{width:59px;height:31px;left:694px;top:307px;background-position: 0px -360px;}
        .mask19{width:245px;height:27px;left:805px;top:313px;background-position: 0px -300px;}
        .mask20{width:59px;height:31px;left:1123px;top:312px;background-position: 0px -360px;}

        .mask21{width:87px;height:27px;left:389px;top:345px;background-position: 0px -150px;}
        .mask22{width:59px;height:31px;left:694px;top:340px;background-position: 0px -360px;}
        .mask23{width:139px;height:27px;left:805px;top:347px;background-position: 0px -330px;}
        .mask24{width:59px;height:31px;left:1123px;top:345px;background-position: 0px -360px;}
    ...
    <script language="javascript" type="text/javascript">
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                                  "style:'mask mask" + (j * 2 + 1) + "'" + "," +
                                 "playType:" + vod.getIsSitcom() ;
                            str += "}" ;
                        if(i == 0) str += ",{text:'" + vod.getName() + "',playType:-2,style:'mask mask" + ( ( j + 1 ) * 2 ) + "'}";
        ...
        var columns = 4; rows = 6;              //定义行列，　几行几列
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == 0  && (
                         ...
                         index == -11 && (focus + 1 >= focusable[blocked].items.length && arrows[0] == 0 || arrows[0] == 1 && focus + 1 != focusable[blocked].items.length && focus + columns + 1 > focusable[blocked].items.length ) //按下光标键时
                     ) ) return;
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:undefined,id:228}],video:undefined,position:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-08-07.jpg') no-repeat;" onUnload="exit();"></body>
</html>