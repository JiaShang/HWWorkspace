...
<%
    ...
    final String[] types = {"10000100000000090000000000105151"};//10000100000000090000000000105165
...
<head>
    <title>小儿手册</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-05-29.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:268px;height:44px;left:175px;top:155px;background-position: 0px 0px;}
        .mask2 {width:215px;height:40px;left:178px;top:203px;background-position: 0px -50px;}
        .mask3 {width:141px;height:35px;left:182px;top:252px;background-position: 0px -100px;}
        .mask4 {width:186px;height:37px;left:186px;top:291px;background-position: 0px -150px;}
        .mask5 {width:272px;height:42px;left:190px;top:331px;background-position: 0px -200px;}
        .mask6 {width:141px;height:35px;left:193px;top:381px;background-position: 0px -250px;}
        .mask7 {width:233px;height:41px;left:195px;top:419px;background-position: 0px -300px;}
        .mask8 {width:272px;height:43px;left:200px;top:460px;background-position: 0px -350px;}
        .mask9 {width:292px;height:44px;left:201px;top:502px;background-position: 0px -400px;}
        .mask10 {width:283px;height:59px;left:659px;top:531px;background-position: 0px -450px;}
        ...
        .page {width:70px;height:28px;left:516px;top:348px;font-size:28px;text-align:right;line-height:28px;position:absolute; color: white; }
        ...
        .phoneNumberInput{position:absolute; width:218px;height:28px; left:190px; top:118px; background-color:transparent;color:#ffffff;font-family:"宋体";font-size:28px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items : [
                {name:'百科学苑-孕产育儿',playType:-3,style:'mask mask10',link:'/EPG/jsp/defaultHD/en/zylp_list.jsp?typeId=10000100000000090000000000101511&pageLength=12'},
            ]},
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == focusable.length - 1) {
                         ...
                         if( index == 1 ) { blocked = 1;focus = 0; }
                         else if( index == 11 ) focus -= columns;
                         else if( index == -11 ) focus += columns;
                         if( focus >= focusable[blocked].items.length ) return;
                     } else {
                         blocked = ( index == 1 ? focusable.length - 1 : 0); focus = focusable[blocked].focus;
                     }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-05-29.jpg') no-repeat;" onUnload="exit();"></body>
</html>