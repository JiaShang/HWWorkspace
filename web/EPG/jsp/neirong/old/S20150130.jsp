...
<%
    ...
    final String[] types = {"10000100000000090000000000104903"};
...
<head>
<title>喜气“羊羊”看大片</title>
<style>
    .mask {position:absolute;background:transparent url('images/mask-2015-01-30.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1{width: 255px;height: 35px;left:320px; top:288px;background-position: 0px 0px;}
    .mask2{width: 161px;height: 33px;left:369px; top:328px;background-position: -49px -40px;}
    .mask3{width: 229px;height: 35px;left:337px; top:367px;background-position: -17px -79px;}
    .mask4{width: 162px;height: 35px;left:372px; top:407px;background-position: -52px -119px;}
    .mask5{width: 162px;height: 35px;left:372px; top:446px;background-position: -52px -158px;}
    .mask6{width: 128px;height: 33px;left:388px; top:486px;background-position: -68px -198px;}
    .mask7{width: 128px;height: 32px;left:388px; top:526px;background-position: -68px -238px;}
    .mask8{width: 186px;height: 35px;left:490px; top:571px;background-position: -170px -283px;}
    .mask9{width: 166px;height: 35px;left:490px; top:610px;background-position: -170px -322px;}
        ...
        if(typeof index == "number" && !initilized){
            ...
            if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                ...
                if( blocked == focusable.length - 1 && index == -1 && focus == 0 ) {
                    ...
                    if(focus > 8 && index == -11 || focus <= 0 && index == 11 || index == -1 ) return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-01-30.jpg') no-repeat;" onUnload="exit();"></body>
</html>