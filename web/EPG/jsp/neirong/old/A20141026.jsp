...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104626";
...
<head>
<title>中国好声音十大金曲</title>
<style>
    .mask {height: 36px;position:absolute;background:transparent url('images/mask-2014-10-26.png') no-repeat fixed;}
    .mask1 {width:166px;left:875px;top:346px; background-position: 0px 0px;}
    .mask2 {width:284px;left:875px;top:377px; background-position: 0px -36px;}
    .mask3 {width:264px;left:875px;top:408px; background-position: 0px -73px;}
    .mask4 {width:331px;left:875px;top:439px; background-position: 0px -109px;}
    .mask5 {width:360px;left:875px;top:471px; background-position: 0px -145px;}
    .mask6 {width:251px;left:689px;top:510px; background-position: 0px -181px;}
    .mask7 {width:191px;left:689px;top:540px; background-position: 0px -218px;}
    .mask8 {width:233px;left:689px;top:570px; background-position: 0px -254px;}
    .mask9 {width:164px;left:689px;top:599px; background-position: 0px -290px;}
    .mask10 {width:244px;left:689px;top:629px; background-position: 0px -326px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-10-26.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>