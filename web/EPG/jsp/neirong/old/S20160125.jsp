...
<%
    ...
    final String[] types = {"10000100000000090000000000105862"};
...
<head>
    <title>功夫熊猫卖萌归来</title>
    <style>
        .mask {position:absolute;height:32px;background:transparent url('images/mask-2016-01-25.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:243px;left:211px;top:210px;background-position: 0px 0px;}
        .mask2 {width:278px;left:195px;top:247px;background-position: 0px -44px;}
        .mask3 {width:250px;left:204px;top:284px;background-position: 0px -89px;}
        .mask4 {width:181px;left:843px;top:130px;background-position: 0px -133px;}
        .mask5 {width:181px;left:843px;top:161px;background-position: 0px -178px;}
        .mask6 {width:181px;left:843px;top:192px;background-position: 0px -222px;}
        .mask7 {width:181px;left:843px;top:222px;background-position: 0px -267px;}
        .mask8 {width:181px;left:843px;top:253px;background-position: 0px -311px;}
        .mask9 {width:181px;left:843px;top:284px;background-position: 0px -356px;}
        .mask10 {width:215px;left:824px;top:315px;background-position: 0px -400px;}
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked < focusable.length - 2  && (
                         index == 11 && ( focus == 0 || focus == 3) || //按上光标键时
                         index == -1 && focus <= 2 ||   //按左光标键时
                         index == 1 && focus >= 3 ||    //按右光标键时
                         index == -11 && focus == 2     //按下光标键时
                     ) ) return;
                     //TODO:当光标在首页、返回按钮上时，可同时按上，左键返回到列目中时，需要重写光标移动代码
                     if( blocked == focusable.length - 1) { blocked = 0;focus = focusable[blocked].focus; }
                     else {
                         if( index == 1) focus += 6;
                         else if( index == -1 ) { focus -= 6; if( focus < 0) focus = 0; }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-01-25.jpg') no-repeat;" onUnload="exit();"></body>
</html>