...
<%
    ...
    final String[] types = {"10000100000000090000000000105643"};
...
<head>
    <title>“老干部”的春天</title>
    <style>
        .mask {width:238px;height:33px;position:absolute;background:transparent url('images/mask-2015-11-13.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {left:572px;top:513px;background-position: 0px 0px;}
        .mask2 {left:596px;top:548px;background-position: 0px -40px;}
        .mask3 {left:619px;top:583px;background-position: 0px -80px;}
        .mask4 {left:642px;top:618px;background-position: 0px -120px;}
        .mask5 {left:664px;top:652px;background-position: 0px -160px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-11-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>