...
<%
    ...
    final String[] types = {"10000100000000090000000000105740"};
...
<head>
    <title>十大妙招助你过暖冬</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-12-15.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{width:169px;height:32px;left:592px;top:150px;background-position:0px 0px;}
        .mask2{width:289px;height:31px;left:949px;top:151px;background-position:0px -40px;}
        .mask3{width:113px;height:31px;left:592px;top:205px;background-position:0px -80px;}
        .mask4{width:281px;height:31px;left:949px;top:205px;background-position:0px -120px;}
        .mask5{width:222px;height:31px;left:594px;top:259px;background-position:0px -160px;}
        .mask6{width:253px;height:31px;left:949px;top:259px;background-position:0px -200px;}
        .mask7{width:197px;height:31px;left:592px;top:313px;background-position:0px -240px;}
        .mask8{width:225px;height:31px;left:949px;top:313px;background-position:0px -280px;}
        .mask9{width:309px;height:31px;left:592px;top:367px;background-position:0px -320px;}
        .mask10{width:225px;height:31px;left:949px;top:367px;background-position:0px -360px;}
        .mask11{width:246px;height:63px;left:985px;top:516px;background-position:0px -400px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0, items : [ {playType:-3, text:'',link:'http://192.168.35.153:8080/index.jsp',style:'mask mask11'}]},
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0  && (
                            ...
                            ) || blocked == 1 && ( index == -1 || index == 1)) return;
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:'<div style="width:250px;height:63px;left:983px;top:516px; position:absolute;"><img src="images/focusBg-2015-12-15.gif" /></div>'}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-12-15.jpg') no-repeat;" onUnload="exit();"></body>
</html>