...
<head>
    <title>青春重庆 直辖20周年</title>
    <style>
        .mask {position:absolute;background-position: 0px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-05-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>