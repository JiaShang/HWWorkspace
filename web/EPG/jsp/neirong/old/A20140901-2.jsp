...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104481";
...
<title>夏日出走吧</title>
<style>
    .mask1 {top:240px; left:407px;width:205px;height:47px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px 0px;}
    .mask2 {top:285px; left:407px;width:124px;height:39px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px -45px;}
    .mask3 {top:323px; left:407px;width:112px;height:43px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px -83px;}
    .mask4 {top:370px; left:407px;width:215px;height:43px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px -130px;}
    .mask5 {top:407px; left:407px;width:230px;height:50px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px -167px;}
    .mask6 {top:508px; left:180px;width:231px;height:45px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px -214px;}
    .mask7 {top:553px; left:180px;width:163px;height:36px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px -259px;}
    .mask8 {top:590px; left:180px;width:217px;height:43px;position:absolute;background:transparent url('images/mask-2014-09-01-2.png') no-repeat fixed 0px -296px;}
...
<script language="javascript" type="text/javascript">
    ...
    function doEnter(){
        ...
        if(blocked == 0){
            ...
            if( item.playType == 1)
                top.window.location.href = focusURL() + "/EPG/jsp/defaultHD/en/hddb/hjzq/hj_tvDetail.jsp?vodId=" + item.mid + "&typeId=" + typeId;
            else {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-09-01-2.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>