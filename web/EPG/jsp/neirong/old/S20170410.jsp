...
<%
    ...
    final String[] types = {"10000100000000090000000000107543","10000100000000090000000000107544"};
    final int[] position = {8,0,6,0};
    //TODO:每次需要修改
    int area = 1;
    String focused = "";
    ...
    try {
        ...
        if(null != focus ){
            for( int i = 0; i < focus.length; i ++ )
                focused += focus[i] + ",";
            focused = focused.substring(0, focused.length() -  1);
        }
...
<head>
    <title>双生偶像TWINS</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-04-10.png') no-repeat;background-position: 0px 0px;}

        .mv {width:131px;height:43px;left:76px;top:290px;background-position: -960px 0px;}
        .movie {width:131px;height:43px;left:207px;top:290px;background-position: -960px -50px;}
        .link {width:258px;height:64px;left:236px;top:590px;background-position: -960px -100px;}

        .item{width:233px;height:48px;}
        .item11 {left:84px;top:368px;background-position: -480px 0px;}
        .item12 {left:348px;top:368px;background-position: -720px 0px;}
        .item13 {left:84px;top:418px;background-position: -480px -50px;}
        .item14 {left:348px;top:418px;background-position: -720px -50px;}
        .item15 {left:84px;top:468px;background-position: -480px -100px;}
        .item16 {left:348px;top:468px;background-position: -720px -100px;}
        .item17 {left:84px;top:518px;background-position: -480px -150px;}
        .item18 {left:348px;top:518px;background-position: -720px -150px;}

        .item21 {left:84px;top:368px;background-position: -480px -200px;}
        .item22 {left:348px;top:368px;background-position: -720px -200px;}
        .item23 {left:84px;top:418px;background-position: -480px -250px;}
        .item24 {left:348px;top:418px;background-position: -720px -250px;}
        .item25 {left:84px;top:468px;background-position: -480px -300px;}
        .item26 {left:348px;top:468px;background-position: -720px -300px;}

        .text {width:460px;height:179px;left:108px;top:378px;}
        .text1 {background-position: 0px 0px;}
        .text2 {background-position: 0px -200px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'mv',style:'mask mv'},{name:'movie',style:'mask movie'}]},
            <%
            value = "";
            ...
            %>
            { focus:0,items : [{name:'抢票',style:'mask link',playType:-3,link:'/EPG/jsp/neirong/S20170315.jsp'}]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( blocked == 0 && (index == -1 && focus == 0 || index == 1 && focus == 1 || index == 11 ) ||
                        (blocked == 1 || blocked == 2 ) && ( index == -1 && focus % 2 == 0 || index == 1 && focus % 2 == 1 ) ||
                        blocked == 3 && index != 11
                    ) return;
                    if( blocked == 0 ) {
                        ...
                        if( index == 1 || index == -1 ) {
                            ...
                            if( focus + 2 >= focusable[blocked].items.length ) {
                                blocked = 3; focus = 0;
                            } else  focus += 2;
                        }
            ...
            var txtFocus  = focusable[0].focus;
            $("mask1").className = focusable[0].items[txtFocus].style;

            var txt = txtFocus + 1;
            $("before").className = "mask text text" + txt;
        ...
        function init(){
            ...
            $.current = function (){
                var curs = "";
                for( var i = 0 ; i < focusable.length - 1; i ++ ) curs += focusable[i].focus + ",";
                curs = curs.substr(0, curs.length - 1 );
                return "/EPG/jsp/defaultHD/en/SaveCurrFocus.jsp?currFoucs=" + blocked + "," + curs + "&url=";
            };
            ...
            $.buildUserInterface({flowed:undefined,vote:undefined,video:undefined,position:undefined,external:{after:undefined,before:'<div id="before"></div>'}}); //

            var curs = '<%= focused %>';

            if( curs.isEmpty() ) {
                focusable[0].focus = 0;
                blocked = 1;focusable[blocked].focus = 0;focusable[3].from = 0;
            } else {
                curs = curs.split(',');
                blocked = Number( curs[0] );
                for( var i = 1 ; i < focusable.length ; i ++ )
                    focusable[i - 1 ].focus = Number( curs[ i ] );
            }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-04-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>