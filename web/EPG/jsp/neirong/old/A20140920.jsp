...
<title>我的上班路</title>
<style>
    .mask {height: 25px;position:absolute;background:transparent url('images/mask-2014-09-20.png') no-repeat fixed;}
    .mask1 {width:153px;left:459px;top:222px; background-position: 0px 0px;}
    .mask2 {width:195px;left:417px;top:259px; background-position: 0px -25px;}
    .mask3 {width:191px;left:480px;top:297px; background-position: 0px -50px;}
    .mask4 {width:239px;left:373px;top:334px; background-position: 0px -75px;}
    .mask5 {width:217px;left:504px;top:395px; background-position: 0px -100px;}
    .mask6 {width:196px;left:504px;top:432px; background-position: 0px -125px;}
    .mask7 {width:153px;left:504px;top:470px; background-position: 0px -150px;}
    .mask8 {width:220px;left:504px;top:508px; background-position: 0px -175px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-09-20.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>