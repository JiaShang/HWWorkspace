...
<%
    ...
    final String[] types = {"10000100000000090000000000105121"};
...
<head>
    <title>二战风云录</title>
    <style>
        .mask {width:394px;height:51px;left:688px;position:absolute;background:transparent url('images/mask-2015-05-11.png') no-repeat fixed;background-position: 0px -550px;}
        .mask1 {top:63px;}
        .mask2 {top:108px;}
        .mask3 {top:153px;}
        .mask4 {top:198px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var columns = 1; rows = 12;              //定义行列，　几行几列
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:'<div style="width:225px;height:525px;position: absolute;left: 789px;top:74px;background:transparent url(images/mask-2015-05-11.png) no-repeat fixed 0px 0px;"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-05-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>