...
<%
    ...
    final String[] types = {"10000100000000090000000000106645"};
...
<head>
    <title>夏日韩妆大揭秘</title>
    <style>
        .mask {position:absolute;width:270px;height:41px;background:transparent url('images/mask-2016-08-26.png') no-repeat;background-position: 0px 0px;}

        .mask1{left:336px;top:333px;background-position: 0px 0px;}
        .mask2{left:544px;top:400px;background-position: 0px -50px;}
        .mask3{left:400px;top:456px;background-position: 0px -100px;}
        .mask4{left:541px;top:531px;background-position: 0px -150px;}
        .mask5{left:316px;top:585px;background-position: 0px -200px;}

        .text,.focusText {width:195px;height:31px;line-height: 31px;font-size:22px; overflow: hidden;position:absolute;}
        .text {color:white;}
        .focusText {color:#FF578B;}
        .text1 {left:339px;top:335px;}
        .text2 {left:547px;top:402px;}
        .text3 {left:403px;top:458px;}
        .text4 {left:544px;top:533px;}
        .text5 {left:319px;top:587px;}
    ...
    <script language="javascript" type="text/javascript">
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                if( i == focus && blocked == index  ) {
                    if( item.shortText == item.text) {
                        $("text" + ( i + 1)).innerHTML = item.shortText;
                    } else {
                        $("text" + ( i + 1)).innerHTML = "<marquee>" + item.text + "</marquee>";
                    }
                    $("text" + ( i + 1)).className = "focusText text" + ( i + 1);
                } else {
                    $("text" + ( i + 1)).innerHTML = item.shortText;
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                ...
                html += "<div id='text1'></div>";
                html += "<div id='text2'></div>";
                html += "<div id='text3'></div>";
                html += "<div id='text4'></div>";
                html += "<div id='text5'></div>";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-26.jpg') no-repeat;" onUnload="exit();"></body>
</html>