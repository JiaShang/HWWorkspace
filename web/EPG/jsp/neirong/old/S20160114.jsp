...
<%
    ...
    final String[] types = {"10000100000000090000000000104935","10000100000000090000000000104936","10000100000000090000000000104936"};
...
<head>
    <title>2016广播电视报读者新春大联欢</title>
    <style>
        .mask {width:503px;height:53px;left:136px;position:absolute;background:transparent url('images/mask-2016-01-14.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{top:397px;}
        .mask2{top:444px;}
        .mask3{top:488px;}
        .mask4{top:534px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-01-14.jpg') no-repeat;" onUnload="exit();"></body>
</html>