...
<%
    ...
    final String[] types = {"10000100000000090000000000106925"};
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-21.jpg') no-repeat;" onUnload="exit();"></body>
</html>