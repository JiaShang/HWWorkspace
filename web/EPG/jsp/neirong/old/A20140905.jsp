...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104514";
...
<title>夏日出走吧</title>
<style>
    .maskOne {position:absolute;height: 42px;top:468px; background:transparent url('images/mask-2014-09-05.png') no-repeat fixed;}
    .maskTwo {position:absolute;height: 42px;top:527px; background:transparent url('images/mask-2014-09-05.png') no-repeat fixed;}
    .mask1 {width:239px;left:473px;background-position: 0px 0px;}
    .mask2 {width:170px;left:749px;background-position: 0px -42px;}
    .mask3 {width:110px;left:919px;background-position: 0px -84px;}
    .mask4 {width:140px;left:1072px;background-position: 0px -126px;}
    .mask5 {width:140px;left:473px;background-position: 0px -168px;}
    .mask6 {width:170px;left:638px;background-position: 0px -210px;}
    .mask7 {width:229px;left:822px;background-position: 0px -252px;}
    .mask8 {width:110px;left:1092px;background-position: 0px -294px;}
...
<script language="javascript" type="text/javascript">
    ...
    var focusable = focusable ? focusable : [
                  ...
                  for( int i = 0; i< list.size() && i < 8; i ++) {
                     ...
                     out.write("{ mid:'" + vod.getId() + "'," +
                           ...
                           "playType:" + vod.getIsSitcom() + "," +
                             "action:" + actions[i] + "," +
                              "style:'" + ( i < 4 ? "maskOne" : "maskTwo") + " mask" + (i + 1) + "'" +
                         "}" +  ( i + 1 < list.size() ? "," : ""));
                  }
                  out.flush();
            }
        ...
        { focus:0, items : [
            {name:'首页',style:'btnHome',action:[0,6,0,2,1,1,1,1]},
            {name:'返回',style:'btnReturn',action:[0,7,0,3,1,0,1,0]}
        ]}
    ];
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-09-05.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>