...
<%
    ...
    final String[] types = {"10000100000000090000000000107860"};
...
<head>
    <title>权游7回归福利季</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-06-19.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:415px;height:31px;left:177px;top:353px;background-position: 0px 0px;}
        .mask2 {width:154px;height:28px;left:332px;top:402px;background-position: 0px -50px;}
        .mask3 {width:179px;height:28px;left:332px;top:447px;background-position: 0px -100px;}
        .mask4 {width:154px;height:28px;left:332px;top:492px;background-position: 0px -150px;}
        .mask5 {width:154px;height:28px;left:332px;top:537px;background-position: 0px -200px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-06-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>