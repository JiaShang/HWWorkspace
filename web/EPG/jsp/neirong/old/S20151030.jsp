...
<%
    ...
    final String[] types = {"10000100000000090000000000105610"};//
...
<head>
    <title>逍遥哥哥的成功逆袭</title>
    <style>
        .mask {position:absolute;height:35px;background:transparent url('images/mask-2015-10-30.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{width:188px;left:174px;top:379px;background-position: 0px -300px}
        .mask2{width:116px;left:246px;top:420px;background-position: 0px -340px}
        .mask3{width:94px;left:268px;top:459px;background-position: 0px -380px}
        .mask4{width:94px;left:268px;top:499px;background-position: 0px -420px}
        .mask5{width:139px;left:223px;top:539px;background-position: 0px -460px}
        .mask6{width:118px;left:916px;top:273px;background-position: 0px -500px}
        .mask7{width:188px;left:916px;top:313px;background-position: 0px -540px}
        .mask8{width:140px;left:916px;top:353px;background-position: 0px -580px}
        .mask9{width:163px;left:916px;top:393px;background-position: 0px -620px}
        .flowed {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0  && ( (focus == 0 || focus == 5) && index == 11 || focus == 4 && index == -11 || focus <= 4 && index == -1 || focus >= 5 && index == 1 )) return;
                    if( blocked == 0 ){
                        ...
                        blocked = 0;
                        focus = index == 11 ? 8 : 4;
                        if( focus > focusable[0].items.length - 1 ) { focus = focusable[0].items.length - 1 }
                    }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{
                after:'<div style="position:absolute;width:1037px;height:296px;left:59px;top:275px;background: transparent url(\'images/mask-2015-10-30.png\') fixed no-repeat 0px 0px;"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-10-30.jpg') no-repeat;" onUnload="exit();"></body>
</html>