...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-09-30-1.png') no-repeat fixed;background-position: 0px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-09-30-1.jpg') no-repeat;" onUnload="exit();"></body>
</html>