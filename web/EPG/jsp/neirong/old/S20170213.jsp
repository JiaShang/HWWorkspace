...
<%
    ...
    final String[] types = {"10000100000000090000000000107240"};
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-02-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>