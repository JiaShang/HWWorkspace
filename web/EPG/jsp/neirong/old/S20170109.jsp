...
<%
    ...
    final String[] types = {"10000100000000090000000000107124"};
...
<head>
    <title>2017年金球奖提名不完全名单</title>
    <style>
        .mask {position:absolute;height:36px;background:transparent url('images/mask-2017-01-09.png') no-repeat;background-position: 0px 0px;}
        .mask1{ width:309px; left:90px;top:350px;background-position:0px 0px;}
        .mask2{ width:309px; left:90px;top:396px;background-position:0px -40px;}
        .mask3{ width:309px; left:90px;top:445px;background-position:0px -80px;}
        .mask4{ width:309px; left:90px;top:492px;background-position:0px -120px;}
        .mask5{ width:309px; left:90px;top:540px;background-position:0px -160px;}
        .mask6{ width:309px; left:90px;top:588px;background-position:0px -200px;}
        .mask7{ width:309px; left:90px;top:637px;background-position:0px -240px;}
        .mask8{ width:475px; left:453px;top:350px;background-position:0px -280px;}
        .mask9{ width:475px; left:453px;top:396px;background-position:0px -320px;}
        .mask10{ width:475px; left:453px;top:445px;background-position:0px -360px;}
        .mask11{ width:475px; left:453px;top:492px;background-position:0px -400px;}
        .flowed {}
        .after {}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == -1 && focus <= 6 || index == 1 && focus >= 7  || index == 11 && ( focus == 0 || focus == 7 ) || index == -11 && ( focus == 6 || focus + 1 >= focusable[blocked].items.length ))) return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-01-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>