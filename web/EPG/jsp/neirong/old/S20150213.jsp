...
<script language="javascript" type="text/javascript">
    ...
    function init(){
        ...
        //vote:[0,0] ,投票ID,0:0
        //popup:是否包含弹出对话框
        $.buildUserInterface({popup:undefined,vote:undefined,video:undefined,position:undefined,external:{}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-02-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>