...
<%
    ...
    final String[] types = {"10000100000000090000000000105868"};
...
<head>
    <title>小编教你买年货</title>
    <style>
        .mask {width:272px;height:126px;position:absolute;background:transparent url('images/mask-2016-02-01.png') no-repeat fixed;background-position: 0px 0px;}

        .maskTGO {width:261px;height:290px;left:36px;top:73px; background-position:0px -150px; }

        .mask1{left:255px;top:304px;}
        .mask2{left:661px;top:313px;}
        .mask3{left:985px;top:128px;}
        .mask4{left:31px;top:383px;}
        .mask5{left:450px;top:408px;}
        .mask6{left:776px;top:431px;}
        .mask7{left:160px;top:502px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'TGO',style:'mask maskTGO',playType:-3,link:'http://192.168.33.75/TGO/index.htm',action:[0,0,1,3,0,0,1,0]}]},
            <%
            value = "";
            final String[][] actions = {"[1,0,1,4,0,0,1,1]|[1,2,1,5,1,0,1,2]|[1,2,-1,0,1,1,1,2]|[0,0,1,6,1,3,1,4]|[1,0,1,6,1,3,1,5]|[1,1,-1,0,1,4,1,2]|[1,3,1,6,1,3,-1,0]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[1,2,-1,0,1,6,-1,1]},
                {name:'返回',style:'btnReturn',action:[1,2,-1,1,-1,0,-1,1]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div style="width:1104px;height:421px;left:98px;top:163px;position:absolute;background: transparent url(images/focusBg-2016-02-01.png) fixed 0px 0px;"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-02-01.jpg') no-repeat;" onUnload="exit();"></body>
</html>