...
<head>
    <title>消灭节后综合症</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-02-21.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{width:419px;height:124px;top:574px;left:111px;background-position: 0px 0px;}
        .mask2{width:212px;height:93px;top:73px;left:987px;background-position: 0px -150px;}
        .mask3{width:212px;height:93px;top:312px;left:700px;background-position: 0px -250px;}
        .mask4{width:212px;height:93px;top:544px;left:987px;background-position: 0px -350px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'立即订购',style:'mask mask1',playType:-3,link:'http://192.168.35.153:8080/woYaoDingGou.jsp?orderPId=2&lcn=wydg'},
                {name:'健身塑形',style:'mask mask2',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=5&lcn=jianshen'},
                {name:'美颜坊',style:'mask mask3',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=3&lcn=meiyan'},
                {name:'美食营养',style:'mask mask4',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=14&lcn=meishi'},
            ]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus == 0 && index == -1 || focus >= 1 && index == 1 || focus <= 1 && index == 11 || (focus == 0 || focus == 3 ) && index == -11  ))
                        return;
                    if( index == -1 ){
                        consign = focus;
                        focus = 0;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-02-21.jpg') no-repeat;" onUnload="exit();"></body>
</html>