...
<%
    ...
    final String[] types = {"10000100000000090000000000107542"};
...
<head>
    <title>鲜花宝贝</title>
    <style>
        .mask {width:251px;left:783px;height:58px;position:absolute;background:transparent url('images/mask-2017-04-09.png') no-repeat;background-position: 0px 0px;}
        .item1 {top:264px;}
        .item2 {top:333px;}

        .normal {background-position: 0px -60px;}
        .focus {background-position: 0px 0px;}

        .flowed {}
        .after {width:225px;height:91px;left:793px;top:278px;background-position: 0px -120px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            if( focus == 0 ) {
                $("item1").className = "mask item1 focus";
                $("item2").className = "mask item2 normal";
            } else {
                $("item1").className = "mask item1 normal";
                $("item2").className = "mask item2 focus";
            }
        }
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                ...
                html += "<div id='item1'></div>";
                html += "<div id='item2'></div>";
            ...
            $.buildUserInterface({flowed:[0],vote:undefined,video:undefined,position:undefined,external:{after:'<div class="mask after"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-04-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>