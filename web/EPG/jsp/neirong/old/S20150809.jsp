...
<%
    ...
    final String[] types = {"10000100000000090000000000105346"};
...
<head>
    <title>暑假补剧班之悬浮剧</title>
    <style>
        .mask {width:370px;left:668px;position:absolute;background:transparent url('images/mask-2015-08-09.jpg') no-repeat fixed;background-position: 0px 0px;}

        .mask1{height:75px;top:119px;background-position:0px 0px;}
        .mask2{height:53px;top:194px;background-position:0px -75px;}
        .mask3{height:53px;top:247px;background-position:0px -128px;}
        .mask4{height:54px;top:300px;background-position:0px -181px;}
        .mask5{height:54px;top:354px;background-position:0px -235px;}
        .mask6{height:50px;top:408px;background-position:0px -289px;}
        .mask7{height:50px;top:458px;background-position:0px -339px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-08-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>