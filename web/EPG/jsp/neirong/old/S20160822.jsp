...
<head>
    ...
    <style>
        ...
        .item .maskImage{background:transparent url('images/mask-2016-07-20.png') no-repeat 0px 0px;}
        .text {width:190px;height:35px; font-size:22px; color:#ffffff; line-height:30px; position:relative; top:-270px; overflow: hidden;left:5px;text-align: center;}

        .flowed {width:1200px;left:100px;top:303px;height:245px;overflow:hidden;position: absolute;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += '<div class="text" ' + ( ( i == focus && blocked == index ) ? ' style="color:#54B4FB;"' : '' ) + '>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-22.jpg') no-repeat;" onUnload="exit();"></body>
</html>