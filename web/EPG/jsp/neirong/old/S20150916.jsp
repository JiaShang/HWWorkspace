...
<%
    ...
    final String[] types = {"10000100000000090000000000105498"};
...
<head>
    <title>金婚祝福礼第2季</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-09-16.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:253px;height:80px;left:272px;top:303px;background-position:0px 0px;}
        .mask2 {width:379px;height:80px;left:208px;top:354px;background-position:0px -80px;}
        .mask3 {width:318px;height:80px;left:240px;top:408px;background-position:0px -160px;}
        .mask4 {width:325px;height:80px;left:236px;top:460px;background-position:0px -240px;}
        .mask5 {width:261px;height:80px;left:268px;top:512px;background-position:0px -320px;}
        .mask6 {width:269px;height:80px;left:267px;top:563px;background-position:0px -400px;}
        .mask7 {width:273px;height:80px;left:267px;top:616px;background-position:0px -480px;}
    ...
    <script language="javascript" type="text/javascript">
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                                  "style:'mask mask" + ( j + ( j > 1 ? 2 : 1 ) ) + "'" + "," +
                                 "playType:" + vod.getIsSitcom() ;
                            str += "}" ;
                            if( j == 1 ) str += ",{playType:-3,link:'/EPG/jsp/neirong/S20150916-1.jsp',style:'mask mask3'}";
        ...
        var columns = 1; rows = 7;              //定义行列，　几行几列
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-09-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>