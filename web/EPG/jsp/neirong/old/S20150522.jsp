...
<%
    ...
    final String[] types = {"10000100000000090000000000105151"};
...
<head>
    <title>我家有房要装修</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-05-22.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:416px;height:45px;left:785px;top:129px;background-position: 0px 0px;}
        .mask2 {width:416px;height:45px;left:785px;top:169px;background-position: 0px -50px;}
        .mask3 {width:416px;height:45px;left:785px;top:208px;background-position: 0px -100px;}
        .mask4 {width:416px;height:45px;left:785px;top:249px;background-position: 0px -150px;}
        .mask5 {width:416px;height:45px;left:785px;top:381px;background-position: 0px -200px;}
        .mask6 {width:416px;height:45px;left:785px;top:419px;background-position: 0px -250px;}
        .mask7 {width:416px;height:45px;left:785px;top:456px;background-position: 0px -300px;}
        .mask8 {width:416px;height:45px;left:785px;top:497px;background-position: 0px -350px;}
        .mask9 {width:416px;height:45px;left:785px;top:536px;background-position: 0px -400px;}
        .mask10 {width:416px;height:45px;left:785px;top:576px;background-position: 0px -450px;}

        .mask11 {width:144px;height:47px;left:150px;top:589px;background-position: 0px -500px;}
        .mask12 {width:144px;height:47px;left:285px;top:588px;background-position: -200px -500px;}
        .mask13 {width:144px;height:47px;left:411px;top:589px;background-position: 0px -550px;}
        .mask14 {width:144px;height:47px;left:537px;top:589px;background-position: -200px -550px;}
        .flowed {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            { focus:0,voted:false, items : [
                {name:'A.环保',playType:-2,style:'mask mask11'},
                {name:'B.预算',playType:-2,style:'mask mask12'},
                {name:'C.风格',playType:-2,style:'mask mask13'},
                {name:'D.实用',playType:-2,style:'mask mask14'}
            ]},
        ...
        var columns = 1; rows = 10;             //定义行列，　几行几列
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     ) || blocked == 1 && (index == 11 || index == -11 || focus == 0 && index == -1 )) return;
                     if( blocked == focusable.length - 1) {
                         if( index == 11 ) { blocked = 0;focus = focusable[blocked].focus; }
                         else { blocked = 1;focus = focusable[blocked].items.length - 1; }
                     } else if( blocked == 0 ) {
                         if( index == -1 ) { blocked = 1;focus = focusable[blocked].items.length - 1; }
                         ...
                         focus += index ;
                         if( focus >= focusable[blocked].items.length ) { blocked = 0;focus = focusable[blocked].focus; }
                     }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:1,item:undefined,id:213}],video:undefined,position:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-05-22.jpg') no-repeat;" onUnload="exit();"></body>
</html>