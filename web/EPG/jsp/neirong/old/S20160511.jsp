...
<%
    ...
    final String[] types = {"10000100000000090000000000106220"};
...
<head>
    <title>家装消费指南</title>
    <style>
        .mask {width:174px;height:26px;position:absolute;background:transparent url('images/mask-2016-05-11.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:697px;top:409px;background-position: 0px 0px;}
        .mask2{left:982px;top:409px;background-position: 0px -30px;}
        .mask3{left:697px;top:457px;background-position: 0px -60px;}
        .mask4{left:982px;top:457px;background-position: 0px -90px;}
        .mask5{left:697px;top:505px;background-position: 0px -120px;}
        .flowed {}
        .after {width:901px;height:422px;left:176px;top:228px;position:absolute;background:transparent url('images/focusBg-2016-05-11.png') no-repeat left top;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>