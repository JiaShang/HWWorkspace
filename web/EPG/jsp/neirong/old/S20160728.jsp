...
<head>
    <title>家宴</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-07-28.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:79px;height:31px;left:361px;top:52px;background-position:0px 0px}
        .mask2{width:78px;height:68px;left:105px;top:251px;background-position:0px -40px}
        .mask3{width:82px;height:35px;left:429px;top:288px;background-position:0px -110px}
        .mask4{width:97px;height:35px;left:667px;top:368px;background-position:0px -150px}
        .mask5{width:77px;height:25px;left:117px;top:424px;background-position:0px -190px}
        .mask6{width:87px;height:49px;left:420px;top:456px;background-position:0px -220px}
        .mask7{width:152px;height:39px;left:59px;top:572px;background-position:0px -270px}
        .mask8{width:117px;height:52px;left:349px;top:544px;background-position:0px -310px}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus == 0 && index == 11 || focus >=6 && index == -11 || index == -1 && ( focus == 1 || focus == 4 || focus == 6 ) )) return;
                    if( blocked == 0 ) {
                        if( index == 1 || index == -1 ) {
                            if( ( index == 1 ) && ( focus == 3 || focus == 5 || focus == 7 ) ) { blocked = focusable.length - 1; focus = 0; }
                            else if( index == -1 && focus == 0 ) focus = 1;
                            else if( index == 1 && focus == 0 ) focus = 3;
                            else focus += index
                        } else if( index == 11 ) {
                            if( focus == 1 || focus == 3 ) focus = 0;
                            else if( focus == 5 ) focus = 2;
                            else focus -= 2;
                        } else if( index == -11 ) {
                            if( focus == 1 ) focus = 4;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-07-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>