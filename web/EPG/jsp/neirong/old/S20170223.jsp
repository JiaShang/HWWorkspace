...
<%
    ...
    final String[] types = {"10000100000000090000000000107281"};
...
<head>
    <title>新生代奥斯卡闪耀2017</title>
    <style>
        .mask {width:309px;height:36px;position:absolute;background:transparent url('images/mask-2017-02-23.png') no-repeat;background-position: 0px -300px;}
        .mask0{left:125px;top:344px;}
        .mask1{left:125px;top:380px;}
        .mask2{left:125px;top:428px;}
        .mask3{left:125px;top:476px;}
        .mask4{left:125px;top:524px;}
        .mask5{left:125px;top:572px;}
        .mask6{left:125px;top:620px;}
        .mask7{left:491px;top:380px;}
        .mask8{left:491px;top:428px;}
        .mask9{left:491px;top:476px;}
        .mask10{left:491px;top:524px;}
        .mask11{left:491px;top:572px;}
        .mask12{left:491px;top:620px;}

        .flowed {}
        .after {width:664px;height:300px;left:129px;top:353px;background-position: 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        value += str;
                        if( j + 1 == vodList.size()) {
                            value += ",{name:'电视院线',style:'mask mask12',playType:-3,link:'http://192.168.5.229/dyyx/index.htm'}";
                        }
                    }
                    value += "]},";
                }
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if ( index == -1 && focus <= 6 || index == 1 && (focus == 0 || focus >= 7 ) || index == 11 && ( focus == 0 || focus == 7 ) || index == -11 && ( focus == 6 || focus + 1 >= focusable[blocked].items.length )) return;
                    if( index == 1 || index == -1 ) {
                        focus += 6 * index ;
                    } else {
                        focus += index > 0 ? -1 : 1;
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:'<div class="mask after"></div>',before:undefined}}); //
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-02-23.jpg') no-repeat;" onUnload="exit();"></body>
</html>