...
<head>
    <title>看《权力的游戏》享特惠大礼</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-05-09.png') no-repeat;background-position: 0px 0px;}
        .maskRole{ width:160px;height:40px;left:552px;top:454px; }
        ...
        .btnHome {position:absolute;background: transparent url("images/navBG.png") no-repeat; top:622px;left:123px; width:161px;height:41px; background-position: 0px 0px;}
        .btnReturn{position:absolute;background: transparent url("images/navBG.png") no-repeat; top:622px;left:123px; width:161px; height:41px; background-position: 0px -42px;}
    </style>
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'活动细则',style:'mask maskRole',playType:-3,link:'http://192.168.9.120/chongqing_TV/demandTV.htm?comboId=1421'}]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>