...
<head>
    ...
    <style>
        ...
        .item .maskImage{background:transparent url('images/mask-2016-07-10.png') no-repeat 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += '<div class="text" ' + ( ( i == focus && blocked == index ) ? ' style="color:#76b085;"' : '' ) + '>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-07-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>