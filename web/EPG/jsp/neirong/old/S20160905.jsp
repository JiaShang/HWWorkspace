...
<%
    ...
    final String[] types = {"10000100000000090000000000106662"};
...
<head>
    <title>韩星也陷人设坑</title>
    <style>
        .mask {width:226px;height:35px;position:absolute;background:transparent url('images/mask-2016-09-05.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:0px;top:429px;}
        .mask2{left:0px;top:468px;}
        .mask3{left:318px;top:412px;}
        .mask4{left:318px;top:451px;}
        .mask5{left:318px;top:490px;}
        .mask6{left:731px;top:408px;}
        .mask7{left:731px;top:447px;}
        .mask8{left:1017px;top:493px;}
        .mask9{left:1017px;top:532px;}
        .flowed {}
        .after {width:1203px;height:151px;left:32px;top:412px;background-position: 0px -50px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus < 2 && index == -1 || focus >=7 && index == 1 || ( focus == 0 || focus == 2 || focus == 5 || focus == 7 ) && index == 11 || ( focus == 1 || focus == 4 || focus == 6 ) && index == -11 ))
                        return;
                    if( blocked == 0 ) {
                        if( index == 11 || index == -11 ) {
                            focus += index > 0 ? -1 : 1;
                            if( focus >= focusable[blocked].items.length && index == -11 ) {
                                blocked = focusable.length - 1; focus = focusable[blocked].focus
                            }
                        } else if( index == 1 ){
                            if( focus == 2 || focus == 3 ) focus += 3;
                            else focus += 2;
                        } else {
                            if( focus >= 4 &&focus <= 6 ) focus -= 3;
                            else focus -=  2;
                        }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-05.jpg') no-repeat;" onUnload="exit();"></body>
</html>