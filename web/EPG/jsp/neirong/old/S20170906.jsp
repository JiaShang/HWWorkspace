...
<%
    ...
    final String[] types = {"10000100000000090000000000108353"};
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            document.body.style.backgroundImage = 'url("images/bg-2017-09-06-' +  (focus + 1) + '.jpg")'
        }
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                var html = '<img src="images/bg-2017-09-06-1.jpg" style="display:none;"/>';
                html += '<img src="images/bg-2017-09-06-2.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-09-06-3.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-09-06-4.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-09-06-5.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-09-06-6.jpg"  style="display:none;"/>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-09-06-<%=focused + 1 %>.jpg') no-repeat;" onUnload="exit();"></body>
</html>