...
<%
    ...
    final String[] types = {"10000100000000090000000000106223"};
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-01.jpg') no-repeat;" onUnload="exit();"></body>
</html>