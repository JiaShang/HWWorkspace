...
<%
    ...
    final String[] types = {"10000100000000090000000000104928"};
...
<title>新春看大片</title>
<style>
    .mask {width:227px; height:280px;top:239px; position:absolute;background:transparent url('images/mask-2015-02-11.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1 {left:87px;}
    .mask2 {left:306px;}
    .mask3 {left:525px;}
    .mask4 {left:747px;}
    ...
    .flowed {position: absolute;left:0px;top:257px;width:1280px;height: 240px;}
    .image {top:0px;width:183px;height:236px; border:none;position:absolute;}
    .image1 {left:104px;}
    .image2 {left:323px;}
    .image3 {left:542px;}
    .image4 {left:764px;}
...
<script language="javascript" type="text/javascript">
            ...
            if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                ...
                if( blocked == focusable.length - 1) { blocked = 0; focus = focusable[blocked].focus; }
                    ...
                    if( index == 11 || focus <= 0 && index == -1 ||
                        ...
                        index == -11 && (focus - startedFlowed) % 5 != 4
                    ) return;
    ...
    var flowedShow = function(){
        ...
        startedFlowed = Math.floor(focus / 5.0) * 5;
        if( startedFlowed + 5 >= focusable[blocked].items.length ) startedFlowed = focusable[blocked].items.length - 5;
        var html = "", maskStyle = '';
        for(var i = 0; i< 5; i++) {
    ...
    function init(){
        ...
        //popup:是否包含弹出对话框
        $.buildUserInterface({popup:undefined,flowed:[0],vote:undefined,video:undefined,position:undefined,external:{after:'<div style="width:1280px;height:720px;position: absolute;left: 0px;top:0px;background:transparent url(images/focusBG-2015-02-11.png) no-repeat fixed 0px 0px;">',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-02-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>