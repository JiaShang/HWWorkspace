...
<%
    ...
    final String[] types = {"10000100000000090000000000106651"};
...
<head>
    <title>金秋九月TGO送好礼</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-08-30.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:81px;height:81px;left:688px;top:503px;background-position: 0px 0px;}
        .mask2 {width:171px;height:61px;left:1046px;top:494px;background-position: 0px -100px;}
        .flowed {}
        .after {}
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                            ...
                            str += "}" ;
                            if( j == 0 )
                            str += ",{name:'活动细则',style:'mask mask2',playType:-3,link:'http://192.168.98.67:9988/ggly-gd-hd/index.jsp?entry=recommend1&code=20160829_kkxxsxq_album'}";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-30.jpg') no-repeat;" onUnload="exit();"></body>
</html>