...
<head>
    <title>权力的游戏回归粉丝趴</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-04-21.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:168;height:43px;left:115px;top:463px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'报名',style:'mask mask1',playType:-2}]},
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:undefined,id: 320}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-04-21.jpg') no-repeat;" onUnload="exit();"></body>
</html>