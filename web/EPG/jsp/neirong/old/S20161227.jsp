...
<%
    ...
    final String[] types = {"10000100000000090000000000107099"};
...
<head>
    <title>给孩子新年的第一份礼物</title>
    <style>
        .mask {position:absolute;}

        .item{ width:210px;height:245px;margin:0px 6px; float: left;}
        ...
        .flowed {width:1200px;left:89px;top:303px;height:245px;overflow:hidden;position: absolute;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-12-27.jpg') no-repeat;" onUnload="exit();"></body>
</html>