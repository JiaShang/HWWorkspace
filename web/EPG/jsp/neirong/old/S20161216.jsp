...
<%
    ...
    final String[] types = {"10000100000000090000000000108943"};
...
<head>
    <title>读者新春大联欢海选启动</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-12-16.png') no-repeat;background-position: 0px 0px;}
        ...
        .flowedItem {padding:0px 16px;font-style:italic; width:574px;height:56px; font-size: 28px; font-weight: bold; left:441px;line-height:56px;overflow: hidden; position: absolute;word-break:keep-all;white-space:nowrap; background-repeat: no-repeat;background-position: -20px 0px;}
        .item1 { top:411px; }
        .item2 { top:467px; }
        .item3 { top:523px; }
        .item4 { top:579px; }
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex, j = 1; i < flowCursorIndex + pageCount && i < items.length; i += 1, j++) {
                ...
                if( i == focus && blocked == index ){
                    ...
                    $("flowedItem" + j).style.backgroundImage = "url('images/mask-2016-12-16.png')";
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                ...
                if(typeof option.flowed != 'undefined' ) {
                    html += "<div id='scrollBar' class='scrollBar'><div class='mask scrollBarTop'></div><div id='scrollBarMiddle' class='mask scrollBarMiddle'></div><div class='mask scrollBarBottom'></div></div><div id='flowedItem1'></div><div id='flowedItem2'></div><div id='flowedItem3'></div><div id='flowedItem4'></div>";//<div id='arrowUp'></div><div id='arrowDown'></div>
                    focusable.flowed = [];
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-12-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>