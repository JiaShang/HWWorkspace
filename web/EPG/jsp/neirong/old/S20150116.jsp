...
<title>我是歌手3</title>
<style>
    .mask {position:absolute; background:transparent url('images/mask-2015-01-16.png') no-repeat fixed 0px 0px;}
...
<script language="javascript" type="text/javascript">
    ...
    var focusable = focusable ? focusable : [
        {focus:0,items:[{playType:-1,blocked:1,style:'mask review'}]},
    <%
    ...
    function focused(index,initilized){
        ...
        if(typeof index == "number" && !initilized){
            ...
            if( ( blocked == 0 || blocked == 1 || blocked == 3 || blocked == 4 ) && ( index == -1 || index == 1) ||
                  blocked == 6 && index == -11 || blocked == 0 && index == 11 ||
            ...
            switch (index){
                case 11:
                    if( ( blocked == 1 || blocked == 4 ) && focus - 1 >= 0 ) { focus = focus - 1; }
                    ...
                    break;
                case -11:
                    if( ( blocked == 1 || blocked == 4 ) && focus + 1 < focusable[blocked].items.length ) { focus = focus + 1; }
                    else { var temp = blocked; switch ( blocked ){
        ...
        if( blocked != 1 && blocked != 4){
            ...
            if( blocked == 0 || blocked == 3 || blocked == 6 ){
                $("mask").style.left = "";
                $("mask").style.top = "";
            } else if( blocked == 2 ){
                initSideShow();
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-01-16.jpg') no-repeat;">
