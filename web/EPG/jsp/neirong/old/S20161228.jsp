...
<%
    ...
    final String[] types = {"10000100000000090000000000107098","10000100000000090000000000107098"};
    final int[] position = {6,0,3,6};
    //TODO:每次需要修改
...
<head>
    <title>2016重庆大事记</title>
    <style>
        .mask {height:27px;position:absolute;background:transparent url('images/mask-2016-12-28.png') no-repeat;background-position: 0px 0px;}

        .mask11 {width:273px;left:136px;top:177px;background-position: 0px 0px;}
        .mask12 {width:273px;left:136px;top:234px;background-position: 0px -30px;}
        .mask13 {width:312px;left:136px;top:295px;background-position: 0px -60px;}
        .mask14 {width:273px;left:136px;top:356px;background-position: 0px -90px;}
        .mask15 {width:204px;left:137px;top:414px;background-position: 0px -120px;}
        .mask16 {width:273px;left:136px;top:476px;background-position: 0px -150px;}
        .mask21 {width:313px;height:65px;left:932px;top:375px;background-position: 0px -180px;}
        .mask22 {width:313px;height:65px;left:932px;top:458px;background-position: 0px -250px;}
        .mask23 {width:204px;left:932px;top:557px;background-position: 0px -320px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( index == 11  && focus <= 0 || index == -11 && focus + 1 >= focusable[blocked].items.length || index == -1 && blocked == 0 || index == 1 && blocked == 1 ) return;
                    if( index == -1 || index == 1) {
                        blocked = index == -1 ? 0 : 1;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-12-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>