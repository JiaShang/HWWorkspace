...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,focusVote: false,voteId:383,groupName:'艺术青少年组',items : [
                {actor:'红舞鞋艺术学校',name:'《团结就是力量》',vote:'tjjl',mid:0,addon:500,count:0,playType:0},
                {actor:'舞韵艺术培训学校',name:'《箱子里的梦》',vote:'xzlm',mid:0,addon:500,count:0,playType:0},
                {actor:'尚舞艺术培训学校',name:'《嘻哈小子》',vote:'xgxz',mid:0,addon:500,count:0,playType:0},
                {actor:'舞韵艺术培训学校',name:'《下课十分钟》',vote:'xksz',mid:0,addon:500,count:0,playType:0},
                {actor:'红舞鞋艺术学校',name:'《Wonderful dance》',vote:'wond',mid:0,addon:500,count:0,playType:0},
                {actor:'舞艺艺术培训学校',name:'《bangbangbang》',vote:'bbbg',mid:0,addon:500,count:0,playType:0},
                {actor:'红舞鞋艺术学校',name:'《珊瑚颂》',vote:'shsg',mid:0,addon:500,count:0,playType:0},
                {actor:'舞艺艺术培训学校',name:'《快乐布谷》',vote:'klbg',mid:0,addon:500,count:0,playType:0},
                {actor:'文化馆大地艺术培训中心',name:'《遥、瑶、谣》',vote:'yyy',mid:0,addon:500,count:0,playType:0},
                {actor:'舞艺艺术培训学校',name:'《小不点大篮球》',vote:'xbdq',mid:0,addon:500,count:0,playType:0},
                {actor:'尚舞艺术培训学校',name:'《迷彩士兵》',vote:'mcsb',mid:0,addon:500,count:0,playType:0},
                {actor:'红舞鞋艺术学校',name:'《红梅赞》',vote:'hmzn',mid:0,addon:500,count:0,playType:0},
                {actor:'舞韵艺术培训学校',name:'《马啼哒哒》',vote:'mtdd',mid:0,addon:500,count:0,playType:0},
                {actor:'文化馆大地艺术培训中心',name:'《翔》',vote:'xiag',mid:0,addon:500,count:0,playType:0},
                {actor:'金芭蕾艺术培训学校',name:'《barbarbar》',vote:'bbbr',mid:0,addon:500,count:0,playType:0}
            ]},
            { focus:0,focusVote: false,voteId:384,groupName:'艺术成年组',items : [
                {actor:'尚舞艺术培训学校',name:'《礼仪之邦》',vote:'lyzb',mid:0,addon:500,count:0,playType:0},
                {actor:'舞艺艺术培训学校',name:'《肚皮舞》',vote:'dpwu',mid:0,addon:500,count:0,playType:0},
                {actor:'文化馆大地艺术培训中心',name:'《Anaconda》',vote:'anaa',mid:0,addon:500,count:0,playType:0},
                {actor:'红舞鞋艺术学校',name:'《月引霓裳》',vote:'yylc',mid:0,addon:500,count:0,playType:0},
                {actor:'舞艺艺术培训学校',name:'《Say My Name》',vote:'smne',mid:0,addon:500,count:0,playType:0},
                {actor:'尚舞艺术培训学校',name:'《青年》',vote:'qnin',mid:0,addon:500,count:0,playType:0},
                {actor:'文化馆大地艺术培训中心',name:'《我的天空》',vote:'qdtk',mid:0,addon:500,count:0,playType:0},
                {actor:'尚舞艺术培训学校',name:'《Dance》',vote:'dane',mid:0,addon:500,count:0,playType:0},
                {actor:'文体艺术团',name:'《蒙古人》',vote:'mgrn',mid:0,addon:500,count:0,playType:0},
                {actor:'老年大学',name:'《三峡橘乡俏老太》',vote:'sxjt',mid:0,addon:500,count:0,playType:0},
                {actor:'红舞鞋艺术学校',name:'《Danceholic》',vote:'danc',mid:0,addon:500,count:0,playType:0},
                {actor:'老年大学',name:'《洗衣歌》',vote:'xyge',mid:0,addon:500,count:0,playType:0},
                {actor:'红舞鞋艺术学校',name:'《百花争妍》',vote:'bhzy',mid:0,addon:500,count:0,playType:0},
                {actor:'老年大学',name:'《鸿雁》',vote:'hyan',mid:0,addon:500,count:0,playType:0},
                {actor:'红舞鞋艺术学校',name:'《无名花》',vote:'wmha',mid:0,addon:500,count:0,playType:0},
                {actor:'尚舞艺术培训学校',name:'《父亲》',vote:'fqig',mid:0,addon:500,count:0,playType:0}
            ]},
            { focus:0,focusVote: false,voteId:381,groupName:'乡镇青少年组',items : [
                {actor:'拔山镇',name:'《冬天来了》',vote:'dtll',mid:0,addon:500,count:0,playType:0},
                {actor:'新立镇',name:'《妈妈的红灯笼》',vote:'mmdl',mid:0,addon:500,count:0,playType:0},
                {actor:'新生镇',name:'《小鸡舞》',vote:'xjwu',mid:0,addon:500,count:0,playType:0},
                {actor:'官坝镇',name:'《祖国的蜕变》',vote:'zmdb',mid:0,addon:500,count:0,playType:0},
                {actor:'白公街道',name:'《花儿为什么这样红》',vote:'hrwh',mid:0,addon:500,count:0,playType:0},
                {actor:'复兴镇',name:'《飞呀飞》',vote:'fyfi',mid:0,addon:500,count:0,playType:0},
                {actor:'花桥镇',name:'《百花争艳》',vote:'bhzy',mid:0,addon:500,count:0,playType:0},
                {actor:'野鹤镇',name:'《扇花花》',vote:'shha',mid:0,addon:500,count:0,playType:0},
                {actor:'黄金镇',name:'《大王叫我来巡山》',vote:'dwjs',mid:0,addon:500,count:0,playType:0},
                {actor:'白公街道',name:'《喜庆丰收年》',vote:'xqfn',mid:0,addon:500,count:0,playType:0},
                {actor:'兴峰乡',name:'《锄禾》',vote:'chhe',mid:0,addon:500,count:0,playType:0},
                {actor:'忠州街道',name:'《忠州魂》',vote:'zzhn',mid:0,addon:500,count:0,playType:0},
                {actor:'忠州街道',name:'《国风》',vote:'gfeg',mid:0,addon:500,count:0,playType:0},
                {actor:'善广乡',name:'《小马奔腾》',vote:'xmbt',mid:0,addon:500,count:0,playType:0},
                {actor:'金声乡',name:'《老师亲妈妈亲》',vote:'lsqq',mid:0,addon:500,count:0,playType:0},
                {actor:'磨子乡',name:'《空巢的孩子》',vote:'kqdz',mid:0,addon:500,count:0,playType:0},
                {actor:'任家镇',name:'《飞蹄声声》',vote:'fdss',mid:0,addon:500,count:0,playType:0},
                {actor:'石宝镇',name:'《声声布谷情》',vote:'ssbq',mid:0,addon:500,count:0,playType:0},
                {actor:'东溪镇',name:'《谷韵丰情》',vote:'gyfq',mid:0,addon:500,count:0,playType:0},
                {actor:'白石镇',name:'《采茶舞》',vote:'ccwu',mid:0,addon:500,count:0,playType:0}
            ]},
            { focus:0,voteId:382,focusVote: false,groupName:'乡镇成年组',items : [
                {actor:'拔山镇',name:'《回家的路》',vote:'hjdl',mid:0,addon:500,count:0,playType:0},
                {actor:'金声乡',name:'《共同面对》',vote:'gtmd',mid:0,addon:500,count:0,playType:0},
                {actor:'复兴镇',name:'《风姿花》',vote:'fzha',mid:0,addon:500,count:0,playType:0},
                {actor:'乌杨镇',name:'《迈克尔杰克逊》舞',vote:'mkew',mid:0,addon:500,count:0,playType:0},
                {actor:'任家镇',name:'《夕阳红》',vote:'xyhg',mid:0,addon:500,count:0,playType:0},
                {actor:'忠州街道',name:'《忠州情韵》',vote:'zzqy',mid:0,addon:500,count:0,playType:0},
                {actor:'白公街道',name:'《忠州好儿郎》',vote:'zzhl',mid:0,addon:500,count:0,playType:0},
                {actor:'忠州街道',name:'《罗敷行》',vote:'lfxg',mid:0,addon:500,count:0,playType:0},
                {actor:'汝溪镇',name:'《迎春歌》',vote:'ycge',mid:0,addon:500,count:0,playType:0},
                {actor:'石宝镇',name:'《浪拉山情》',vote:'llsq',mid:0,addon:500,count:0,playType:0},
                {actor:'新立镇',name:'《说唱脸谱》',vote:'scnp',mid:0,addon:500,count:0,playType:0},
                {actor:'白公街道',name:'《筷子舞》',vote:'kzwu',mid:0,addon:500,count:0,playType:0},
                {actor:'新生镇',name:'《碧波孔雀》',vote:'bbkq',mid:0,addon:500,count:0,playType:0},
                {actor:'官坝镇',name:'《爱你》',vote:'aini',mid:0,addon:500,count:0,playType:0},
                {actor:'永丰镇',name:'《烟雨江南》',vote:'yyjn',mid:0,addon:500,count:0,playType:0},
                {actor:'三汇镇',name:'《梦的摇篮》',vote:'mdyl',mid:0,addon:500,count:0,playType:0}
            ]},
        ...
        var columns = 1; rows = 5;              //定义行列，　几行几列
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += "<div class='total" + stClass + "'>总票数:" + ( item.count + item.addon  ) + "</div>";
