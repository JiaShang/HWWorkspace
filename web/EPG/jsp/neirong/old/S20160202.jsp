...
<%
    ...
    final String[] types = {"10000100000000090000000000105871"};
...
<head>
    <title>有爱·有家</title>
    <style>
        .mask {height:44px;position:absolute;background:transparent url('images/mask-2016-02-02.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{width:163px;left:998px;top:248px;background-position: 0px 0px;}
        .mask2{width:213px;left:972px;top:286px;background-position: 0px -50px;}
        .mask3{width:163px;left:998px;top:323px;background-position: 0px -100px;}
        .mask4{width:213px;left:972px;top:361px;background-position: 0px -150px;}
        .mask5{width:163px;left:998px;top:398px;background-position: 0px -200px;}
        .mask6{width:213px;left:972px;top:436px;background-position: 0px -250px;}
        .mask7{width:234px;left:961px;top:474px;background-position: 0px -300px;}
        .mask8{width:234px;left:961px;top:511px;background-position: 0px -350px;}
        .mask9{width:163px;left:998px;top:549px;background-position: 0px -400px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-02-02.jpg') no-repeat;" onUnload="exit();"></body>
</html>