...
<%
    ...
    final String[] types = {"10000100000000090000000000106060"};
...
<head>
    <title>蒋欣的霸屏之旅</title>
    <style>
        .mask {height:35px;position:absolute;background:transparent url('images/mask-2016-05-19.png') no-repeat;background-position: 0px 0px;}

        .mask1 {width:137px;left:154px;top:455px; background-position: 0px 0px;}
        .mask2 {width:207px;left:291px;top:489px; background-position: 0px -40px;}
        .mask3 {width:104px;left:291px;top:614px; background-position: 0px -80px;}
        .mask4 {width:140px;left:671px;top:230px; background-position: 0px -120px;}
        .mask5 {width:96px;left:811px;top:489px; background-position: 0px -160px;}
        .mask6 {width:139px;left:811px;top:555px; background-position: 0px -200px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            <%
            value = "";
            final String[][] actions = {"[0,0,0,1,0,0,0,1]|[0,0,0,2,0,0,0,4]|[0,1,0,2,0,2,0,5]|[0,3,0,4,0,0,0,4]|[0,3,0,5,0,1,-1,0]|[0,4,-1,0,0,2,-1,0]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,5,-1,0,0,2,-1,1]},
                {name:'返回',style:'btnReturn',action:[0,5,-1,1,-1,0,-1,1]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked === 0 && focus >= focusable[blocked].items.length ) { blocked = focusable.length - 1;focus = focusable[blocked].focus; }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>