...
<%
    ...
    final String[] types = {"10000100000000090000000000106688"};
...
<head>
    <title>西部世界 失控的机器人乐园</title>
    <style>
        .mask {width:195px;height:41px; position:absolute;background:transparent url('images/mask-2016-09-15.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:56px;top:545px;background-position: 0px 0px;}
        .mask2{left:56px;top:581px;background-position: 0px -40px;}
        .mask3{left:268px;top:545px;background-position: 0px -80px;}
        .mask4{left:268px;top:581px;background-position: 0px -120px;}
        .mask5{left:268px;top:615px;background-position: 0px -160px;}
        .mask6{left:268px;top:651px;background-position: 0px -200px;}
        .mask7{left:480px;top:545px;background-position: 0px -240px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( ( focus == 0 || focus == 2 || focus == 6 ) && index == 11 || ( focus == 1 || focus == 5 || focus == 6 ) && index == -11 || focus <= 1 && index == -1 ) ) return;
                    if( blocked == focusable.length - 1 ) {
                        blocked = 0 ; focus = focusable[blocked].focus;
                    } else if ( blocked == 0 ) {
                        if( index == 11 || index == -11 ) {
                            focus += index > 0 ? -1 : 1 ;
                            if( index == -11  && focus >= focusable[blocked].items.length ) {
                            ...
                            if( focus == 6 ) focus = 2;
                            else if( focus == 2 || focus == 3 ) focus -= 2;
                            else focus = 1;
                        }
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-15.jpg') no-repeat;" onUnload="exit();"></body>
</html>