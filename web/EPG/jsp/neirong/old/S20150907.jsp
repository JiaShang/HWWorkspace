...
<%
    ...
    final String[] types = {"10000100000000090000000000105482"};
...
<head>
    <title>我的美女机器人</title>
    <style>
        .mask {width:214px;height:141px;position:absolute;background:transparent url('images/mask-2015-09-07.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {left:533px;top:195px;}
        .mask2 {left:765px;top:195px;}
        .mask3 {left:1005px;top:195px;}
        .mask4 {left:306px;top:429px;}
        .mask5 {left:533px;top:429px;}
        .mask6 {left:765px;top:429px;}
        .mask7 {left:1005px;top:429px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( (focus == 0 || focus == 3 ) && index == -1 || focus <= 3 && index == 11 || focus >= 3 && focus != focusable[0].items.length -1 && index == -11 || ( focus == 2 || focus == focusable[0].items.length - 1 ) && index == 1 )) return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-09-07.jpg') no-repeat;" onUnload="exit();"></body>
</html>