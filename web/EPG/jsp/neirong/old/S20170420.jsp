...
<%
    ...
    final String[] types = {"10000100000000090000000000107602"};
...
<head>
    ...
    <style>
        .mask {width:53px;height:71px;top:555px;position:absolute;background:transparent url('images/mask-2017-04-20.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:400px;height:41px;left:93px;top:461px;background-position: 0px 0px;}
        .mask2{left:118px;background-position: 0px -50px;}
        .mask3{left:177px;background-position: -60px -50px;}
        .mask4{left:234px;background-position: -120px -50px;}
        .mask5{left:292px;background-position: -180px -50px;}
        .mask6{left:350px;background-position: -240px -50px;}
        .mask7{left:409px;background-position: -300px -50px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( blocked == 0 && ( index == -1 && focus <= 1 || index == 1 && (focus == 0 || focus + 1 >= focusable[blocked].items.length) || index == 11 && focus == 0 || index == -11 && focus >= 1 )) return
                    if( index == 1 || index == -1 ) {
                        focus += index;
                    } else if( index == 11 ) {
                        consign = focus;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-04-20.jpg') no-repeat;" onUnload="exit();"></body>
</html>