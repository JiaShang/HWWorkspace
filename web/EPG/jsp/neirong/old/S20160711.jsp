...
<head>
    <title>7.11我们约球吧</title>
    <style>
        .mask {height:51px;top:584px;position:absolute;background:transparent url('images/mask-2016-07-11.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:216px;left:861px;background-position:0px 0px;}
        .mask2{width:108px;left:1094px;background-position:-220px 0px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'报名',style:'mask mask1',playType:-2},
                {name:'退出',style:'mask mask2'}
            ]},
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:undefined,id: 334}],video:undefined,position:undefined,external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
        ...
        function doEnter(){
            ...
            //首页，返回
            if( blocked == 0 && focusable[blocked].focus == 1 || blocked == focusable.length - 1 ) { goBack(); return;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-07-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>