...
<%
    ...
    final String[] types = {"10000100000000090000000000108441"};
...
<head>
    ...
    <style>
        .mask {height:30px;position:absolute;background:transparent url('images/mask-2017-09-26.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:278px;left:671px;top:316px;background-position: 0px 0px;}
        .mask2{width:278px;left:671px;top:350px;background-position: 0px -38px;}
        .mask3{width:150px;left:737px;top:383px;background-position: 0px -75px;}
        .mask4{width:382px;left:616px;top:417px;background-position: 0px -113px;}
        .mask5{width:247px;left:689px;top:449px;background-position: 0px -150px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    value += ",{name:'明星招唤师',style:'mask mask3',playType:-3,link:'http://192.168.49.142:8400/es720p/EnterGame/epg002.aspx'}";
                    value += ",{name:'英雄联联盟',style:'mask mask4',playType:-3,link:'http://192.168.49.142:8400/es720p/EnterGame/epg001.aspx'}";
                    value += ",{name:'LOL',style:'mask mask5',playType:-3,link:'http://192.168.34.131:8300/activity/s7/index.do?from=epg_activity'}";
                    value += "]},";
                }
                out.write(value);
            }
        ...
        function init(){
            ...
            //vote:[{blocked:0,item:3,id: 196}],投票ID,0:0
            //video:'视频ID'
            //positio`n:[0,0,0,0]:视频显示坐标
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-09-26.jpg') no-repeat;" onUnload="exit();"></body>
</html>