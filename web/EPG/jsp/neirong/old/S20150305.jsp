...
<%
    ...
    final String[] types = {"10000100000000090000000000104962"};
...
<head>
    <title>看春晚抽红包正式结果</title>
    <style>
        .mask {width:355px;left:62px;position:absolute;background:transparent url('images/mask-2015-03-05.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {height:24px;top:283px;background-position: 0px 0px;}
        .mask2 {height:24px;top:307px;background-position: 0px -24px;}
        .mask3 {height:48px;top:331px;background-position: 0px -48px;}
        .mask4 {height:24px;top:379px;background-position: 0px -96px;}
        .mask5 {height:24px;top:403px;background-position: 0px -120px;}
        .mask6 {height:24px;top:427px;background-position: 0px -144px;}
        .mask7 {height:24px;top:451px;background-position: 0px -168px;}
        .mask8 {height:24px;top:475px;background-position: 0px -192px;}
        .mask9 {height:48px;top:499px;background-position: 0px -216px;}
        .mask10 {height:24px;top:547px;background-position: 0px -264px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && (focus <= 0 && index == 11 || focus >= focusable[0].items.length && index == -11 || index == -1 )) return;
                    if( blocked == focusable.length - 1 ) {
                        blocked = 0; focus = focusable[blocked].focus;
                    } else if( blocked == 0 ) {
                        if( index == 1 ) { blocked = focusable.length - 1 ; focus = focusable[blocked].focus; }
                        else
                            focus += (index > 0 ? -1 : 1);
                    }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-03-05.jpg') no-repeat;" onUnload="exit();"></body>
</html>