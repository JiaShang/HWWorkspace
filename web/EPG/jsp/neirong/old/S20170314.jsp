...
<%
    ...
    final String[] types = {"10000100000000090000000000107282"};
    final int[] position = {99,0};
    //TODO:每次需要修改
    int focused = 0, area = 0;
    final int popItemMaxCharLength = 34;
...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-03-14.png') no-repeat;background-position: 0px 0px;}

        .flowed{position:absolute;width:442px;top:406px;height:255px;left:392px;}
        .item {width:442px;height:42px;}

        .text{height:42px;line-height: 30px;font-size:22px;font-weight:bold;color:#ffffff;float:left;overflow:hidden;word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;}
        .circle,.circleFocus {width:20px;height:42px;float:left;}
        .text,.textFocus{width:420px;}
        .textFocus{color:#0C336E;background:transparent url('images/mask-2017-03-14.png') no-repeat -20px 0px;}
        .circleFocus{background:transparent url('images/mask-2017-03-14.png') no-repeat 0px 0px;}
        .scrollBar{position:absolute;width:6px;left:895px;}
        .scrollBarTop,.scrollBarBottom{width:6px;left:0px;height:3px; border:none;}
        .scrollBarTop {top:0px;background-position: -450px 0px;}
        .scrollBarMiddle{width:6px;left:0px;border:none;top:3px;background-position: -460px 0px; background-repeat: repeat-y;}
        .scrollBarBottom{bottom:0px;background-position: -450px -31px;}

        .marqueed{line-height: 30px;width:400px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                   ...
                   if( index == -1 || index == 1 || index == 11 && focus == 0 || index == -11 && focus + 1 >= focusable[blocked].items.length ) return;
                   focus += index > 0 ? -1 : 1;
                }
        ...
        var flowedShow = function(index){
            ...
            $("flowed").className = "flowed flowed";
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += "<div class='text text" + ( ( i == focus && blocked == index ) ? 'Focus' : '' ) + "'>"
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:[0],popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-03-14.jpg') no-repeat;" onUnload="exit();"></body>
</html>