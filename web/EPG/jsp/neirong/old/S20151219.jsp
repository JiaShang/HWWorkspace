...
<%
    ...
    try {
        ...
        if( area == 0 && focus != null && focus.length > 1 && focus[1] != null)
            focused = Integer.parseInt(focus[1]);
        else
            focused = list.get(0).size() - 1;
...
<head>
    <title>行走在光影中的重庆</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-12-19.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{width:30px;height:241px;left:242px;top:238px;background-position: 0px 0px;}
        .mask2{width:30px;height:203px;left:285px;top:238px;background-position: -30px 0px;}
        .mask3{width:30px;height:358px;left:328px;top:238px;background-position: -60px 0px;}
        .mask4{width:30px;height:358px;left:370px;top:238px;background-position: -90px 0px;}
        .mask5{width:30px;height:144px;left:412px;top:238px;background-position: -120px 0px;}
        .mask6{width:30px;height:305px;left:456px;top:238px;background-position: -150px 0px;}
        .mask7{width:30px;height:162px;left:595px;top:323px;background-position: -180px 0px;}
        .mask8{width:30px;height:199px;left:636px;top:323px;background-position: -210px 0px;}
        .mask9{width:30px;height:165px;left:674px;top:323px;background-position: -270px 0px;}
        .mask10{width:30px;height:77px;left:714px;top:323px;background-position: -240px 0px;}
        .mask11{width:30px;height:130px;left:756px;top:323px;background-position: -300px 0px;}
        .mask12{width:30px;height:137px;left:795px;top:323px;background-position: -330px 0px;}
        .mask13{width:30px;height:218px;left:835px;top:323px;background-position: -360px 0px;}
        .mask14{width:30px;height:165px;left:874px;top:323px;background-position: -390px 0px;}
        .mask15{width:30px;height:144px;left:914px;top:323px;background-position: -420px 0px;}
        .mask16{width:30px;height:164px;left:955px;top:323px;background-position: -450px 0px;}

        .mask21{width:99px;height:25px;left:634px;top:562px;background-position: 0px -370px;}

        .mask31{width:93px;height:29px;left:515px;top:646px;background-position: -200px -370px;}
        .mask32{width:93px;height:29px;left:609px;top:646px;background-position: -350px -370px;}
        .mask33{width:103px;height:29px;left:706px;top:646px;background-position: -200px -330px;}
        .mask34{width:92px;height:29px;left:810px;top:646px;background-position: -350px -330px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    value += "{focus:" + focused + ",typeId:'" + types[i] + "',items:[";
            ...
            %>
            { focus:0,items : [{name:'活动细则',style:'mask mask21',playType:-3,link:'/EPG/jsp/neirong/R20151219.jsp'}]},
            { focus:0,items : [
                {name:'A.解放碑',style:'mask mask31',playType:-2},
                {name:'B.洪崖洞',style:'mask mask32',playType:-2},
                {name:'C.长江索道',style:'mask mask33',playType:-2},
                {name:'D.磁器口',style:'mask mask34',playType:-2}
            ]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus == 0 && index == -1 || focus == focusable[0].items.length - 1 && index == 1 || index == 11 || focus <= 4 && index == -11 ) ||
                        blocked == 1 && ( index == -1 || index == 1 ) ||
                        blocked == 2 && ( focus == 0 && index == -1 || index == -11  )
                    ) return;
                    ...
                    if( blocked == 0 ) {
                        ...
                        if( index == 1 || index == -1 )  {
                            focus += index;
                            if( focus > focusable[blocked].items.length - 1 ) { focus = 0; blocked = focusable.length - 1; }
                        } else {
                           blocked = 1; focus = 0;
                        }
                    } else if( blocked == focusable.length - 1 ) {
                        blocked = index == -1 ? 2 : 0 ; focus = focusable[blocked].items.length - 1;
                    }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:2,item:undefined,id: 275}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:undefined}});
            if( focusable.length == 2 ) {blocked = focusable.length - 1;}
            focused( <%= area %> == 0 ? <%= focused %> : 0, true);
        }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-12-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>