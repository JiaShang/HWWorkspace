...
<%
    ...
    final String[] types = {"10000100000000090000000000105350"};
...
<head>
    <title>霸气女神范冰冰</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-07-29.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:404px;height:39px;left:63px;top:209px; background-position: 0px -0px;}
        .mask2 {width:404px;height:39px;left:63px;top:242px; background-position: 0px -40px;}
        .mask3 {width:404px;height:39px;left:63px;top:274px; background-position: 0px -80px;}
        .mask4 {width:404px;height:39px;left:63px;top:308px; background-position: 0px -120px;}
        .mask5 {width:404px;height:39px;left:63px;top:340px; background-position: 0px -160px;}
        .mask6 {width:404px;height:39px;left:63px;top:446px; background-position: 0px -200px;}
        .mask7 {width:404px;height:39px;left:63px;top:479px; background-position: 0px -240px;}
        .mask8 {width:404px;height:39px;left:63px;top:549px; background-position: 0px -280px;}
        .mask9 {width:404px;height:39px;left:63px;top:583px; background-position: 0px -320px;}

        .mask10 {width:136px;height: 38px;left:808px;top:423px; background-position: 0px -360px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            { focus:0, vote:true, items : [
                {name:'支持范冰冰',style:'mask mask10',playType:-2}
            ]},
            { focus:0, vote:true, items : [
                {name:'input'},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == -1 || focus == 0 && index == 11 || focus + 1 == focusable[0].items.length && index == -11 ) ||
                        blocked == 1 && ( index == 11 || index == 1 ) ) return;

                    if( blocked == 0 ) {
                        if( index == 1 ) {
                            blocked = focus >= 6 ? focusable.length - 1 : 1;
                            focus = 0;
                        } else if( index == 11 || index == -11 ) {
                            focus += index == -11 ? 1 : -1;
                        }
                    } else {
                        if( index == -1 ) { blocked = 0 ; focus = focusable[blocked].focus; }
                        else if( index == -11 ) { blocked = focusable.length - 1; focus = focusable[blocked].focus; }
                        else if( index == 11 ) { blocked = 1; focus = 0;}
                    }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:1,item:undefined,id: 227}],video:undefined,position:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-07-29.jpg') no-repeat;" onUnload="exit();"></body>
</html>