...
<head>
    ...
    <style>
        ...
        .flowed {width:1200px;left:89px;top:333px;height:245px;overflow:hidden;position: absolute;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-04.jpg') no-repeat;" onUnload="exit();"></body>
</html>