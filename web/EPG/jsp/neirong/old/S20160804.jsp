...
<head>
    <title>抢票去看郭德纲</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-08-04.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:119px;height:40px;left:110px;top:631px;background-position: 0px 0px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'抢票',style:'mask mask1',playType:-2}]},
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:undefined,id: 344}],video:undefined,position:undefined,external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-04.jpg') no-repeat;" onUnload="exit();"></body>
</html>