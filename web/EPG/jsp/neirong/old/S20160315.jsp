...
<%
    ...
    final String[] types = {"10000100000000090000000000105966"};
...
<head>
    <title>3.15在行动</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-03-15.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{width:311px;height:103px;left:17px;top:185px;background-position: 0px 0px;}
        .mask2{width:307px;height:108px;left:928px;top:111px;background-position: 0px -110px;}
        .mask3{width:339px;height:58px;left:24px;top:326px;background-position: 0px -220px;}
        .mask4{width:271px;height:80px;left:908px;top:252px;background-position: 0px -330px;}
        .mask5{width:305px;height:95px;left:185px;top:467px;background-position: 0px -440px;}
        .mask6{width:264px;height:76px;left:958px;top:399px;background-position: 0px -550px;}
           ...
           <%
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    value += ",{name:'活动细则',style:'mask mask6',playType:-3,link:'/EPG/jsp/defaultHD/en/iCatch_yulq_list.jsp?typeId=10000100000000090000000000105965&pageLength=8'}";
                    value += "]},";
                }
                out.write(value);
            }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-03-15.jpg') no-repeat;" onUnload="exit();"></body>
</html>