...
<%
    ...
    final String[] types = {"10000100000000090000000000104930"};
...
<head>
    <title>年夜饭?家乡味</title>
    <style>
        .mask {width: 130px;height: 132px; position:absolute;background:transparent url('images/mask-2015-02-17.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {left:77px;top:307px;}
        .mask2 {left:355px;top:307px;}
        .mask3 {left:635px;top:307px;}
        .mask4 {left:910px;top:307px;}
        .mask5 {left:77px;top:436px;}
        .mask6 {left:355px;top:436px;}
        .mask7 {left:635px;top:436px;}
        .mask8 {left:910px;top:436px;}
        .mask9 {left:77px;top:566px;}
        .mask10 {left:355px;top:566px;}
        .mask11 {left:635px;top:566px;}
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if(blocked == focusable.length - 1) {
                        blocked = 0;
                        focus = index == 11 ? 7 : focusable[blocked].items.length - 1;
                    }
                    else {
                        if( focus < 4 && index == 11 || focus % 4 == 0 && index == -1 || focus % 4 == 3 && index == 1 || focus >= 8 && index == -11 ) return;
                        if( index == 1 ) {
                            focus ++;
                            ...
                            if( focus +4 >= focusable[blocked].items.length ) { blocked = focusable.length - 1; focus = focusable[blocked].focus; }
                            else focus += 4;
                        }
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-02-17.jpg') no-repeat;" onUnload="exit();"></body>
</html>