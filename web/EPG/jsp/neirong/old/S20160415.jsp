...
<%
    ...
    final String[] types = {"10000100000000090000000000106120"};
...
<head>
    ...
    <style>
        .mask {width:236px;height:83px;position:absolute;background:transparent url('images/mask-2016-04-15.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {left:945px;top:76px;background-position: 0px 0px;}
        .mask2 {left:881px;top:197px;background-position: 0px -100px;}
        .mask3 {left:945px;top:319px;background-position: 0px -200px;}
        .mask4 {left:880px;top:442px;background-position: 0px -300px;}

        .mask5,.focusedBg {width:305px;height:125px;left:925px;top:523px;background-position: 0px 0px;background-image: url('images/focusMask-2016-04-15.gif');}
        .focusedBg{position:absolute; background-image: url('images/focusBg-2016-04-15.gif');}
        .flowed {}
        .after {}
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    value += ",{name:'more',style:'mask mask5',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=13&lcn=wdg1'}";
                    value += "]},";
                }
                out.write(value);
            }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-04-15.jpg') no-repeat;" onUnload="exit();"></body>
</html>