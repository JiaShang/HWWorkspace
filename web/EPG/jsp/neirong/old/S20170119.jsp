                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked < focusable.length - 2  && (
                     ...
                     if( blocked == focusable.length - 1) { blocked = 0;focus = focusable[blocked].focus; }
                         ...
                         if( index == 1 ) { if( columns == 1 ) { blocked = focusable.length - 1;focus = focusable[blocked].focus; } else focus += index; }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-01-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>