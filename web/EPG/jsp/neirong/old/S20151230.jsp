...
<%
    ...
    final String[] types = {"10000100000000090000000000105811"};
...
<head>
    <title>金姐来了</title>
    <style>
        .mask {width:276px;height:66px;left:596px; position:absolute;background:transparent url('images/mask-2015-12-30.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {top:79px;background-position: 0px 0px;}
        .mask2 {top:180px;background-position: 0px -70px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0, items : [
                {name:'抢票',style:'mask mask1',playType:-2},
                {name:'回顾',style:'mask mask2'}
            ]},
            <%
            value = "";
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked === 0 && ( index == -1 || index == 11 && focus == 0 )) return;
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:[{blocked:0,item:1,target:1,style:'mask mask2'}],vote:[{blocked:0,item:undefined,id: 299}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-12-30.jpg') no-repeat;" onUnload="exit();"></body>
</html>