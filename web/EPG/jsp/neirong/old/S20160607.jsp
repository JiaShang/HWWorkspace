...
<head>
    <title>宋仲基见面会</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-06-07.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:144px;height:143px;left:674px;top:384px;background-position: 0px 0px;}
        .mask2 {width:144px;height:143px;left:862px;top:384px;background-position: 0px -150px;}
        .mask3 {width:190px;height:52px;left:673px;top:591px;background-position: 0px -300px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'订购韩剧',style:'mask mask1',playType:-3,link:'http://192.168.5.75/ccn-tv/dg/comboWL/1155?comboCateParentId=1003&terminalType=2',action:[0,0,0,2,0,0,0,1]},
                {name:'注册会员',style:'mask mask2',playType:-3,link:'/EPG/jsp/defaultHD/en/hddb/hjzq/hj_personCenter.jsp',action:[0,1,0,2,0,0,0,1]},
                {name:'活动细则',style:'mask mask3',playType:-3,link:'/EPG/jsp/neirong/S20160607Role.jsp',action:[0,0,0,2,0,2,0,2]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-07.jpg') no-repeat;" onUnload="exit();"></body>
</html>