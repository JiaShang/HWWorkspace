...
<%
    ...
    final String[] types = {"10000100000000090000000000105682"};
...
<head>
    <title>火星救援：艰难生存法则</title>
    <style>
        .mask {width:280px;height:39px;left:411px;position:absolute;background:transparent url('images/mask-2015-11-25.png') no-repeat fixed;background-position: -300px -310px;}
        .mask0 {width:248px;height:51px;left:39px;top:499px;background-position: 0px -310px;}
        .mask1 {left:40px;top:295px;}
        .mask2 {width:339px;left:40px;top:335px;background-position: 0px -370px;}
        .mask3 {top:380px;}
        .mask4 {top:420px;}
        .mask5 {top:460px;}
        .mask6 {top:500px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'抢票',style:'mask mask0',playType:-2}]},
            <%
            value = "";
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == 0 && ( index == -11 || index == -1) ||
                         blocked == 1 && ( index == 11 && focus == 0 || focus + 1 >= focusable[1].items.length && index == -11 ))
                     return;
                    if( blocked == 0 ) {
                        blocked = 1;
                        focus = index == 11 ? 1 : 2;
                        ...
                        if ( index == 11 || index == -11 ) {
                            ...
                            if( focus <= 1 && index == 1) {
                                ...
                                focus = 0;
                                blocked = index == 1 ? focusable.length - 1 : 0;
                            }
                        }
                    }  else {
                        blocked = 1;
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:undefined,id: 254}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div style="width:605px;height:308px;top:303px;left:57px;position: absolute;background:transparent url(images/mask-2015-11-25.png) no-repeat"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-11-25.jpg') no-repeat;" onUnload="exit();"></body>
</html>