...
<%
    ...
    final String[] types = {"10000100000000090000000000106960"};
...
<head>
    ...
    <style>
        .mask {width:54px;height:174px;top:106px;position:absolute;background:transparent url('images/mask-2017-01-16.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:586px;background-position:0px 0px;}
        .mask2 {left:683px;background-position:-60px 0px;}
        .mask3 {left:800px;background-position:-120px 0px;}
        .mask4 {left:911px;background-position:-180px 0px;}
        .mask5 {left:1036px;background-position:-240px 0px;}
        .mask6 {left:631px;top:385px;background-position:-360px 0px;}
        .mask7 {left:748px;top:385px;background-position:-420px 0px;}
        .mask8 {left:862px;top:385px;background-position:-480px 0px;}
        .mask9 {left:988px;top:385px;background-position:-540px 0px;}
        .mask10 {left:1103px;top:385px;background-position:-600px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-01-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>