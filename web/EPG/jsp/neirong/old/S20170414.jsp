...
<%
    ...
    final String[] types = {"10000100000000090000000000107561"};
...
<head>
    ...
    <style>
        .mask {width:320px;height:662px;top:25px;position:absolute;background:transparent none no-repeat;background-position: 0px 0px;}
        .focus {border:7px solid #FF0000;}
        .mask1 {left:5px;}
        .mask2 {left:308px;}
        .mask3 {left:616px;}
        .mask4 {left:932px;}
        ...
        .before{width:1221px;height:658px;left:30px;top:30px;}
        .after {width: 1198px;height:544px;left:40px;top:47px;background: transparent url('images/focusBg-2017-04-14.png')}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            $("before").style.backgroundImage='url("images/bg-2017-04-14-' + ( Math.floor( focus / columns ) + 1 )  +'.jpg")';
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,vote:undefined,video:undefined,position:undefined,external:{after:'<div class="mask after"></div>',before:'<div class="mask before" id="before"></div>'}}); //
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:#FF0000 url('images/translateBg.png') no-repeat;" onUnload="exit();"></body>
</html>