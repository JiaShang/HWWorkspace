...
<head>
    <title>爱漫游</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-10-14.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:196px;height:37px;left:106px;top:404px;background-position: 0px 0px;}
        .mask2 {width:105px;height:47px;left:108px;top:621px;background-position: 0px -50px;}
    ...
    <script language="javascript" type="text/javascript">
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                            ...
                            str += "}" ;
                        if(j == 0) str += ",{text:'抢票',style:'mask mask2',playType:-2}";
        ...
        var columns = 1; rows = 20;              //定义行列，　几行几列
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:undefined,id: 369}],video:undefined,position:undefined,external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-10-14.jpg') no-repeat;" onUnload="exit();"></body>
</html>