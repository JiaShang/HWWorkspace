...
<head>
    <title>Hold住2016吉猴闹春之快乐寒假</title>
    <style>
        .mask {width:353px;height:155px;position:absolute;background:transparent url('images/mask-2016-01-28.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {left:403px;top:249px}
        .mask2 {left:898px;top:240px}
        .mask3 {left:571px;top:367px}
        .mask4 {left:365px;top:514px}
        .mask5 {left:754px;top:469px}
        .flowed {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'',style:'mask mask1',playType:-3,link:'/EPG/jsp/neirong/S20160125.jsp',action:[0,0,0,2,0,0,0,1]},
                {name:'',style:'mask mask2',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=peisheng',action:[0,1,0,4,0,0,0,1]},
                {name:'',style:'mask mask3',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=singer',action:[0,0,0,3,0,2,0,2]},
                {name:'',style:'mask mask4',playType:-3,link:'/EPG/jsp/neirong/S20160127.jsp',action:[0,2,0,3,0,3,0,4]},
                {name:'',style:'mask mask5',playType:-3,link:'/EPG/jsp/neirong/S20150611.jsp',action:[0,1,-1,0,0,3,0,4]}
            ]},
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,4,-1,0,-1,0,-1,1]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-01-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>