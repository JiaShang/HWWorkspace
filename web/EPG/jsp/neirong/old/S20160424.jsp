...
<%
    ...
    final String[] types = {"10000100000000090000000000106146"};
...
<head>
    <title>从小妹撩到老妹的轩哥儿</title>
    <style>
        .mask {height:40px;position:absolute;background:transparent url('images/mask-2016-04-24.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:217px;left:960px;top:373px;background-position: 0px 0px;}
        .mask2{width:81px;left:1096px;top:417px;background-position: 0px -40px;}
        .mask3{width:118px;left:1059px;top:461px;background-position: 0px -80px;}
        .mask4{width:217px;left:960px;top:504px;background-position: 0px -120px;}
        .mask5{width:118px;left:1059px;top:549px;background-position: 0px -160px;}
        .flowed {}
        .after {width:199px;height:204px;left:970px;top:378px; background-position: 0px -200px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div class="mask after"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-04-24.jpg') no-repeat;" onUnload="exit();"></body>
</html>