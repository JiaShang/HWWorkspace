...
<%
    ...
    try {
        ...
        if( list.size() > 0 ) {
            List<Vod> vods = list.get(0);
            if( vods.size() > 0 ) value = String.valueOf(vods.get(0).getId());
        }
    } catch (Exception e){}
%>
<html>
...
<head>
    <title>Twins世界巡演重庆站门票免费抢</title>
    <style>
        .bg {position:absolute;background:transparent none no-repeat 0px 0px;}
        .bgTop {width:1280px;height:375px;left:0px;top:0px;background-image:url('images/bg-2017-03-15-1.jpg');}
        .bgLeft {width:728px;height:345px;left:0px;top:375px;background-image:url('images/bg-2017-03-15-2.jpg');}
        .bgRight {width:552px;height:345px;left:728px;top:375px;background-image:url('images/bg-2017-03-15-3.png');}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                ...
                html += "<div class='bg bgTop'></div><div class='bg bgLeft'></div><div class='bg bgRight'></div>";
            ...
            $.buildUserInterface({flowed:undefined,vote:undefined,video:'<%= value%>',position:[728,375,473,290],external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
