...
<%
    ...
    final String[] types = {"10000100000000090000000000105167"};
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-06-02.jpg') no-repeat;" onUnload="exit();"></body>
</html>