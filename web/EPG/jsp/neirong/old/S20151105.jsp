...
<%
    ...
    final String[] types = {"10000100000000090000000000105635"};
...
<head>
    <title>网购达人必看这十条</title>
    <style>
        .mask {height:31px;left:53px;position:absolute;background:transparent url('images/mask-2015-11-05.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:174px;top:145px;background-position:0px 0px;}
        .mask2 {width:257px;top:179px;background-position:0px -40px;}
        .mask3 {width:191px;top:212px;background-position:0px -80px;}
        .mask4 {width:220px;top:246px;background-position:0px -120px;}
        .mask5 {width:174px;top:279px;background-position:0px -160px;}
        .mask6 {width:220px;top:312px;background-position:0px -200px;}
        .mask7 {width:292px;top:345px;background-position:0px -240px;}
        .mask8 {width:174px;top:379px;background-position:0px -280px;}
        .mask9 {width:197px;top:412px;background-position:0px -320px;}
        .mask10 {width:197px;top:445px;background-position:0px -360px;}

        .mask21{width:139px;height:35px;left:47px;top:620px;background-position:0px -400px;}
        .mask22{width:157px;height:35px;left:190px;top:620px;background-position:0px -440px;}
        .mask23{width:139px;height:35px;left:47px;top:649px;background-position:0px -480px;}
        .mask24{width:139px;height:35px;left:190px;top:649px;background-position:0px -520px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            {
                focus:0, items:[
                {text:"A. 经常网购",playType:-2,style:"mask mask21"},
                {text:"B. 一周两三次",playType:-2,style:"mask mask22"},
                {text:"C. 一周一次",playType:-2,style:"mask mask23"},
                {text:"D. 从不网购",playType:-2,style:"mask mask24"},
            ]},
        ...
        var columns = 1; rows = 11;              //定义行列，　几行几列
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if(
                    ...
                    blocked == focusable.length - 1 && ( index == 11 || index == -11 || focus == 1 && index == 1 ) ||
                    //如果焦点在投票上,按上下左右键时
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == 0  && (
                         ...
                         index == -11 && (focus + columns >= focusable[blocked].items.length && arrows[0] == 0 || arrows[0] == 1 && focus + 1 != focusable[blocked].items.length && focus + columns + 1 > focusable[blocked].items.length ) //按下光标键时
                     ) || ( blocked == 1 && (focus % 2 == 0 && index == -1 || focus >= 2 && index == -11)) ) return;
                     if( blocked == focusable.length - 1) { blocked = 1;focus = focusable[blocked].focus; }
                     else if( blocked == 0 ) {
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:1,item:undefined,id: 252}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-11-05.jpg') no-repeat;" onUnload="exit();"></body>
</html>