...
<head>
    <title>乐视体育青少年运动嘉华</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-05-26.png') no-repeat;background-position: 0px -450px;}
        .mask1 {width:285px;height:35px;left:111px;top:465px;background-position: 0px 0px;}
        .mask2 {width:171px;height:35px;left:438px;top:465px;background-position: 0px -40px;}
        .mask3 {width:171px;height:35px;left:109px;top:518px;background-position: 0px -80px;;}
        .mask4 {width:171px;height:35px;left:438px;top:518px;background-position: 0px -120px;}
        .flowed {}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-05-26.jpg') no-repeat;" onUnload="exit();"></body>
</html>