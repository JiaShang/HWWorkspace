...
<%
    ...
    final String[] types = {"10000100000000090000000000107064"};
...
<head>
    <title>2016年电视剧</title>
    <style>
        .mask {width:392px;height:50px;position:absolute;background:transparent url('images/mask-2016-12-26.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:32px;top:137px;background-position:0px 0px;}
        .mask2{left:77px;top:209px;background-position:0px -50px;}
        .mask3{left:127px;top:278px;background-position:0px -100px;}
        .mask4{left:177px;top:348px;background-position:0px -150px;}
        .mask5{left:226px;top:415px;background-position:0px -200px;}
        .mask6{left:848px;top:137px;background-position:0px -250px;}
        .mask7{left:799px;top:209px;background-position:0px -300px;}
        .mask8{left:753px;top:278px;background-position:0px -350px;}
        .mask9{left:705px;top:348px;background-position:0px -400px;}
        .mask10{left:658px;top:415px;background-position:0px -450px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == -1 && focus < 5 || index == 1 && focus >= 5 || index == 11 && focus % 5 == 0 || index == -11 && focus == 4) ) return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-12-26.jpg') no-repeat;" onUnload="exit();"></body>
</html>