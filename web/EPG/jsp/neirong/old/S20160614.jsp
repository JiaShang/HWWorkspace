...
<head>
    <title>欧洲杯-专题</title>
    <style>
        .mask {left:942px;width:268px;height:96px;position:absolute;background:transparent url('images/mask-2016-06-14.png') no-repeat;background-position: 0px 0px;}
        .mask1{top:74px;background-position: 0px 0px;}
        .mask2{top:187px;background-position: 0px -100px;}
        .mask3{top:300px;background-position: 0px -200px;}
        .mask4{top:410px;background-position: 0px -300px;}
        .mask5{width:291px;height:101px;left:925px;top:571px;background-position: 0px -400px;}

        .flowed {}
        .after {width:230px;height:100px;left:1021px;top:601px;background:transparent url('images/focusBg-2016-06-14.gif') no-repeat 0px 0px;position:absolute;}
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        value += str;
                        if( j == 3 ) {
                            value += "{style:'mask mask5',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=14&lcn=yyms'}";
                        }
                    }
                    value += "]},";
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-14.jpg') no-repeat;" onUnload="exit();"></body>
</html>