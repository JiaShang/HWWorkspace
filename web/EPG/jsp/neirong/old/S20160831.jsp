...
<%
    ...
    final String[] types = {"10000100000000090000000000106650"};
...
<head>
    <title>结婚为什么？</title>
    <style>
        .mask {width:274px;height:369px;top:270px;position:absolute;background:transparent url('images/mask-2016-08-31.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:59px;}
        .mask2 {left:281px;}
        .mask3 {left:504px;}
        .mask4 {left:726px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-31.jpg') no-repeat;" onUnload="exit();"></body>
</html>