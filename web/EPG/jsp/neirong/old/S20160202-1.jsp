...
<%
    ...
    final String[] types = {"10000100000000090000000000105872"};
...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-02-02-1.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:135px;height:43px;left:84px;top:456px; background-position: 0px 0px;}
        .mask2 {width:286px;height:66px;left:223px;top:512px; background-position: 0px -70px;}
        .mask3 {width:286px;height:66px;left:524px;top:512px; background-position: 0px -140px;}
        .mask4 {width:286px;height:66px;left:823px;top:512px; background-position: 0px -210px;}
        .mask5 {width:286px;height:66px;left:369px;top:588px; background-position: 0px -280px;}
        .mask6 {width:286px;height:66px;left:671px;top:588px; background-position: 0px -350px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            <%
            value = "";if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    value += "{focus:0,typeId:'" + types[i] + "',items:[";
                    value += "{name:'活动细则',style:'mask mask1',playType:-3,link:'/EPG/jsp/neirong/S20160202-1Rule.jsp'},";
                    value += "{name:'贺岁大片全家看',style:'mask mask2',playType:-3,link:'/EPG/jsp/defaultHD/en/highvod_happy_classify.jsp?typeId=10000100000000090000000000105870&pageSize=100&startIndex=0'},";
                    value += "{name:'有家有爱',style:'mask mask3',playType:-3,link:'/EPG/jsp/neirong/S20160202.jsp'},";
                    value += "{name:'教你买年货',style:'mask mask4',playType:-3,link:'/EPG/jsp/neirong/S20160201.jsp'},";
                    value += "{name:'全家欢唱',style:'mask mask5',playType:-3,link:'http://192.168.48.217:8085/iptv/entrance.jsp?gpid=129'},";
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus <= 3 && index == 11 || focus >= 4 && index == -11  || ( focus == 0 || focus == 4 ) && index == -1 || focus == 3 && index == 1 ) )
                        return ;
                    if( blocked == focusable.length - 1 ) {
                        blocked = 0;
                        focus = index == 11 ? 3 : focusable[0].items.length -1 ;
                    } else if( blocked == 0 ){
                        if( index == 1 || index == -1 ) {
                            focus += index;
                            if( focus > focusable[blocked].items.length - 1 )
                            {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-02-02-1.jpg') no-repeat;" onUnload="exit();"></body>
</html>