...
<%
    ...
    final String[] types = {"10000100000000090000000000106747"};
...
<head>
    <title>导演篇</title>
    <style>
        .mask {width:188px;height:256px;position:absolute;background:transparent url('images/mask-2016-10-181.png') no-repeat;background-position: 0px -260px;}
        .item1 {left:70px;top:155px;}
        .item2 {left:272px;top:155px;}
        .item3 {left:473px;top:155px;}
        .item4 {left:272px;top:417px;}
        .item5 {left:473px;top:417px;}
        .focus {background-position: 0px 0px;}

        .text {width:159px;height:22px;font-size: 18px; line-height: 22px; color:#ffffff;position:absolute; text-align: center;}
        .text1 {left:82px;top:357px;}
        .text2 {left:284px;top:357px;}
        .text3 {left:486px;top:357px;}
        .text4 {left:284px;top:620px;}
        .text5 {left:486px;top:620px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus <= 2 && index == 11 || ( focus == 0 || focus == 3 ) && index == -1 || focus == 2 && index == 1 || ( focus >= 3 || focus == 0 ) && index == -11 )) return;
                    if( blocked == 0 ) {
                        if( index == 1 || index == -1 ) {
                            if( focus + 1 == focusable[blocked].items.length && index == 1) {
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                if( i == focus && blocked == index ){
                    $("item" + ( i + 1 )).className = "mask item" + ( i + 1) + " focus";
                    ...
                    $("item" + ( i + 1 )).className = "mask item" + ( i + 1);
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                ...
                if(typeof option.flowed != 'undefined' ) {
                    html += "<div id='item1'></div><div id='item2'></div><div id='item3'></div><div id='item4'></div><div id='item5'></div><div id='text1'></div><div id='text2'></div><div id='text3'></div><div id='text4'></div><div id='text5'></div>";
                    focusable.flowed = [];
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-10-181.jpg') no-repeat;" onUnload="exit();"></body>
</html>