...
<%
    ...
    final String[] types = {"10000100000000090000000000106600"};
...
<head>
    ...
    <style>
        .mask {width:247px;height:34px;position:absolute;background:transparent url('images/mask-2016-11-02.png') no-repeat;background-position: 0px 0px;}
        .bgLeft{position:absolute;width:745px;height:720px;left:535px;top:0px;background:transparent url('images/bg-2016-11-02-3.jpg') no-repeat 0px 0px; }
        .bgBottom{position:absolute;width:535px;height:313px;left:0px;top:407px;background:transparent url('images/bg-2016-11-02-2.jpg') no-repeat 0px 0px; }

        .mask1 {left:46px;top:451px;background-position:0px 0px;}
        .mask2 {left:46px;top:498px;background-position:0px -40px;}
        .mask3 {left:46px;top:546px;background-position:0px -80px;}
        .mask4 {left:46px;top:594px;background-position:0px -120px;}
        .mask5 {left:46px;top:642px;background-position:0px -160px;}
        .mask6 {left:324px;top:451px;background-position:0px -200px;}
        .mask7 {left:324px;top:498px;background-position:0px -240px;}
        .mask8 {left:324px;top:546px;background-position:0px -280px;}
        .mask9 {left:324px;top:594px;background-position:0px -320px;}
        .mask10 {left:324px;top:642px;background-position:0px -360px;}
        .mask11 {width:335px;height:73px;left:645px;top:617px;background-position:0px -400px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items : [{name:'订购',style:'mask mask11',playType:-3,link:'/EPG/jsp/neirong/S20161102-1.jsp'}]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus % 5 === 0 && index == 11 || focus <= 4 && index == -1 || ( focus % 5 === 4 || focus + 1 >= focusable[blocked].items.length ) && index == -11 ) ||
                        blocked == 1 && ( index == 11 || index == -11 ) ) return;
                    if( blocked === focusable.length - 1 ) {
                        blocked = 1; focus = 0;
                    } else if( blocked === 0) {
                        if( index == 11 || index == -11 ) {
                            focus += index > 0 ? -1 : 1;
                        } else if( index == -1 ) focus -= 5;
                        else {
                            focus += 5;
                        ...
                        blocked = index == -1 ? 0 : focusable.length - 1; focus = focusable[blocked].focus;
                    }
                }
        ...
        function init(){
            ...
            focusable[0].items = focusable[0].items.splice(1,10);
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:cricleId,position:[51,135,484,271],external:{after:undefined,before:'<div class="bgLeft"></div><div class="bgBottom"></div>'}}); //
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:transparent url('images/bg-2016-11-02-1.png') no-repeat;" onUnload="exit();"></body>
</html>