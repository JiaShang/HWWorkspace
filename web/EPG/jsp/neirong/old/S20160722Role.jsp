...
<head>
    ...
    <style>
        ...
        .btnHome {position:absolute;background: transparent url("images/navBG.png") no-repeat; top:636px;left:113px; width:161px;height:41px; background-position: 0px 0px;}
        .btnReturn{position:absolute;background: transparent url("images/navBG.png") no-repeat; top:636px;left:113px; width:161px; height:41px; background-position: 0px -42px;}
    </style>
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-07-22Role.jpg') no-repeat;" onUnload="exit();"></body>
</html>