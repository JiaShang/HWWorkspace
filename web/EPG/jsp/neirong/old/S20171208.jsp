...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-12-08.png') no-repeat;background-position: 0px 0px;}
        .itemx {width:161px;height:142px;left:83px;top:45px;background-position: 0 -180px;}
        .itemxFocus {width:196px;height:178px;left:65px;top:21px;background-position: 0 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        .                    }
            ...
            %>
            { focus:0,items : [{name:'看电影送好礼',playType:-3,link:'http://192.168.18.146:8082/mo_msc/item.h?id=36'}]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( blocked == 0 && ( index == -11 || index == -1 && focus <= 0 || index == 1 && focus + 1 >= focusable[blocked].items.length ) || blocked === 1 && index != -11 ) return;
                    if( index == 11 ) {
                        blocked = 1; focus = 0;
                    } else if ( index == -11 ) {
            ...
            $("mask").className = blocked == 0 ? "mask itemx" : "mask itemxFocus";
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                ...
                html += "<div id='mask' class='mask itemx'></div>";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-12-08.jpg') no-repeat;" onUnload="exit();"></body>
</html>