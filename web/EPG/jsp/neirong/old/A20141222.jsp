...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104743";
...
<head>
<title>贺岁头炮戏一步之遥</title>
<style>
    .mask {position:absolute;width:451px; height:38px;background:transparent url('images/mask-2014-12-22.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1 {left:444px; top:433px;background-position: 0px 0px;}
    .mask2 {left:444px; top:476px;background-position: 0px -40px;}
    .mask3 {left:444px; top:519px;background-position: 0px -80px;}
    .mask4 {left:444px; top:562px;background-position: 0px -120px;}
    .mask5 {left:903px; top:432px;background-position: 0px -160px;}
    .mask6 {left:903px; top:476px;background-position: 0px -200px;}
    .mask7 {left:903px; top:518px;background-position: 0px -240px;}
...
<script language="javascript" type="text/javascript">
    ...
    var focusable = focusable ? focusable : [
        { focus:0, items : [
            <%
                String[] actions = "[0,0,0,1,0,0,0,4]|[0,0,0,2,0,1,0,5]|[0,1,0,3,0,2,0,6]|[0,2,0,3,0,3,1,0]|[0,4,0,5,0,0,0,4]|[0,4,0,6,0,1,0,5]|[0,5,1,0,0,2,0,6]".split("\\|");
        ...
        { focus:0, items : [
            {name:'首页',style:'btnHome',action:[0,6,1,0,0,3,1,1]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-12-22.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>