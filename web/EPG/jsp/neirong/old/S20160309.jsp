...
<head>
    <title>三月观影指南</title>
    <style>
        .mask {height:50px;position:absolute;background:transparent url('images/mask-2016-03-09.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{width:177px;left:55px;top:294px;background-position: 0px 0px;}
        .mask2{width:177px;left:302px;top:294px;background-position: 0px -60px;}
        .mask3{width:189px;left:541px;top:294px;background-position: 0px -120px;}
        .mask4{width:189px;left:792px;top:294px;background-position: 0px -180px;}
        .mask5{width:189px;left:49px;top:628px;background-position: 0px -240px;}
        .mask6{width:189px;left:296px;top:629px;background-position: 0px -300px;}
        .mask7{width:189px;left:541px;top:628px;background-position: 0px -360px;}
        .mask8{width:196px;height:74px;left:789px;top:605px;background-position: 0px -420px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-03-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>