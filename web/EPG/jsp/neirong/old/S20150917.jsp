...
<%
    ...
    final String[] types = {"10000100000000090000000000105520"};
...
<head>
    <title>金秋献礼第二弹</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-09-17.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{width:163px;height:26px;left:315px;top:336px;background-position:0px 0px;}
        .mask2{width:109px;height:26px;left:561px;top:335px;background-position:0px -40px;}
        .mask3{width:194px;height:26px;left:315px;top:375px;background-position:0px -80px;}
        .mask4{width:166px;height:26px;left:560px;top:375px;background-position:0px -120px;}
        .mask5{width:150px;height:26px;left:315px;top:415px;background-position:0px -160px;}
        .mask6{width:164px;height:26px;left:561px;top:416px;background-position:0px -200px;}
        .mask7{width:107px;height:26px;left:315px;top:454px;background-position:0px -240px;}
        .mask8{width:186px;height:32px;left:555px;top:491px;background-position:0px -280px;}
    ...
    <script language="javascript" type="text/javascript">
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                            ...
                            str += "}" ;
                            if( j == 6 ) str += ",{playType:-2,text:'抢票特别企划',style:'mask mask8'}";
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:7,id: 236}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-09-17.jpg') no-repeat;" onUnload="exit();"></body>
</html>