...
<%
    ...
    final String[] types = {"10000100000000090000000000107995"};
...
<head>
    ...
    <style>
        .mask {height:23px;position:absolute;background:transparent url('images/mask-2017-07-11.png') no-repeat;background-position: 0px 0px;}
        ...
        .mask3 {width:118px;left:708px;top:571px;background-position: 0px -50px;}
        .mask4 {width:118px;left:708px;top:611px;background-position: 0px -75px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-07-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>