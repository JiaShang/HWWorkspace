...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104671";
...
<head>
<title>麻辣言子儿逗山城第二季</title>
    <style>
    .mask {width:325px;height: 23px;left:478px;position:absolute;background:transparent url('images/mask-2014-11-13.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1 {top:445px;}
    .mask2 {top:482px;}
    .mask3 {top:521px;}
    .mask4 {top:557px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-11-13.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>