...
<%
    ...
    final String[] types = {"10000100000000090000000000107320"};
...
<head>
    <title>越狱重磅回归</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-03-02.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:87px;height:19px;left:512px;top:103px;background-position: 0px 0px;}
        .mask2 {width:87px;height:19px;left:701px;top:119px;background-position: 0px -20px;}
        .mask3 {width:87px;height:19px;left:889px;top:133px;background-position: 0px -40px;}
        .mask4 {width:87px;height:19px;left:1079px;top:152px;background-position: 0px -60px;}
        .mask5 {width:180px;height:44px;left:478px;top:572px;background-position: 0px -80px;}
        .mask6 {width:127px;height:37px;left:701px;top:554px;background-position: 0px -130px;}
        .mask7 {width:103px;height:35px;left:871px;top:536px;background-position: 0px -170px;}
        .mask8 {width:151px;height:41px;left:1019px;top:514px;background-position: 0px -210px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-03-02.jpg') no-repeat;" onUnload="exit();"></body>
</html>