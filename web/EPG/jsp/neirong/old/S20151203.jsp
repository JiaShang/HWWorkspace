...
<%
    ...
    final String[] types = {"10000100000000090000000000105700"};
...
<head>
    <title>12月观影指南</title>
    <style>
        .mask {width:200px;height:268px;position:absolute;background:transparent url('images/mask-2015-12-03.png') no-repeat fixed;background-position: 0px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-12-03.jpg') no-repeat;" onUnload="exit();"></body>
</html>