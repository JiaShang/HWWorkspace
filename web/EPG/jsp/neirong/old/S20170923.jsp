...
<%
    ...
    final String[] types = {"10000100000000090000000000108421"};//第69届艾美奖热剧大赏  10000100000000090000000000108421
...
<head>
    ...
    <style>
        .mask {width:20px;height:20px;left:538px;position:absolute;background:transparent url('images/mask-2017-09-23.png') no-repeat;background-position: 0px 0px;}
        .mask1{top:334px;}
        .mask2{top:388px;}
        .mask3{top:440px;background-position: 0px -20px;}
        .mask4{left:564px;top:440px;background-position: 0px -40px;}
        .mask5{left:589px;top:440px;background-position: 0px -60px;}
        .mask6{left:615px;top:440px;background-position: 0px -80px;}
        .mask7{top:558px;}
        .mask8{left:555px;top:592px;background-position: 0px -20px;}
        .mask9{left:581px;top:592px;background-position: 0px -40px;}
        .mask10{left:606px;top:592px;background-position: 0px -60px;}
        .mask11{left:632px;top:592px;background-position: 0px -80px;}
        .mask12{top:625px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if(index == 11 && focus <= 0 || index == -11 && focus + 1 >= focusable[0].items.length  || index == -1 && (focus <= 2 || focus == 11 || focus == 6 || focus == 7) || index == 1 && ( focus <= 1 || focus >= 10 || focus == 5 || focus == 6 )) return;
                    if( index == -1 || index == 1 ) {
                        focus += index;
                    } else if(index == -11){
                        if(focus >= 2 && focus <= 5) {
        ...
        function doEnter(){
            ...
            switch(item.playType){
                ...
                case -3:
                    ...
                    break;
                case 1:
                    top.window.location.href = $.current() + "/EPG/jsp/defaultHD/en/hddb/" + ( isKorean ? "hjzq/hj_tvD" : 'western/eu_tvD'/*'western/eu_tvD'*/) + "etail.jsp?vodId=" + item.mid + "&typeId=" + typeId;
                    break;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-09-23.jpg') no-repeat;" onUnload="exit();"></body>
</html>