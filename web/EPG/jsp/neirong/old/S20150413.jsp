...
<%
    ...
    final String[] types = {"10000100000000090000000000105043"};
...
<head>
    <title>速度与激情</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-04-13.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:164px;height:29px;background-position:0px 0px;left:80px; top:367px;}
        .mask2 {width:168px;height:29px;background-position:0px -40px;left:78px; top:407px;}
        .mask3 {width:168px;height:29px;background-position:0px -80px;left:78px; top:447px;}
        .mask4 {width:168px;height:29px;background-position:0px -120px;left:78px; top:487px;}
        .mask5 {width:168px;height:29px;background-position:0px -160px;left:78px; top:527px;}
        .mask6 {width:168px;height:29px;background-position:0px -200px;left:78px; top:567px;}
        .mask7 {width:293px;height:29px;background-position:0px -240px;left:718px; top:367px;}
        .mask8 {width:387px;height:29px;background-position:0px -280px;left:718px; top:407px;}
        .mask9 {width:505px;height:29px;background-position:0px -320px;left:718px; top:447px;}
        .mask10 {width:430px;height:29px;background-position:0px -360px;left:718px; top:487px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && (focus <= 5 && (index == -1 || focus == 0 && index == 11 || focus == 5 && index == -11 ) || focus > 5 && ( index == 1 ||  focus == 6 && index == 11  ) ) ) return;
                    if( blocked == focusable.length - 1) {
                        blocked = 0;
                        focus = index == 11 ? focusable[blocked].items.length - 1 : saved[0];
                    }
                    else if( blocked == 0 ){
                        if( focus <= 5 ) {
                            if( index == 1 ){
                                saved[0] = focus;
                                focus = saved[1] >= focusable[blocked].items.length ? focusable[blocked].items.length - 1 : saved[1];
                            }
                            ...
                            if( index == -1 ) {
                                ...
                                if( focus >= focusable[blocked].items.length ) {
                                    saved[1] = focusable[blocked].items.length - 1;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-04-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>