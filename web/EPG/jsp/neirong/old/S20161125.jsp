...
<%
    ...
    final String[] types = {"10000100000000090000000000106942"};
...
<head>
    <title>亡命之徒改</title>
    <style>
        .mask {width:239px;height:319px;top:321px;position:absolute;background:transparent url('images/mask-2016-11-25.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:66px;}
        .mask2{left:291px;}
        .mask3{left:516px;}
        .mask4{left:740px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-25.jpg') no-repeat;" onUnload="exit();"></body>
</html>