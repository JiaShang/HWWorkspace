...
<%
    ...
    final String[] types = {"10000100000000090000000000108386"};
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    value += "{focus:0,typeId:'" + types[i] + "',items:[{text:'食为奴',length:6,shortText:'食为奴',picture:'images/item-2017-09-15-1.jpg',playType:-3,link:'http://epgServer/defaultHD/en/Category.jsp?url=http://chongqingtvb-utc.wasu.cn/a?f=72516&t=37&a=10640079'},";
