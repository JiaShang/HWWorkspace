...
<%
    ...
    final String[] types = {"10000100000000090000000000104961"};
...
<head>
    <title>三月观影指南</title>
    <style>
        .mask {position:absolute;width:229px;height:287px;background:transparent url('images/mask-2015-03-06.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {left:46px; top:164px;}
        .mask2 {left:240px; top:137px;}
        .mask3 {left:429px; top:112px;}
        .mask4 {left:618px; top:85px;}
        .mask5 {left:415px; top:388px;}
        .mask6 {left:602px; top:362px;}
        .mask7 {left:790px; top:337px;}
        .mask8 {left:978px; top:311px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:transparent url('images/bg-2015-03-06.jpg') no-repeat;" onUnload="exit();"></body>
</html>