...
<%
    ...
    final String[] types = {"10000100000000090000000000106143"};
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-03.jpg') no-repeat;" onUnload="exit();"></body>
</html>