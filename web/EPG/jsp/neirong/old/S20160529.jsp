...
<head>
    <title>搞破坏联萌</title>
    <style>
        .mask {width:95px;height:81px;position:absolute;background:transparent url('images/mask-2016-05-29.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:499px;top:219px;}
        .mask2 {left:499px;top:258px;}
        .mask3 {left:499px;top:297px;}
        .mask4 {left:499px;top:336px;}
        .mask5 {left:499px;top:375px;}
        .mask6 {left:726px;top:219px;}
        .mask7 {left:726px;top:258px;}
        .mask8 {left:726px;top:297px;}
        .mask9 {left:726px;top:336px;}
        .mask10 {left:726px;top:375px;}
        .mask11 {left:726px;top:415px;}
        .flowed {}
        .after {}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( ( focus == 0 || focus == 5 ) && index == 11 || focus <= 4 && index == -1 || focus >= 5 && index == 1 || focus == 4 && index == -11 )) return ;
                    if( blocked == focusable.length - 1 ) { blocked = 0;focus = focusable[blocked].focus; }
                    else {
                        if( index == 11 || index == -11 ) {
                            focus += index > 0 ? -1 : 1;
                            if( focus >= focusable[0].items.length ) { blocked = focusable.length - 1; focus = 0;}
                        } else {
                            if( focus == 10 && index == -1 ){ focus = 4;}
                            else focus += 5 * index;
                        }
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-29.jpg') no-repeat;" onUnload="exit();"></body>
</html>