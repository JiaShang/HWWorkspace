...
<%
    ...
    final String[] types = {"10000100000000090000000000106140"};
...
<head>
    <title>点击必要好货</title>
    <style>
        .mask {width:290px;height:108px;left:910px;position:absolute;background:transparent url('images/mask-2016-06-23.png') no-repeat;background-position: 0px 0px;}

        .flowed {}

        .mask0 {width:243px;height:148px;left:182px;top:446px;background-position: 0px -440px;}
        .mask1 {top:87px;background-position: 0px 0px;}
        .mask2 {top:216px;background-position: 0px -110px;}
        .mask3 {top:342px;background-position: 0px -220px;}
        .mask4 {top:469px;background-position: 0px -330px;}

        .after {width:69px;height:444px;left:1130px;top:141px;background-position: -300px 0px;}
        .before {width:248px;height:153px;left:180px;top:444px;background:transparent url('images/focusBg-2016-06-23.gif') no-repeat;background-position:0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'活动细则',style:'mask mask0',playType:-3,link:'http://192.168.35.153:8080/index.jsp?lcn=yyx'}]},
            <%
            value = "";
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == 0 && index != 1 || blocked == 1 && (
                         index == 11 && focus <= 0 ||
                         index == 1 || index == -11 && focus + 1 >= focusable[1].items.length ) ) return;
                     if( blocked == focusable.length - 1 || blocked == 0 ) { blocked = 1;focus = focusable[blocked].focus; }
                     else {
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:'<div class="mask after"></div>',before:'<div class="mask before"></div>'}}); //
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-23.jpg') no-repeat;" onUnload="exit();"></body>
</html>