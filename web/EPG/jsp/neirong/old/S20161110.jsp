...
<%
    ...
    final String[] types = {"10000100000000090000000000106862"};
...
<head>
    ...
    <style>
        ...
        .flowed {width:1200px;left:89px;top:363px;height:245px;overflow:hidden;position: absolute;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function goBack(keyBack){
            ...
            if(blocked == focusable.length - 1 && focusable[blocked].focus == 0 || EPGflag || typeof keyBack == 'boolean' && !keyBack )
            {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>