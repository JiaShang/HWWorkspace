...
<%
    ...
    final String[] types = {"10000100000000090000000000106190"};
...
<head>
    <title>端午吃什么，别忘了做这几道菜</title>
    <style>
        .mask {left:1004px;width:244px;height:90px;position:absolute;background:transparent url('images/mask-2016-06-08.png') no-repeat;background-position: 0px 0px;}
        .mask1{top:63px;background-position: 0px 0px;}
        .mask2{top:197px;background-position: 0px -100px;}
        .mask3{top:369px;background-position: 0px -200px;}
        .mask4{top:503px;background-position: 0px -300px;}
        .mask5{left:1021px;top:601px;background-position: 0px -400px;}

        .flowed {}
        .after {width:230px;height:100px;left:1021px;top:601px;background:transparent url('images/focusBg-2016-06-08.gif') no-repeat 0px 0px;position:absolute;}
    ...
    <script language="javascript" type="text/javascript">
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        value += str;
                        if( j == 3 ) {
                            value += "{style:'mask mask5',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=14&lcn=duanwujie'}";
                        }
                    }
                    value += "]},";
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:'<div class="after"></div>'}}); //
        ...
        function doEnter(){
            ...
            switch(item.playType){
                ...
                case -3:
                    ...
                    break;
                case 1:
                    top.window.location.href = $.current() + "/EPG/jsp/defaultHD/en/hddb/" + ( isKorean ? "hjzq/hj_tvD" : 'vod/tv_') + "etail.jsp?vodId=" + item.mid + "&typeId=" + typeId;
                    break;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-08.jpg') no-repeat;" onUnload="exit();"></body>
</html>