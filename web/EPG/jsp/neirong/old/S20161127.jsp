...
<%
    ...
    final String[] types = {"10000100000000090000000000106962"};
...
<head>
    <title>造乐者 林忆莲演唱会抢票</title>
    <style>
        .mask {width:349px;height:58px;left:894px;position:absolute;background:transparent url('images/mask-2016-11-27.png') no-repeat;background-position: 0px 0px;}
        .bgLeft{position:absolute;width:386px;height:720px;left:0px;top:0px;background:transparent url('images/bg-2016-11-27-1.jpg') no-repeat 0px 0px; }
        .bgTop{position:absolute;width:496px;height:209px;left:386px;top:0px;background:transparent url('images/bg-2016-11-27-2.jpg') no-repeat 0px 0px; }
        .bgBottom{position:absolute;width:496px;height:231px;left:386px;top:489px;background:transparent url('images/bg-2016-11-27-3.jpg') no-repeat 0px 0px; }
        .bgRight{position:absolute;width:398px;height:720px;left:882px;top:0px;background:transparent url('images/bg-2016-11-27-4.jpg') no-repeat 0px 0px; }

        .mask1 {top:211px;background-position:0px 0px;}
        .mask2 {top:275px;background-position:0px -60px;}
        .mask3 {top:341px;background-position:0px -120px;}
        .mask4 {top:406px;background-position:0px -180px;}

        .mask2x {width:220px;height:69px;top:500px;}
        .mask21 {left:382px;background-position:0px -240px;}
        .mask22 {left:598px;background-position:0px -310px;}
        .mask23 {left:815px;background-position:0px -380px;}
        .mask24 {left:1031px;background-position:0px -450px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items : [
                {name:'艺术青少年组',style:'mask mask2x mask21',playType:-3,link:'/EPG/jsp/neirong/S20161127Vote.jsp?group=1'},
                {name:'艺术成年组',style:'mask mask2x mask22',playType:-3,link:'/EPG/jsp/neirong/S20161127Vote.jsp?group=2'},
                {name:'乡镇青少年组',style:'mask mask2x mask23',playType:-3,link:'/EPG/jsp/neirong/S20161127Vote.jsp?group=3'},
                {name:'乡镇成年组',style:'mask mask2x mask24',playType:-3,link:'/EPG/jsp/neirong/S20161127Vote.jsp?group=4'}
            ]},
        ...
        function init(){
            ...
            focusable[0].items = focusable[0].items.splice(1,4);
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:cricleId,position:[386,209,496,280],external:{after:undefined,before:'<div class="bgLeft"></div><div class="bgTop"></div><div class="bgBottom"></div><div class="bgRight"></div>'}}); //
