...
<%
    ...
    final String[] types = {"10000100000000090000000000105302"};
...
<head>
    <title>全球高冷格斗大赛</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-07-02.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:213px;height:31px;left:102px;top:411px;background-position: 0px 0px;}
        .mask2 {width:85px;height:31px;left:102px;top:446px;background-position: 0px -40px;}
        .mask3 {width:109px;height:31px;left:102px;top:480px;background-position: 0px -80px;}
        .mask4 {width:109px;height:31px;left:102px;top:515px;background-position: 0px -120px;}
        .mask5 {width:109px;height:31px;left:367px;top:555px;background-position: 0px -160px;}
        .mask6 {width:133px;height:31px;left:367px;top:590px;background-position: 0px -200px;}
        .mask7 {width:133px;height:31px;left:367px;top:624px;background-position: 0px -240px;}
        .mask8 {width:126px;height:31px;left:664px;top:628px;background-position: 0px -280px;}
        .mask9 {width:133px;height:31px;left:917px;top:511px;background-position: 0px -320px;}

        .vote1 {width:136px;height:27px;left:354px;top:284px;background-position: 0px -360px;}
        .vote2 {width:136px;height:27px;left:492px;top:284px;background-position: 0px -400px;}
        .vote3 {width:136px;height:27px;left:631px;top:284px;background-position: 0px -440px;}
        .vote4 {width:136px;height:27px;left:769px;top:284px;background-position: 0px -480px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items:[
                {name:'A. 中国功夫片',style:'mask vote1',playType:-2},
                {name:'B. 泰拳格斗',style:'mask vote2',playType:-2},
                {name:'C. 欧美博击',style:'mask vote3',playType:-2},
                {name:'D. 都喜欢',style:'mask vote4',playType:-2},
            ]},
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if(
                         blocked === 1 && ( index == 11 || focus == 0 && index == -1 || focus == focusable[blocked].items.length - 1 && index == 1) ||
                         blocked === 0 && ( focus <= 3 && index == -1 || ( focus == 3 || focus == 6 || focus == 7 ) && index == -11 || focus == 8 && index == 1 )
                     )  return;
                     if( blocked == 1 ) {
                         ...
                         if( index == 11 ) {
                             if( focus == 0 || focus == 4 || focus == 7 || focus == 8 ) { blocked = 1; focus = focusable[blocked].focus; }
                             else focus -= 1;
                         }  else if( index == -11 ) {
                             if( focus == 8 ) { blocked = focusable.length - 1; focus = focusable[blocked].focus; }
                             else focus += 1;
                         } else if( index == -1 ){
                             if( focus == 8 ) focus = 7;
                             else if( focus == 7 ) focus = 6;
                             else focus = 3;
                         } else if( index == 1 ) {
                             if( focus < 4 ) focus = 4;
                             else if( focus < 7 ) focus = 7;
                             else focus = 8;
                         }
                     } else if( blocked == focusable.length - 1 )  {
                         blocked = 0; focus = index == -1 ? 7 : 8;
                     }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:1,item:undefined,id: 224}],video:undefined,position:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-07-02.jpg') no-repeat;" onUnload="exit();"></body>
</html>