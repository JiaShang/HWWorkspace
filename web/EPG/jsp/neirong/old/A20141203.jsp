...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104708";

    int length = 3, start = 0;
    int focused = 0;
    int area = 0;
    String backUrl = "";
    String value = "";
...
<title>贺岁片哪家强</title>
    <style>
    .mask {position:absolute;height: 50px;left:328px;background:transparent url('images/mask-2014-12-03.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1 {width:512px;top:415px;background-position: 0px 0px;}
    .mask2 {width:635px;top:478px;background-position: 0px -63px;}
    .mask3 {width:493px;top:538px;background-position: 0px -123px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-12-03.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>