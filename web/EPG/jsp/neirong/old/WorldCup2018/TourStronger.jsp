...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000109544";  //爱看策划： (getTypeList)
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:transparent url('images/carnivalFan.jpg') no-repeat;" onUnload="exit();">
