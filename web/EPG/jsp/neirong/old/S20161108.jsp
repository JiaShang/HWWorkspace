...
<%
    ...
    final String[] types = {"10000100000000090000000000106860"};
...
<head>
    <title>看西部世界 品味美式生活</title>
    <style>
        .mask {width:150px;height:57px;top:536px;position:absolute;background:transparent url('images/mask-2016-11-08.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:70px;}
        .mask2{left:237px;}
        .mask3{left:410px;}
        .mask4{width:127px;height:33px;left:611px;top:525px;background-position: -150px 0px;}
        .mask5{width:91px;height:33px;left:740px;top:525px;background-position: -280px 0px;}
        .mask6{width:106px;height:33px;left:833px;top:525px;background-position: -370px 0px;}
        .mask7{width:129px;height:33px;left:943px;top:525px;background-position: -480px 0px;}

        .flowed {}
        .after {width:576px;height:410px;left:582px;top:157px;background-position: 0px -60px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    value += "{focus:0,typeId:'" + types[i] + "',items:[{name:'包月订购',style:'mask mask1',playType:-3,link:'http://tvservicehall.cqccn.com/ccn-tv/dg/comboWL/1382?comboCateParentId=1003&terminalType='},{name:'包年订购',style:'mask mask2',playType:-3,link:'http://tvservicehall.cqccn.com/ccn-tv/dg/comboWL/1421?comboCateParentId=1003&terminalType='},{name:'活动细则',style:'mask mask3'},";
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == 0 && ( index == 11 || index == -11 || focus == 0 && index == -1 || index == 1 && focus + 1 >= focusable[blocked].items.length ) ) return;
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:'<div id="after"></div>',before:undefined}}); //
            focusable[0].items[0].link += iPanel.eventFrame.systemId == 1 ? 1 : 2;
            focusable[0].items[1].link += iPanel.eventFrame.systemId == 1 ? 1 : 2;
        ...
        function doEnter(){
            ...
            if( blocked == 99 || blocked == 0 && focusable[0].focus == 2 ) {
                if( consign == false ) {
                    blocked = 99;
                    consign = true;
                    $("after").className = "mask after";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-08.jpg') no-repeat;" onUnload="exit();"></body>
</html>