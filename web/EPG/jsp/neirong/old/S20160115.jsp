...
<%
    ...
    final String[] types = {"10000100000000090000000000105850"};
...
<head>
    <title>期末备考帮你赢</title>
    <style>
        .mask {width:26px;height:26px;position:absolute;background:transparent url('images/mask-2016-01-15.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{left:332px;top:252px;}
        .mask2{left:369px;top:309px;}
        .mask3{left:386px;top:364px;}
        .mask4{left:757px;top:86px;}
        .mask5{left:742px;top:139px;}
        .mask6{left:770px;top:186px;}
        .mask7{left:1161px;top:203px;}
        .mask8{left:1147px;top:257px;}
        .mask9{left:1143px;top:310px;}

        .mask10{width:134px;height:39px;left:979px;top:624px;background-position:-50px 0px;}
        ...
        .btnHome {position:absolute;background: transparent url("images/mask-2016-01-15.png") no-repeat fixed; top:36px;left:1046px; width:83px;height:36px; background-position: 0px -50px;}
        .btnReturn{position:absolute;background: transparent url("images/mask-2016-01-15.png") no-repeat fixed; top:36px;left:1134px; width:83px; height:36px; background-position: -90px -50px;}
    </style>
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items : [{name:'订购',style:'mask mask10',playType:-3,link:'http://192.168.42.52/epg/index/newEast.do'}]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked === 0 && ( ( focus == 0 || focus == 3 ) && index == 11 ||
                                           focus < 3 && index == -1 || focus >= 6 && index == 1 ||
                                           ( focus == 2 || focus == 5 ) && index == -11 ) ||
                        blocked == 1 && index != 11
                    ) return;
                    if( blocked == 0 ) {
                        if( index == 11 ) {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-01-15.jpg') no-repeat;" onUnload="exit();"></body>
</html>