...
<head>
    ...
    <style>
        .mask {width:211px; height:315px;top:299px;position:absolute;background:transparent url('images/mask-2016-06-12.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:55px;background-position: 0px 0px;}
        .mask2 {left:249px;background-position: -220px 0px;}
        .mask3 {left:445px;background-position: -440px 0px;}
        .mask4 {left:645px;background-position: -660px 0px;}
        .mask5 {left:843px;background-position: -880px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-12.jpg') no-repeat;" onUnload="exit();"></body>
</html>