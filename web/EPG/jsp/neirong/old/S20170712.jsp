...
<%
    ...
    final String[] types = {"10000100000000090000000000107961"};
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var voteSwitch = (new Date()).Format("yyyy-MM-dd hh:mm:ss") < "2017-07-19 00:00:00";
        ...
        function queryVoteResult(){
            try {
                $.ajax('http://192.168.49.56:8989/VoteStatistics/getVoteInfo?classifyID=395',function(result){
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:[0],vote:[{blocked:0,item:undefined,id:395}],video:undefined,position:undefined,external:{after:'<div class="page pageNum" id="pageNum">0</div><div class="page pageCount" id="pageCount">0</div>',before:undefined}}); //
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-07-12.jpg') no-repeat;" onUnload="exit();"></body>
</html>