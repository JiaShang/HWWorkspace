...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-03-03.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{width:177px;height:36px;left:123px;top:416px;background-position: 0px 0px;}
        .mask2{width:147px;height:30px;left:337px;top:580px;background-position: 0px -50px;}
        .mask3{width:194px;height:73px;left:636px;top:451px;background-position: 0px -100px;}
        .mask4{width:211px;height:30px;left:935px;top:443px;background-position: 0px -200px;}
        .mask5{width:154px;height:31px;left:1049px;top:303px;background-position: 0px -250px;}
        .flowed {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'安全第一课',style:'mask mask1',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=hwaqyd'},
                {name:'家长第一课',style:'mask mask2',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=jzktzq'},
                {name:'邱政政公益讲座',style:'mask mask3',playType:-3,link:'http://192.168.42.52:8088/epg/newEast/biz_12540079.do'},
                {name:'新学期必看必学',style:'mask mask4',playType:-3,link:'http://192.168.42.52:8088/epg/newEast/biz_49797689/category/ccms_category_84327448/item/subject/39702.do'},
                {name:'名师第一课',style:'mask mask5',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=llkt'},
            ]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus == 0 && index == -1 || focus == 4 && index == 1 || ( focus == 0 || focus == 4 || focus == 2 ) && index == 11 || ( focus ==  2 || focus == 1 ) && index == -11 )) return;
                    if( blocked == 0 ) {
                        if( index == 1 || index == -1 ) {
                            focus += index;
                        } else if( index == 11 ) {
                            ...
                            if( focus == 3 ) { blocked = focusable.length - 1 ; focus = 0; }
                            else focus = focus == 0 ? 1 : 3;
                        }
                    } else {
                        blocked = 0;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-03-03.jpg') no-repeat;" onUnload="exit();"></body>
</html>