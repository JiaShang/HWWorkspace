...
<%
    ...
    final String[] types = {"10000100000000090000000000106378"};
...
<head>
    ...
    <style>
        .mask {height:720px;top:0px;position:absolute;background-position: 0px 0px;}
        .mask1 {width:310px;left:0px;background:transparent url('images/item-2017-05-27-1.png') no-repeat left top;}
        .mask2 {width:316px;left:248px;background:transparent url('images/item-2017-05-27-2.png') no-repeat left top;}
        .mask3 {width:311px;left:505px;background:transparent url('images/item-2017-05-27-3.png') no-repeat left top;}
        .mask4 {width:296px;left:757px;background:transparent url('images/item-2017-05-27-4.png') no-repeat left top;}
        .mask5 {width:282px;left:998px;background:transparent url('images/item-2017-05-27-5.png') no-repeat left top;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-05-27.jpg') no-repeat;" onUnload="exit();"></body>
</html>