...
<%
    ...
    final String[] types = {"10000100000000090000000000105606"};
...
<head>
    <title>山河故人 贾樟柯</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-10-27.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:384px;height:40px;left:101px;top:162px;background-position: 0px 0px;}
        .mask2 {width:384px;height:40px;left:101px;top:200px;background-position: 0px -50px;}
        .mask3 {width:384px;height:40px;left:101px;top:235px;background-position: 0px -100px;}
        .mask4 {width:384px;height:40px;left:101px;top:269px;background-position: 0px -150px;}
        .mask5 {width:384px;height:40px;left:101px;top:302px;background-position: 0px -200px;}
        .mask6 {width:255px;height:45px;left:456px;top:349px;background-position: 0px -250px;}
        .mask7 {width:255px;height:45px;left:456px;top:383px;background-position: 0px -300px;}
        .mask8 {width:255px;height:45px;left:456px;top:420px;background-position: 0px -350px;}

        .mask9 {width:79px;height:26px;left:252px;top:605px;background-position: 0px -400px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0, items : [
                {playType:-2,text:'抢票',style:'mask mask9'}
            ]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if(blocked == 0 && ( focus == 0 && index == 11 || focus != 5 && index == -1 || focus < 4 && index == 1 ) ||
                       blocked == 1 && ( index == -1 || index == -11 )) return;

                    if( blocked == 0 ){
                        if( index == -1 ) { focus = 4 ;}
                        else if( index == 11 ) { focus = focus - 1; }
                        else if( index == 1 ) {
                            if( focus == 4 ) focus ++;
                            else { blocked = focusable.length - 1; focus = 0; }
                        } else {
                            if( focus == 4 ) { blocked = 1; focus = 0; }
                            else {
                                focus = focus + 1;
                                if( focus > focusable[0].items.length -1 ) {
                                    blocked = 1; focus = 0;
                                }
                            }
                        }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:1,item:undefined,id:251}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-10-27.jpg') no-repeat;" onUnload="exit();"></body>
</html>