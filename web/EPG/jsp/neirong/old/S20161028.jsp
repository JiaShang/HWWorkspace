...
<%
    ...
    final String[] types = {"10000100000000090000000000106749"};
...
<head>
    <title>西部世界-HBO科幻新神剧（主演篇）</title>
    <style>
        .mask {position:absolute;background:transparent none no-repeat;background-position: 0px 0px;}
        .item {width:212px;height:40px;position:absolute;background-position: center center;}
        .item1 {left:59px;top:468px;}
        .item2 {left:59px;top:516px;}
        .item3 {left:393px;top:468px;}
        .item4 {left:393px;top:516px;}
        .item5 {left:393px;top:564px;}
        .item6 {left:767px;top:468px;}
        .item7 {left:767px;top:516px;}
        .item8 {left:767px;top:564px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == 11 && (focus == 0 || focus == 2 || focus == 5) || index == -11 && ( focus == 1 || focus == 4 || focus + 1 >= focusable[blocked].items.length  ) || index == -1 && focus <= 1 )) return;
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                var item = items[i];
                html += "<div class='item item" + ( i + 1) + "' style='background-image:url(images/20161028/" + ( i == focus && blocked == index ? "1" : "" ) + ( i + 1) + ".png);' ></div>";
            }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/20161028/bg-2016-10-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>