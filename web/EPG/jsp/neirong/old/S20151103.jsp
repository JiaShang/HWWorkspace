...
<%
    ...
    final String[] types = {"10000100000000090000000000105612"};
...
<head>
    <title>十一月观影指南</title>
    <style>
        .mask {position:absolute;width:206px;height:258px;background:transparent url('images/mask-2015-11-03.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {left:32px; top:183px;}
        .mask2 {left:203px; top:161px;}
        .mask3 {left:376px; top:140px;}
        .mask4 {left:542px; top:117px;}
        .mask5 {width:229px;height:287px;left:410px; top:406px; background-position: 0px -260px;}
        .mask6 {width:229px;height:287px;left:597px; top:381px; background-position: 0px -260px;}
        .mask7 {width:229px;height:287px;left:785px; top:355px; background-position: 0px -260px;}
        .mask8 {width:229px;height:287px;left:973px; top:330px; background-position: 0px -260px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            <%
            value = "";
            final String[][] actions = {"[0,4,0,4,0,3,0,1]|[0,4,0,4,0,0,0,2]|[0,4,0,4,0,1,0,3]|[0,5,0,5,0,2,0,0]|[0,2,0,2,0,7,0,5]|[0,3,0,3,0,4,0,6]|[0,3,-1,0,0,5,0,7]|[0,3,-1,1,0,6,0,4]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,6,0,6,-1,1,-1,1]},
                {name:'返回',style:'btnReturn',action:[0,7,0,7,-1,0,-1,0]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
        var startedFlowed = 0;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:transparent url('images/bg-2015-11-03.jpg') no-repeat;" onUnload="exit();"></body>
</html>