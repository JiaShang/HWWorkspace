...
<%
    ...
    final String[] types = {"10000100000000090000000000106009"};
...
<head>
    <title>蝙蝠侠大战超人</title>
    <style>
        .mask {width:542px;height:39px;left:349px;position:absolute;background:transparent url('images/mask-2016-03-25.png') no-repeat fixed;background-position: 0px 0px;}
        ...
        .mask7{left:676px;top:444px;}
        .mask8{left:676px;top:484px;}
        .mask9{left:676px;top:524px;}
        .mask10{left:676px;top:564px;}
        .mask11{left:676px;top:604px;}


        .flowed {}
        .after {width:542px;height:229px;left:352px;top:429px;position: absolute;background:transparent url('images/mask-2016-03-25.png') no-repeat fixed;background-position: 0px -40px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if(blocked == 0 && ( ( focus == 0 || focus == 6 ) && index == 11 || ( focus == 5 || focus >= focusable[blocked].items.length ) && index == -11 || focus <=5 && index == -1 )) return;
                    if( blocked == focusable.length - 1) {
                        blocked = 0; focus = focusable[blocked].focus;
                    } else if( blocked == 0 ) {
                        if( index == 11 || index == -11 ) focus += index > 1 ? -1 : 1;
                        else if( index == 1){
                            if( focus == 0 ) focus = 6;
                            else {
                                focus += 5;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-03-25.jpg') no-repeat;" onUnload="exit();"></body>
</html>