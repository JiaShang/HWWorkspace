...
<head>
    <title>不吃这道菜，友谊的小船会翻哦</title>
    <style>
        .mask {width:267px;height:56px;position:absolute;background:transparent url('images/mask-2016-04-23.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:76px;top:518px; background-position: 0px 0px;}
        .mask2{left:359px;top:518px; background-position: 0px -60px;}
        .mask3{left:76px;top:591px; background-position: 0px -120px;}
        .mask4{left:359px;top:591px; background-position: 0px -180px;}
        .mask5{width:296px;height:61px;left:884px;top:597px;background-position: 0px -240px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items : [{name:'更多',style:'mask mask5',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=14&lcn=ms1'}]},
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == 0  && (
                         index == -1 && ( focus == 0 || focus == 2 ) ||
                         index == 11 && ( focus == 0 || focus == 1 ) ||
                         index == -11 && ( focus == 2 || focus == 3 ) ) ||
                     blocked == 1 && index != -1 ) return;

                     if( blocked == 1) { blocked = 0;focus = focusable[blocked].focus; }
                     else {
                         if( index == 1 || index == -1 ) {
                           if( ( focus == 1 || focus == 3 ) && index == 1 ) { blocked = 1 ; focus = focusable[blocked].focus; }
                           else focus += index;
                         } else if( index == 11 ) focus -= 2;
                         else if( index == -11 ) focus += 2;
                     }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-04-23.jpg') no-repeat;" onUnload="exit();"></body>
</html>