...
<%
    ...
    final String[] types = {"10000100000000090000000000107360"};
...
<head>
    ...
    <style>
        .mask {position:absolute;height:30px;background:transparent url('images/mask-2017-03-10.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:183px;left:380px;top:379px;}
        .mask2{width:144px;left:691px;top:379px;}
        .mask3{width:183px;left:380px;top:433px;}
        .mask4{width:144px;left:691px;top:433px;}
        .mask5{width:183px;left:380px;top:486px;}
        .mask6{width:144px;left:691px;top:486px;}
        .mask7{width:117px;left:411px;top:540px;}
        .mask8{width:117px;left:704px;top:540px;}

        .flowed {}
        .after {width:437px;height:183px;left:388px;top:383px;background-position: 0px -50px;}
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    value += "{focus:0,typeId:'" + types[i] + "',items:[{name:'1566',style:'mask mask1',playType:-3,link:'http://192.168.17.74/youku/search_load.htm?vodId=PACKAGES201702000206-youku'},";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-03-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>