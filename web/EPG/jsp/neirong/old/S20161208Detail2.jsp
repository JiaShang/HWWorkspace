...
<%
    ...
    final String[] types = {"10000100000000090000000000105923"};
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-12-08-Detail2.jpg') no-repeat;" onUnload="exit();"></body>
</html>