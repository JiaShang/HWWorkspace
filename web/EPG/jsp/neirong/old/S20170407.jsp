...
<%
    ...
    final String[] types = {"10000100000000090000000000107520","10000100000000090000000000107520"};
    final int[] position = {4,0,6,4};
    //TODO:每次需要修改
...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-04-07.png') no-repeat;background-position: 0px 0px;}
        .mask1 {height:20px;}
        .mask11 {width:211px;left:215px;top:73px;background-position: 0px 0px;}
        .mask12 {width:251px;left:195px;top:109px;background-position: 0px -25px;}
        .mask13 {width:211px;left:215px;top:145px;background-position: 0px -50px;}
        .mask14 {width:251px;left:195px;top:181px;background-position: 0px -75px;}

        .mask2 {width:160px;height:206px;}
        .mask21 {left:69px;top:244px;background-position: 0px -100px;}
        .mask22 {left:246px;top:244px;background-position: -160px -100px;}
        .mask23 {left:418px;top:245px;background-position: -320px -100px;}
        .mask24 {left:69px;top:458px;background-position: 0px -310px;}
        .mask25 {left:246px;top:459px;background-position: -160px -310px;}
        .mask26 {left:418px;top:460px;background-position: -320px -310px;}
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( blocked == 0 && ( index == -1 || index == 1 || index == 11 && focus == 0 ) ||
                        blocked == 1 && ( index == -1 && focus % 3 == 0 || index == 1 && focus % 3 == 2 || index == -11 && (focus >= 3 || focus >= focusable[blocked].items.length ) )
                    ) return;
                    if( index == -1 || index == 1 ) {
                        focus += index;
                    } else if( index == 11 || index == -11) {
                        focus += index > 0 ? ( blocked == 0 ? -1 : -3) : ( blocked == 0 ? 1 : 3);
                        if( focus < 0 && blocked == 1) { blocked = 0; focus = focusable[blocked].focus;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-04-07.jpg') no-repeat;" onUnload="exit();"></body>
</html>