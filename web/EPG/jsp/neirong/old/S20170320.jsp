...
<head>
    <title>品牌专区暖心回馈</title>
    <style>
        .mask {width:270px;height:60px;left:92px;position:absolute;background:transparent url('images/mask-2017-03-20.png') no-repeat;background-position: 0px 0px;}
        .mask1 {top:182px;}
        .mask2 {top:229px;}
        .mask3 {top:276px;}
        .mask4 {top:323px;}
        ...
        .flowed {}
        .after {width:196px;height:409px;left:139px;top:200px;background-position: 0px -70px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            //TODO:独立 Block
            { focus:0,items : [
                {name:'优酷专区',style:'mask mask1',playType:-3,link:'http://192.168.17.74/youku/index.htm'},
                {name:'英美剧专区',style:'mask mask2',playType:-3,link:'/EPG/jsp/defaultHD/en/hddb/western/eu_index.jsp'},
                {name:'搜狐专区',style:'mask mask3',playType:-3,link:'http://192.168.17.57:9888/sohuepg/index.html'},
                {name:'ＴＶＢ专区',style:'mask mask4',playType:-3,link:'http://chongqingtvb-utc.wasu.cn/index.jsp'},
                {name:'凤凰专区',style:'mask mask5',playType:-3,link:'/EPG/jsp/defaultHD/en/ifengnew/Category.jsp?url=ifeng_index.jsp'},
                {name:'中国电视院线',style:'mask mask6',playType:-3,link:'http://192.168.5.229/dyyx/index.htm'},
                {name:'强档好莱坞',style:'mask mask7',playType:-3,link:'http://192.168.42.52:80/epg/index/hollywood.do'},
                {name:'沙发院线',style:'mask mask8',playType:-3,link:'http://192.168.15.19'},
                {name:'坝坝舞蹈专区',style:'mask mask9',playType:-3,link:'http://192.168.48.217:8082/mo/index_mo.jsp'}
            ]},
        ...
        function doEnter(){
            ...
            var currentFocus = focusable[blocked].focus
            var item =  focusable[blocked].items[currentFocus];
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-03-20.jpg') no-repeat;" onUnload="exit();"></body>
</html>