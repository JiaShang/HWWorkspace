...
<%
    ...
    final String[] types = {"10000100000000090000000000108428"};
    ...
    try {
        ...
        if(null != focus ){
            ...
            focus = new String[]{"0","0","0","2","6","7","9","10","13"};
        }
...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-09-25.png') no-repeat;background-position: -500px 0px;}
        ...
        .maskItem {width:153px;height:39px;background-color:#9C0000;}
        .mask1 {left:42px;top:415px;}
        .mask2 {left:42px;top:454px;}

        .mask3 {left:218px;top:415px;}
        .mask4 {left:218px;top:454px;}
        .mask5 {left:218px;top:495px;}
        .mask6 {left:218px;top:529px;}

        .mask7 {width:178px;height:54px;left:380px;top:415px;}

        .mask8 {left:565px;top:415px;}
        .mask9 {left:565px;top:454px;}

        .mask10 {left:738px;top:415px;}

        .mask11 {left:913px;height:44px;top:413px;}
        .mask12 {left:913px;top:457px;}
        .mask13 {left:913px;top:485px;}

        .mask14 {left:1087px;top:415px;}
        .mask15 {left:1087px;top:454px;}


        .flowed {}
        .after {width:1177px;height:139px;left:52px;top:416px;position:absolute;overflow: hidden;background:transparent url('images/mask-2017-09-25.png') no-repeat;background-position: 0px -220px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var consign = [[0,2,<%=focus[2]%>],[2,4,<%=focus[3]%>],[6,1,<%=focus[4]%>],[7,2,<%=focus[5]%>],[9,1,<%=focus[6]%>],[10,3,<%=focus[7]%>],[13,2,<%=focus[8]%>]];                //用来缓存数据的
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-09-25.jpg') no-repeat;" onUnload="exit();"></body>
</html>