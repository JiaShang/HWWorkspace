...
<head>
    <title>小编带你看允儿</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-07-13.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:144px;height:42px;left:674px;top:428px;background-position: 0px 0px;}
        .mask2 {width:144px;height:42px;left:862px;top:428px;background-position: -150px 0px;}
        .mask3 {width:190px;height:56px;left:996px;top:601px;background-position: -300px 0px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                ...
                {name:'注册会员',style:'mask mask2',playType:-3,link:'/EPG/jsp/defaultHD/en/hddb/hjzq/hj_personCenter.jsp',action:[0,1,0,2,0,0,0,2]},
                {name:'活动细则',style:'mask mask3',playType:-3,link:'/EPG/jsp/neirong/S20160713Role.jsp',action:[0,1,0,2,0,1,0,2]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-07-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>