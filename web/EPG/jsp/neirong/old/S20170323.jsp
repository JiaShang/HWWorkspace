...
<%
    ...
    final String[] types = {"10000100000000090000000000107441"};
...
<head>
    <title>奥斯卡影后同台飙戏</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-03-23.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:199px;height:27px;left:333px;top:419px;background-position: 0px 0px;}
        .mask2 {width:80px;height:12px;left:463px;top:448px;background-position: 0px -15px;}
        .mask3 {width:100px;height:14px;left:548px;top:435px;background-position: 0px -13px;}
        .mask4 {width:98px;height:14px;left:487px;top:473px;background-position: 0px -13px;}
        .mask5 {width:169px;height:23px;left:455px;top:498px;background-position: 0px -4px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( index == -1 && focus != 2 || index == 1 && focus != 1 || index == 11 && focus <= 0 || index == -11 && focus + 1 >= focusable[blocked].items.length ) return;
                    if( index == -11 ) {
                        focus += focus == 1 ? 2 : 1;
                    } else if( index == 11 ) {
                        focus += ( focus == 2 || focus == 3 ) ? -2 : -1;
                    } else if( index == -1 && focus == 2 ) {
                        focus -= 1;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-03-23.jpg') no-repeat;" onUnload="exit();"></body>
</html>