...
<%
    ...
    final String[] types = {"10000100000000090000000000105987"};
...
<head>
    <title>疯狂萌物城</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-03-16.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{width:302px;height:70px;left:85px;top:239px;background-position:0px 0px;}
        .mask2{width:226px;height:67px;left:891px;top:139px;background-position:0px -70px;}
        .mask3{width:185px;height:67px;left:343px;top:353px;background-position:0px -140px;}
        .mask4{width:189px;height:67px;left:903px;top:369px;background-position:0px -210px;}
        .mask5{width:170px;height:67px;left:515px;top:412px;background-position:0px -280px;}
        .mask6{width:251px;height:58px;left:546px;top:535px;background-position:0px -350px;}
        .mask7{width:205px;height:67px;left:293px;top:568px;background-position:0px -420px;}
        .flowed {}
        .after {width:1009px;height:480px;left:94px;top:146px;position:absolute;background:transparent url('images/focusBg-2016-03-16.png') no-repeat fixed 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            <%
            value = "";
            final String[][] actions = {"[0,0,0,2,0,0,0,1]|[0,1,0,3,0,0,0,1]|[0,0,0,4,0,2,0,3]|[0,1,-1,1,0,2,0,3]|[0,2,0,5,0,2,0,3]|[0,4,0,6,0,6,-1,1]|[0,2,0,6,0,6,0,5]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,3,-1,0,0,5,-1,1]},
                {name:'返回',style:'btnReturn',action:[0,3,-1,1,-1,1,-1,1]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div class="after"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-03-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>