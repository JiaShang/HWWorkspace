...
<%
    ...
    final String[] types = {"10000100000000090000000000106144"};
...
<head>
    <title>权力游戏</title>
    <style>
        .mask {height:27px;position:absolute;background:transparent url('images/mask-2016-04-22.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:352px;left:286px;top:542px;background-position: 0px 0px;}
        .mask2 {width:331px;left:648px;top:542px;background-position: 0px -30px;}
        .mask3 {width:161px;left:286px;top:583px;background-position: 0px -60px;}
        .mask4 {width:129px;left:648px;top:583px;background-position: 0px -90px;}
        .mask5 {width:160px;left:286px;top:624px;background-position: 0px -120px;}
        .mask6 {width:129px;left:648px;top:624px;background-position: 0px -150px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-04-22.jpg') no-repeat;" onUnload="exit();"></body>
</html>