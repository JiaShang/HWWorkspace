...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            var links = [{text:'三生三世十里桃花',length:<%= StringUtil.length("三生三世十里桃花")%>,shortText:'<%= StringUtil.limitStringLength("三生三世十里桃花", popItemMaxCharLength)%>',playType:-3,picture:'images/item-2017-12-26-1.jpg',link:'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=cce6720bb07669ff8eec599db9edbed1',link1:'com.hunantv.operator,com.starcor.hunan.SplashActivity,cmd_ex###show_video_detail###video_id###E1826570###video_type###0###video_ui_style###0'},
                         {text:'春娇救志明',length:<%= StringUtil.length("春娇救志明")%>,shortText:'<%= StringUtil.limitStringLength("春娇救志明", popItemMaxCharLength)%>',playType:-3,picture:'images/item-2017-12-26-2.jpg',link:'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=43b129bdfdf90b05b83a6f19172a3618',link1:'com.hunantv.operator,com.starcor.hunan.SplashActivity,cmd_ex###show_video_detail###video_id###7fb580bb564293af4db9b586d6034b22###video_type###0###video_ui_style###0'},
                         {text:'28岁未成年',length:<%= StringUtil.length("28岁未成年")%>,shortText:'<%= StringUtil.limitStringLength("28岁未成年", popItemMaxCharLength)%>',playType:-3,picture:'images/item-2017-12-26-3.jpg',link:'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=49d62e93dfa82c36f604cd760b46389f',link1:'com.hunantv.operator,com.starcor.hunan.SplashActivity,cmd_ex###show_video_detail###video_id###D00000001201701030931560031999985###video_type###0###video_ui_style###0'}];

            focusable[0].items.insertAt(0,links[0]);
            focusable[0].items.insertAt(1,links[1]);
