...
<%
    ...
    final String[] types = {"10000100000000090000000000107839"};
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            document.body.style.backgroundImage = 'url("images/bg-2017-06-15-' +  (focus + 1) + '.jpg")'
        }
        ...
        function init(){
            ...
            $.buildUserInterface = function(option){
                var html = '<img src="images/bg-2017-06-15-1.jpg" style="display:none;"/>';
                html += '<img src="images/bg-2017-06-15-2.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-06-15-3.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-06-15-4.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-06-15-5.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-06-15-6.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-06-15-7.jpg"  style="display:none;"/>';
                html += '<img src="images/bg-2017-06-15-8.jpg"  style="display:none;"/>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-06-15-<%=focused + 1 %>.jpg') no-repeat;" onUnload="exit();"></body>
</html>