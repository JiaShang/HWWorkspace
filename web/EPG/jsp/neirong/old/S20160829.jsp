...
<head>
    <title>2016金婚祝福礼</title>
    <style>
        .mask {width:252px;left:151px;position:absolute;background:transparent url('images/mask-2016-08-29.png') no-repeat;background-position: 0px 0px;}
        .mask1 {height:65px;top:285px;background-position: 0px 0px;}
        .mask2 {height:53px;top:350px;background-position: 0px -70px;}
        .mask3 {height:63px;top:403px;background-position: 0px -140px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var columns = 1; rows = 3;              //定义行列，　几行几列
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-29.jpg') no-repeat;" onUnload="exit();"></body>
</html>