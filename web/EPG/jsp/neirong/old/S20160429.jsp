...
<head>
    <title>五一乐翻天</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-04-29.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:110px;height:43px;left:68px;top:234px;background-position: 0px 0px;}
        .mask2 {width:120px;height:56px;left:910px;top:145px;background-position: 0px -60px;}
        .mask3 {width:118px;height:56px;left:142px;top:489px;background-position: 0px -120px;}
        .mask4 {width:176px;height:56px;left:1037px;top:362px;background-position: 0px -180px;}
        .mask5 {width:121px;height:56px;left:372px;top:577px;background-position: 0px -240px;}
        .mask6 {width:123px;height:56px;left:932px;top:529px;background-position: 0px -300px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'看大片',style:'mask mask1',playType:-3,link:'http://192.168.5.229/dyyx/index.htm'},
                {name:'看美剧',style:'mask mask2',playType:-3,link:'/EPG/jsp/defaultHD/en/hddb/western/eu_index.jsp'},
                {name:'追热剧',style:'mask mask3',playType:-3,link:'/EPG/jsp/neirong/STemplate2.jsp?typeId=10000100000000090000000000106191'},
                {name:'劳动最光荣',style:'mask mask4',playType:-3,link:'http://192.168.35.153:8080/huoDong_shougongyi.jsp?lnc=qysg'},
                {name:'综艺趴',style:'mask mask5',playType:-3,link:'/EPG/jsp/neirong/S20150611.jsp'},
                {name:'演唱会',style:'mask mask6',playType:-3,link:'http://192.168.48.217:8085/iptv/concTV_entry.jsp?gpid=163'}
            ]},
        ...
        var columns = 2; rows = 3;              //定义行列，　几行几列
        ...
        function doEnter(){
            ...
            if(typeof item == 'undefined' || item.pvlayType == 'undefined') return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-04-29.jpg') no-repeat;" onUnload="exit();"></body>
</html>