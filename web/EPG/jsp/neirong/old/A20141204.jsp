...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104723";
...
<head>
<title>超级英雄全力出征</title>
<style>
    .mask {height: 45px;position:absolute;background:transparent url('images/mask-2014-12-04.png') no-repeat fixed 0px 0px; background-position: 0px 0px;}
    .mask1 {left:146px;width:116px;top: 582px;background-position: 0px 0px;}
    .mask2 {left:315px;width:130px;top: 581px;background-position: 0px -50px;}
    .mask3 {left:496px;width:130px;top: 581px;background-position: 0px -100px;}
    .mask4 {left:649px;width:147px;top: 581px;background-position: 0px -150px;}
    .mask5 {left:829px;width:147px;top: 582px;background-position: 0px -200px;}
    .mask6 {left:1009px;width:129px;top: 581px;background-position: 0px -250px;}
...
<script language="javascript" type="text/javascript">
            ...
            if(index == 11 || index == -11){
                ...
                if(index == -1) {
                    ...
                    if(focus >= focusable[blocked].items.length){
                        if(blocked == 1) focus = focusable[blocked].items.length - 1;
                        else {
                            blocked  = 1;
                            focus = 0;
                        }
    ...
    function doEnter(){
        ...
        if(blocked == 0){
            ...
            if( item.playType == 1)
                top.window.location.href = focusURL() + "/EPG/jsp/defaultHD/en/hj_TV_detail.jsp?vodId=" + item.mid + "&typeId=" + typeId;
            else {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-12-04.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>