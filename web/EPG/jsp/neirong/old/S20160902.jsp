...
<%
    ...
    final String[] types = {"10000100000000090000000000106652"};
...
<head>
    ...
    <style>
        ...
        .arrowUp,.arrowDown {width:19px;height:13px;left:558px;}
        .arrowUp {top:326px;background-position: -10px 0px;}
        .arrowDown { top:629px;background-position: -10px -30px;}

        .scrollBar{position:absolute;width:6px;left:269px;}
        ...
        .flowedItem {padding:0px 16px; width:545px;height:57px; font-size: 24px; font-weight: bold; left:282px;line-height: 35px;overflow: hidden; position: absolute;word-break:keep-all;white-space:nowrap; background-repeat: no-repeat;}
        .item1 { top:348px; }
        .item2 { top:406px; }
        .item3 { top:465px; }
        .item4 { top:523px; }
        .item5 { top:584px; }
        .flowedItem marquee {width:500px;}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            var h = Math.ceil( 5.0 / items.length * 264);
            var le = 264 - h;
            ...
            $("scrollBar").style.top = Math.ceil( focus * 1.0 / (items.length - 1) * le  + 353 ) + "px";
            for(var i = flowCursorIndex, j = 1; i < flowCursorIndex + pageCount; i += 1, j++) {
                ...
                if( i == focus && blocked == index ){
                    $("flowedItem" + j).style.backgroundImage = "url('images/mask-2016-09-02.png')";
                    $("flowedItem" + j).innerHTML = item.text != item.shortText ? ( "<marquee class='marqueed'>" + item.text + "</marquee>" ) : item.text;
                } else {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-02.jpg') no-repeat;" onUnload="exit();"></body>
</html>