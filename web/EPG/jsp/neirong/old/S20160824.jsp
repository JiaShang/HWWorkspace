...
<%
    ...
    final String[] types = {"10000100000000090000000000106641"};
...
<head>
    <title>谍影重重5</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-08-24.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:276px;height:31px;left:166px;top:282px;background-position: 0px 0px;}
        .mask2 {width:300px;height:31px;left:487px;top:282px;background-position: 0px -40px;}
        .mask3 {width:276px;height:31px;left:831px;top:282px;background-position: 0px -80px;}
        .mask4 {width:261px;height:341px;left:132px;top:300px;background-position: 0px -120px;}
        .mask5 {width:261px;height:341px;left:380px;top:300px;background-position: 0px -120px;}
        .mask6 {width:261px;height:341px;left:628px;top:300px;background-position: 0px -120px;}
        .mask7 {width:261px;height:341px;left:876px;top:300px;background-position: 0px -120px;}
        .flowed {}
        .after {}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus <= 2 && index == 11 || index == -1 && ( focus == 0 || focus == 3 ) || index == 1 && ( focus == 2 || focus == focusable[blocked].items.length - 1 ) || index == -11 && ( focus >= 3 && focus <= 5 ))) return;
                    if( blocked == 0 ) {
                        if( index == -1 || index == 1 ) {
                            focus += index ;
                        } else if( index == -11 ) {
                            if( focus == focusable[0].items.length - 1 ) {
                                ...
                                case 0: focus = 3; break;
                                case 1: focus = 4; break;
                                case 2: focus = focusable[0].items.length - 1; break;
                            }
                        } else {
                            switch ( focus) {
                                case 3: focus = 0; break;
                                case 4:
                                case 5:
                                    focus = 1; break;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-24.jpg') no-repeat;" onUnload="exit();"></body>
</html>