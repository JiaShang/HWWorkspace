...
<%
    ...
    final String[] types = {"10000100000000090000000000105031"};
...
<head>
    <title>愚乐生产线</title>
    <style>
        .mask {position:absolute;width:779px;height:217px;background:transparent url('images/mask-2015-03-31.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {left:44px;top:144px;}
        .mask2 {left:348px;top:31px;}
        .mask3 {left:653px;top:31px;}
        .mask4 {left:956px;top:144px;}
        .mask5 {left:44px;top:370px;}
        .mask6 {left:348px;top:467px;}
        .mask7 {left:653px;top:467px;}
        .mask8 {left:956px;top:370px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus % 4 == 0 && index == -1 || ( focus % 4 == 3 || focus + 1 == focusable[blocked].items.length ) && index == 1 || focus < 4 && index == 11 || ( focus >= 4 && focus + 1 < focusable[blocked].items.length ) && index == -11 )) return;
                    if( blocked == focusable.length - 1 ) {
                        ...
                        focus += index == 1 || index == -1 ? index : ( index > 0 ? -4 : 4 );
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-03-31.jpg') no-repeat;" onUnload="exit();"></body>
</html>