...
<%
    ...
    final String[] types = {"10000100000000090000000000108660"};
...
<head>
    ...
    <style>
        ...
        .maskX {width:263px;height:100px;left:366px;top:279px;position:absolute;background: transparent url('images/mask-2017-11-16.png') no-repeat left top;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items : [{name:'看电影送周边',style:'maskX',playType:-3,link:'http://192.168.34.131:8300/activity/justice/index.do'}]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-11-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>