...
<%
    ...
    final String[] types = {"10000100000000090000000000105202"};
...
<head>
    <title>侏罗纪世界大揭</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-06-10.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:348px;height:49px;left:51px;top:448px;background-position:0px 0px;}
        .mask2 {width:462px;height:47px;left:51px;top:484px;background-position:0px -50px;}
        .mask3 {width:409px;height:46px;left:51px;top:519px;background-position:0px -100px;}
        .mask4 {width:371px;height:46px;left:51px;top:553px;background-position:0px -150px;}
        .mask5 {width:356px;height:47px;left:51px;top:586px;background-position:0px -200px;}
        .mask6 {width:256px;height:49px;left:970px;top:449px;background-position:0px -250px;}
        .mask7 {width:256px;height:49px;left:970px;top:483px;background-position:0px -300px;}
        .mask8 {width:256px;height:49px;left:970px;top:517px;background-position:0px -350px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked === 0 && ( index == -1 && focus < 5 || index == 1 && focus >= 5  || index == 11 && focus % 5 == 0 || index == -11 && focus % 5 == 4 ) ) return;
                    if( blocked === focusable.length - 1 ) {
                        blocked = 0; focus = index == -1 ? 4 : 7;
                        ...
                        if( focus >= focusable[blocked].items.length ) {
                            ...
                            focus = index == -11 ? focusable[blocked].focus : 0;
                        }
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-06-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>