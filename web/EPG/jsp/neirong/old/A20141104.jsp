...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104646";
...
<title>十一月观影指南</title>
<style>
    .mask {position:absolute;width:229px;height:287px;background:transparent url('images/mask-2014-11-04.png') no-repeat fixed 0px 0px;}
    .mask1 {left:46px; top:164px;background-position: 0px 0px;}
    .mask2 {left:240px; top:137px;background-position: -300px 0px;}
    .mask3 {left:429px; top:112px;background-position: -600px 0px;}
    .mask4 {left:618px; top:85px;background-position: -900px 0px;}
    .mask5 {left:415px; top:388px;background-position: 0px -300px;}
    .mask6 {left:602px; top:362px;background-position: -300px -300px;}
    .mask7 {left:790px; top:337px;background-position: -600px -300px;}
    .mask8 {left:978px; top:311px;background-position: -900px -300px;}
...
<script language="javascript" type="text/javascript">
    ...
    var focusable = focusable ? focusable : [
        { focus:0, items : [
            <%
                String[] actions = "[0,4,0,4,0,3,0,1]|[0,4,0,4,0,0,0,2]|[0,4,0,4,0,1,0,3]|[0,5,0,5,0,2,0,0]|[0,2,0,2,0,7,0,5]|[0,3,0,3,0,4,0,6]|[0,3,1,0,0,5,0,7]|[0,3,1,1,0,6,0,4]".split("\\|");
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-11-04.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>