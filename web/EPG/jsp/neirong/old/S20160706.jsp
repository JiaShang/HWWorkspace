    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += '<div class="text" ' + ( ( i == focus && blocked == index ) ? ' style="color:#c7a110;"' : '' ) + '>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-07-06.jpg') no-repeat;" onUnload="exit();"></body>
</html>