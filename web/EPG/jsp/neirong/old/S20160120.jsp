...
<%
    ...
    final String[] types = {"10000100000000090000000000105853"};
...
<head>
    <title>2016年贺岁档观影指南</title>
    <style>
        .mask {width:207px;height:158px;position:absolute;background:transparent url('images/mask-2016-01-20.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{left:52px;top:130px;}
        .mask2{left:256px;top:130px;}
        .mask3{left:460px;top:130px;}
        .mask4{left:663px;top:130px;}

        .mask5{left:203px;top:284px;}
        .mask6{left:407px;top:284px;}
        .mask7{left:610px;top:284px;}
        .mask8{left:814px;top:284px;}
        .mask9{left:1019px;top:284px;}

        .mask10{left:303px;top:438px;}
        .mask11{left:506px;top:438px;}
        .mask12{left:710px;top:438px;}
        .mask13{left:915px;top:438px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus <=3 && index == 11 ||
                                        ( focus == 0 || focus == 4 || focus == 9 ) && index == -1 ||
                                        ( focus == 3 || focus == 8 || focus == focusable[0].items.length - 1 ) && index == 1 ||
                                        ( focus >= 9 && focus < focusable[0].items.length - 1 ) && index == -11 )
                     ) return;
                    ...
                    if( blocked == focusable.length - 1 ) { blocked = 0; focus = focusable[blocked].items.length - 1; }
                        ...
                        if( index == 1 || index == -1 ){
                            ...
                            if( focus >= 9 ) focus -= 5;
                            else if( focus >= 4 && focus < 7 ) focus -= 3;
                            else if( focus == 7 || focus == 8 ) focus = 3;
                        }
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-01-20.jpg') no-repeat;" onUnload="exit();"></body>
</html>