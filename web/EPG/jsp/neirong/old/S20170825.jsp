...
<%
    ...
    final String[] types = {"10000100000000090000000000108286"};
...
<head>
    ...
    <style>
        .mask {width:299px;height:40px;position:absolute;background:transparent url('images/mask-2017-08-25.png') no-repeat;background-position: 0px 0px;}

        .mask1 {left:284px;top:157px;background-position:0px 0px;}
        .mask2 {left:589px;top:155px;background-position:-300px 0px;}
        .mask3 {left:284px;top:188px;background-position:0px -40px;}
        .mask4 {left:589px;top:185px;background-position:-300px -40px;}
        .mask5 {left:284px;top:219px;background-position:0px -80px;}
        .mask6 {left:589px;top:215px;background-position:-300px -80px;}
        .mask7 {left:284px;top:251px;background-position:0px -120px;}
        .mask8 {left:589px;top:247px;background-position:-300px -120px;}
        .mask9 {left:284px;top:282px;background-position:0px -160px;}
        .mask10 {left:589px;top:278px;background-position:-300px -160px;}
        .mask11 {left:284px;top:313px;background-position:0px -200px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var columns = 2; rows = 6;              //定义行列，　几行几列
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-08-25.jpg') no-repeat;" onUnload="exit();"></body>
</html>