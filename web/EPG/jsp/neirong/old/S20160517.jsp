...
<%
    ...
    final String[] types = {"10000100000000090000000000106145"};
...
<head>
    <title>星座宝宝</title>
    <style>
        .mask {width:290px; height:95px;position:absolute;background:transparent url('images/mask-2016-05-17.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:899px;top:91px;background-position:0px 0px;}
        .mask2{left:899px;top:193px;background-position:0px -100px;}
        .mask3{left:902px;top:300px;background-position:0px -200px;}
        .mask4{left:904px;top:408px;background-position:0px -300px;}
        .mask5{height:158px;left:918px;top:525px;background-position:0px -400px;}
        .flowed {}
        .after {width:270px;height:150px; left:924px;top:531px; position:absolute;background:transparent url('images/focusBg-2016-05-17.gif');}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
                {name:'更多星座的秘密',style:'mask mask5',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=9&lcn=ycyr'}
            ]},
        ...
        function focused(index,initilized){
            ...
            $("divAfter").style.visibility = blocked == 0 && focus == 4 ? "hidden" : "visible";
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:'<div id="divAfter" class="after"></div>'}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-17.jpg') no-repeat;" onUnload="exit();"></body>
</html>