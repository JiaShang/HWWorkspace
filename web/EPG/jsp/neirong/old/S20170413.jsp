...
<%
    ...
    final String[] types = {"10000100000000090000000000107562"};
...
<head>
    <title>速度与激情8</title>
    <style>
        .mask {width:120px;height:43px;left:1114px;position:absolute;background:transparent url('images/mask-2017-04-13.png') no-repeat;background-position: 0px 0px;}
        .mask1 {top:192px;background-position: 0px 0px;}
        .mask2 {top:243px;background-position: 0px -50px;}
        .mask3 {top:296px;background-position: 0px -100px;}
        .mask4 {top:348px;background-position: 0px -150px;}
        .mask5 {top:400px;background-position: 0px -200px;}
        .mask6 {top:452px;background-position: 0px -250px;}
        .mask7 {top:505px;background-position: 0px -300px;}
        .mask8 {top:557px;background-position: 0px -350px;}
        .comeon {width:208px;height:84px;left:535px;top:512px;background-position: 0px -400px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'Come on',style:'mask comeon',playType:-4,link:"com.cloud.cyber,com.cybercloud.MainActivity,CyberURL###CyberEntryID=1&CyberSiteCode=CS00006&tag=su8A"}]},
            <%
            value = "";
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( blocked == 0 && index != 1 || blocked == 1 && ( index == 11 && focus <= 0 || index == 1 || index == -11 && focus +1 >= focusable[blocked].items.length )) return;
                    if( index == 1 || index == -1 ) {
                        blocked = index == 1 ? 1 : 0 ; focus = focusable[blocked].focus;
                    } else {
                        focus += index > 0 ? -1 : 1;
                    }
                }
        ...
        function doEnter(){
            ...
            switch(item.playType){
                ...
                case -3:
                    ...
                    break;
                case -4:
                    iPanel.IOControlWrite("startAPK",item.link);
                    break;
                case 1:
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-04-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>