...
<%
    ...
    final String[] types = {"10000100000000090000000000105870"};
...
<head>
    <title>揭秘“权利游戏第五季”</title>
    <style>
        .mask {width:102px;height:168px;position:absolute;background:transparent url('images/mask-2016-02-03.png') no-repeat fixed;background-position: 0px -230px;}
        .mask1 {left:59px;top:63px;}
        .mask2 {left:172px;top:63px;}
        .mask3 {left:283px;top:63px;}
        .mask4 {left:59px;top:262px;}
        .mask5 {left:172px;top:262px;}
        .flowed {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div style="width:286px;height:219px;left:80px;top:208px;position:absolute;background: transparent url(images/mask-2016-02-03.png) fixed 0px 0px;"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-02-03.jpg') no-repeat;" onUnload="exit();"></body>
</html>