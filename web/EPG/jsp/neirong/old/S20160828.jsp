...
<head>
    <title>甜蜜的诱惑 烘焙秀报名啦</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-08-28.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:365px;height:38px;left:379px;top:393px;background-position: 0px 0px;}
        .mask2 {width:178px;height:38px;left:463px;top:437px;background-position: 0px -40px;}
        .flowed {}
        .after {}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>