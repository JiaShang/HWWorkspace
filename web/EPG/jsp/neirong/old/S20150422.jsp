...
<%
    ...
    final String[] types = {"10000100000000090000000000105074"};
...
<head>
    <title>灰姑娘逆袭记</title>
    <style>
        .mask {width:342px;height:80px;left:479px; position:absolute;background:transparent url('images/mask-2015-04-22.png') no-repeat fixed;background-position: 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == -1 || focus == 0 && index == 11 || focus + 1 == focusable[blocked].items.length && index == -11) ) return;
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:'<div style="width:219px;height:359px;position: absolute;left: 570px;top:107px;background:transparent url(images/mask-2015-04-22.png) no-repeat fixed 1px -100px;">',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-04-22.jpg') no-repeat;" onUnload="exit();"></body>
</html>