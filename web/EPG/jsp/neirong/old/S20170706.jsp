...
<%
    ...
    final String[] types = {"10000100000000090000000000107838"};
...
<head>
    <title>青春重庆</title>
    <style>
        .mask {width:114px;height:35px;position:absolute;background:transparent url('images/mask-2017-07-06.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:177px;top:376px;background-position: 0px 0px;}
        .mask2 {left:428px;top:383px;background-position: 0px -40px;}
        .mask3 {left:670px;top:399px;background-position: 0px -80px;}
        .mask4 {left:907px;top:399px;background-position: 0px -120px;}
        .mask5 {left:1019px;top:397px;background-position: 0px -160px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-07-06.jpg') no-repeat;" onUnload="exit();"></body>
</html>