...
<%
    ...
    final String[] types = {"10000100000000090000000000107866"};
...
<head>
    <title>不是深夜 也要放“毒”</title>
    <style>
        .mask {width:268px;height:56px;left:126px;position:absolute;background:transparent url('images/mask-2017-06-21.png') no-repeat;background-position: 0px -260px;}
        .mask1 {top:183px;}
        .mask2 {top:219px;}
        .mask3 {top:254px;}
        .mask4 {top:290px;}
        ...
        .mask8 {left:380px;top:265px;}
        .mask9 {left:380px;top:301px;}
        .mask10 {left:380px;top:336px;}
        .mask11 {left:380px;top:372px;}
        .mask12 {left:380px;top:407px;}

        .flowed {}
        .after {width:438px;height:253px;left:150px;top:193px;background-position: 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( index == 11 && (focus <= 0 || focus == 7 ) || index == -11 && ( focus == 6 || focus +1 >= focusable[blocked].items.length ) ||
                        index == -1 && focus <= 6 || index == 1 && ( focus <= 1 || focus > 6) ) return;
        ...
        function init(){
            ...
            focusable[0].items.splice(5,0,{name:"味想天开",link:"http://192.168.17.134:8787/larko-epg-hd/index.jsp?entry=freeRecommend&code=20170620_yydlz_album",playType:-3,style:'mask mask6'},{name:"为食神探",link:"http://chongqingtvb-utc.wasu.cn/a?f=72502&t=37&a=30308420",playType:-3,style:'mask mask7'});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-06-21.jpg') no-repeat;" onUnload="exit();"></body>
</html>