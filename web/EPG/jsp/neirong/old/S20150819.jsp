...
<%
    ...
    final String[] types = {"10000100000000090000000000105400"};
...
<head>
    <title>七夕表白圣地</title>
    <style>
        .mask {width:133px;height:133px;top:342px;position:absolute;background:transparent url('images/mask-2015-08-19.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{left:58px;}
        .mask2{left:179px;}
        .mask3{left:298px;}
        .mask4{left:418px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-08-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>