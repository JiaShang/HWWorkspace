        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    value += "{focus:0,typeId:'" + types[i] + "',items:[{text:'愤怒的小鸟免费领',length:0,shortText:'愤怒的小鸟免费领',playType:-3,link:'http://192.168.48.217:8085/iptv/cqccn_kids61.jsp',picture:'images/itemBg2016-05-21.jpg'},";
