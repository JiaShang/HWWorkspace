...
<%
    ...
    final String[] types = {"10000100000000090000000000104983"};
...
<head>
    <title>女人撒娇秘籍</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-03-12.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:250px;height:64px;background-position:0px 0px;left:910px; top:167px;}
        .mask6 {width:113px;height:47px;background-position:-25px -330px;left:935px; top:497px;}
        .mask5 {width:518px;height:49px;background-position:-24px -266px;left:934px; top:433px;}
        .mask4 {width:252px;height:44px;background-position:-22px -206px;left:932px; top:373px;}
        .mask3 {width:282px;height:52px;background-position:-14px -140px;left:924px; top:307px;}
        .mask2 {width:287px;height:62px;background-position:-8px -73px;left:918px; top:240px;}
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == focusable.length - 1 ) { blocked = 0; focus = focusable[blocked].focus; }
                        ...
                        if( focus <= 0 && index == 11 || index == 1 || index == -1 ) return;
                        focus += index > 0 ? -1 : 1;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-03-12.jpg') no-repeat;" onUnload="exit();"></body>
</html>