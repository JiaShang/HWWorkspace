...
<head>
    <title>抓住暑假尾巴再来一波欢乐</title>
    <style>
        .mask {height:231px;top:323px;position:absolute;background:transparent url('images/mask-2016-08-23.png') no-repeat;background-position: 0px 0px;}

        .mask0 {width:898px;height:119px;left:309px;top:207px;background-position: 0px 0px}
        .mask1 {width:232px;left:61px;background-position: 0px -150px}
        .mask2 {width:234px;left:291px;background-position: -250px -150px}
        .mask3 {width:234px;left:524px;background-position: -500px -150px}
        .mask4 {width:232px;left:757px;background-position: 0px -400px}
        .mask5 {width:234px;left:988px;background-position: -250px -400px}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'活动细则',style:'mask mask0',playType:-3,link:'http://192.168.35.129:4567/CyberCloud_Dispatcher.htm'}]},
            <%
            value = "";
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if(blocked == 0 || blocked == focusable.length - 1) { blocked = 1;focus = focusable[blocked].focus; }
                     else {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-23.jpg') no-repeat;" onUnload="exit();"></body>
</html>