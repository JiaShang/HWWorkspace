...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-02-02-1Rule.png') no-repeat fixed;background-position: 0px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-02-02-1Rule.jpg') no-repeat;" onUnload="exit();"></body>
</html>