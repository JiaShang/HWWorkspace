...
<%
    ...
    final String[] types = {"10000100000000090000000000106737"};
    final int[] position = {14,0};
    //TODO:每次需要修改
...
<head>
    ...
    <style>
        .mask {height:25px;position:absolute;background:transparent url('images/mask-2016-09-30.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:127px;left:136px;top:308px;background-position:0px 0px;}
        .mask2 {width:94px;left:153px;top:341px;background-position:0px -30px;}
        .mask3 {width:142px;left:379px;top:308px;background-position:0px -60px;}
        .mask4 {width:223px;left:338px;top:341px;background-position:0px -90px;}
        .mask5 {width:151px;left:694px;top:308px;background-position:0px -120px;}
        .mask6 {width:271px;left:634px;top:341px;background-position:0px -150px;}
        .mask7 {width:127px;left:992px;top:308px;background-position:0px -180px;}
        .mask8 {width:127px;left:992px;top:341px;background-position:0px -210px;}
        .mask9 {width:79px;left:160px;top:308px;background-position:0px -240px;}
        .mask10 {width:127px;left:136px;top:341px;background-position:0px -270px;}
        .mask11 {width:199px;left:350px;top:308px;background-position:0px -300px;}
        .mask12 {width:127px;left:386px;top:341px;background-position:0px -330px;}
        .mask13 {width:223px;left:658px;top:308px;background-position:0px -360px;}
        .mask14 {width:103px;left:718px;top:341px;background-position:0px -390px;}

        .before {width:983px;height:101px;left:136px;top:265px;background:transparent url('images/focusBg-2016-09-30.png') no-repeat 0px 0px; position:absolute;}
        .before1 {}
        .before2 {background-position: 0px -120px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus % 2 == 0 && index == 11 || focus % 2 == 1 && focus != 7 && focus + 1 != focusable[blocked].items.length && index == -11 || index == -1 && focus <= 1 || index == 1 && focus >= focusable[blocked].items.length - 2 ) ) return;
                    if( blocked == focusable.length - 1 ) {
                        blocked = 0; focus = focusable[blocked].focus;
                    } else {
                        if( index == 1 || index == -1) focus += index * 2;
                        else {
                            if( index == -11 && ( focus ==7 || focus + 1 == focusable[blocked].items.length ) ){
            ...
            $("before").className = focusable[0].focus <= 7 ? "before before1" : "before before2";
        }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:undefined,before:'<div id="before"></div>'}}); //'<div class="after"></div>'
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-30.jpg') no-repeat;" onUnload="exit();"></body>
</html>