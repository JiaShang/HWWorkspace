...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104623";
...
<title>大片重映年</title>
<style>
    .mask{position:absolute;background:transparent url('images/mask-2014-10-24.png') no-repeat fixed;}
    .mask1 {width:413px;height:61px; left:184px;top:173px;background-position: 0px 0px;}
    .mask2 {width:386px;height:61px; left:375px;top:309px;background-position: 0px -61px;}
    .mask3 {width:401px;height:61px; left:580px;top:387px;background-position: 0px -122px;}
    .mask4 {width:351px;height:60px; left:89px;top:438px;background-position: 0px -183px;}
    .mask5 {width:334px;height:64px; left:323px;top:551px;background-position: 0px -243px;}
    .mask6 {width:436px;height:91px; left:609px;top:599px;background-position: 0px -304px;}
...
<script language="javascript" type="text/javascript">
    ...
    var focusable = focusable ? focusable : [
        { focus:0, items : [
            <%
                String[] actions = "[0,0,0,1,0,3,0,1]|[0,0,0,4,0,3,0,2]|[0,5,0,5,0,1,0,5]|[0,0,0,4,0,3,0,4]|[0,1,0,5,0,3,0,2]|[0,2,1,0,0,4,1,0]".split("\\|");
        ...
        { focus:0, items : [
            {name:'首页',style:'btnHome',action:[0,5,1,0,0,5,1,1]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-10-24.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>