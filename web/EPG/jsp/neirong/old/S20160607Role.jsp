...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-07Role.jpg') no-repeat;" onUnload="exit();"></body>
</html>