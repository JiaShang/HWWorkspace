...
<head>
    <title>我要美美美活动规则</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-03-08Rule.png') no-repeat fixed;background-position: 0px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-03-08Rule.jpg') no-repeat;" onUnload="exit();"></body>
</html>