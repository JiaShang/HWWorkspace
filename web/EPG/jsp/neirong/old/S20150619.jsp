...
<%
    ...
    final String[] types = {"10000100000000090000000000105224"};
...
<head>
    <title>银幕女神特辑</title>
    <style>
        .mask {height:62px;position:absolute;background:transparent url('images/mask-2015-06-19.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:232px;left:257px;top:87px;background-position: 0px 0px;}
        .mask2 {width:259px;left:977px;top:43px;background-position: 0px -70px;}
        .mask3 {width:184px;left:1054px;top:156px;background-position: 0px -140px;}
        .mask4 {width:185px;left:201px;top:575px;background-position: 0px -210px;}
        .mask5 {width:184px;left:551px;top:349px;background-position: 0px -280px;}
        .mask6 {width:186px;left:659px;top:434px;background-position: 0px -350px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            <%
            value = "";
            final String[][] actions = {"[0,0,0,3,0,0,0,1]|[0,1,0,2,0,0,0,1]|[0,1,-1,0,0,4,0,2]|[0,0,0,3,0,3,0,4]|[0,0,0,5,0,3,0,5]|[0,4,0,4,-1,0,-1,0]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,2,-1,0,0,3,-1,1]},
                {name:'返回',style:'btnReturn',action:[0,2,-1,1,-1,0,-1,1]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-06-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>