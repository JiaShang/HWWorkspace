...
<head>
    <title>超女十年</title>
    <style>
        .mask {width:446px;height:441px;position:absolute;background:transparent url('images/mask-2016-05-10.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:95px;top:254px;}
        .mask2{left:414px;top:285px;}
        .mask3{left:752px;top:253px;}
        .flowed {}
        .after {width:901px;height:422px;left:176px;top:228px;position:absolute;background:transparent url('images/focusBg-2016-05-10.png') no-repeat left top;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'想唱就唱',style:'mask mask1',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=4&lcn=yskt'},
                {name:'经典女生',style:'mask mask2',playType:-3,link:'http://192.168.34.81/HiFi_cq/album.html?albumId=416'},
                {name:'回顾超女',style:'mask mask3',playType:-3,link:'http://192.168.48.217:8085/iptv/entrance.jsp?gpid=177'}
            ]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>