...
<%
    ...
    final String[] types = {"10000100000000090000000000107835"};
...
<head>
    <title>砥砺奋进的五年</title>
    <style>
        .mask {position:absolute;background:transparent none no-repeat 0px 0px;}
        .bgLeft{width:687px;height:494px;left:0px; top:0px;position:absolute;background:transparent url('images/bg-2017-06-14-1.png') no-repeat 0px 0px;}
        .bgRight{width:593px;height:494px;left:687px; top:0px;position:absolute;background:transparent url('images/bg-2017-06-14-2.jpg') no-repeat 0px 0px;}
        .bgBottom{width:1280px;height:226px;left:0px; top:494px;position:absolute;background:transparent url('images/bg-2017-06-14-3.jpg') no-repeat 0px 0px;}

        .flowed {width:466px;height:369px;left:756px;top:125px; overflow: hidden;position: absolute;}
        .item,.itemFocus {width:466px;height:41px;font-size: 22px;line-height: 32px; text-align: left;float: left;overflow:hidden;word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;padding:0px 10px 0px 10px;}
        .item {color:#333333;background-color:transparent;}
        .itemFocus { color:white;background-color:#877bcb;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            var videoId = focusable[0].items[0].mid;
            focusable[0].items = focusable[0].items.slice(1);

            $.buildUserInterface({flowed:[0],video:videoId,position:[57,122,630,372],external:{after:undefined,before:'<div class="bgLeft"></div><div class="bgRight"></div><div class="bgBottom"></div>'}}); //
