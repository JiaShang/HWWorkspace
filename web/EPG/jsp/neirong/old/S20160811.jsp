...
<%
    ...
    final String[] types = {"10000100000000090000000000106586"};
...
<head>
    <title>奥运风云</title>
    <style>
        .mask {width:300px;height:300px;top:311px;position:absolute;background:transparent url('images/mask-2016-08-11.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:172px;}
        .mask2 {left:500px;}
        .mask3 {left:828px;}
        .item{ width:310px;height:300px;margin:0px 6px; float: left;}
        .itemContainer{width:270px;height:270px; position:relative;}
        ...
        .item .maskImage{background:transparent url('images/mask-2016-07-15.png') no-repeat 0px 0px;}
        ...
        .flowed {width:1000px;left:170px;top:320px;height:300px;overflow:hidden;position: absolute;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var columns = 3; rows = 1;              //定义行列，　几行几列
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += '<img src="' + item.picture + '" style=" position:relative;width:270px;height:269px;left:11px;top:6px;" />'
                html +='</div></div>';
            }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>