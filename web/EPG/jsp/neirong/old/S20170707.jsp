...
<%
    ...
    final String[] types = {"10000100000000090000000000107963"};
...
<head>
    <title>权游7回归福利季2</title>
    <style>
        .mask {height:23px;position:absolute;background:transparent url('images/mask-2017-07-07.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:320px;left:629px;top:490px;background-position: 0px 0px;}
        .mask2 {width:320px;left:629px;top:530px;background-position: 0px -25px;}
        .mask3 {width:118px;left:703px;top:571px;background-position: 0px -50px;}
        .mask4 {width:118px;left:703px;top:611px;background-position: 0px -75px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-07-07.jpg') no-repeat;" onUnload="exit();"></body>
</html>