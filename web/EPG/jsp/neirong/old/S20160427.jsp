...
<%
    ...
    final String[] types = {"10000100000000090000000000105701"};
...
<head>
    <title>蒋欣的霸屏之旅</title>
    <style>
        .mask {height:35px;position:absolute;background:transparent url('images/mask-2016-04-27.png') no-repeat;background-position: 0px 0px;}

        .mask1 {width:86px;left:495px;top:471px; background-position: 0px 0px;}
        .mask2 {width:134px;left:361px;top:520px; background-position: 0px -40px;}
        .mask3 {width:191px;left:495px;top:607px; background-position: 0px -80px;}
        .mask4 {width:119px;left:769px;top:305px; background-position: 0px -120px;}
        .mask5 {width:188px;left:700px;top:414px; background-position: 0px -160px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            <%
            value = "";
            final String[][] actions = {"[0,4,0,1,0,1,0,4]|[0,0,0,2,0,1,0,4]|[0,1,0,2,0,2,-1,0]|[0,3,0,4,0,0,-1,0]|[0,3,-1,0,0,0,-1,0]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,4,-1,0,0,2,-1,1]},
                {name:'返回',style:'btnReturn',action:[0,4,-1,1,-1,0,-1,1]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-04-27.jpg') no-repeat;" onUnload="exit();"></body>
</html>