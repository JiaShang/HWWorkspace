...
<%
    ...
    final String[] types = {"10000100000000090000000000106001"};
...
<head>
    <title>魔兽好礼狂相送</title>
    <style>
        .mask {width:294px;height:37px;position:absolute;background:transparent url('images/mask-2016-05-28.png') no-repeat;background-position: 0px 0px;}

        .mask1{left:26px;top:378px;}
        .mask2{left:965px;top:407px;}
        .mask3{left:26px;top:418px;}
        .mask4{left:965px;top:445px;}
        .mask5{left:26px;top:454px;}
        .mask6{left:965px;top:483px;}
        .mask7{left:26px;top:492px;}
        .mask8{left:965px;top:521px;}
        .mask9{left:26px;top:530px;}
        .mask10{left:965px;top:559px;}

        .flowed {}
        .after {width:1130px;height:208px;left:34px;top:378px;position:absolute;background: transparent url('images/focusBg-2016-05-28.png') no-repeat;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>