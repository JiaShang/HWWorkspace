...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104685";
...
<title>冬季旅游好去处</title>
    <style>
    .mask {position:absolute;height: 23px;background:transparent url('images/mask-2014-11-27.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1 {width:238px;left:261px;top:84px;background-position: 0px 0px;}
    .mask2 {width:263px;left:236px;top:121px;background-position: 0px -25px;}
    .mask3 {width:240px;left:260px;top:159px;background-position: 0px -50px;}
    .mask4 {width:367px;left:132px;top:196px;background-position: 0px -75px;}
    .mask5 {width:240px;left:913px;top:464px;background-position: 0px -100px;}
    .mask6 {width:287px;left:913px;top:501px;background-position: 0px -125px;}
    .mask7 {width:285px;left:915px;top:539px;background-position: 0px -150px;}
    .mask8 {width:294px;left:914px;top:576px;background-position: 0px -175px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-11-27.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>