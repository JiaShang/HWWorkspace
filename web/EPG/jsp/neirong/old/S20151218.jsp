...
<%
    ...
    final String[] types = {"10000100000000090000000000105766"};
...
<head>
    <title>家年华 齐欢享</title>
    <style>
        .mask {position:absolute;height:47px;background:transparent url('images/mask-2015-12-18.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{width:197px;left:67px;top:68px;background-position:0px 0px;}
        .mask2{width:197px;left:343px;top:68px;background-position:0px -50px;}
        .mask3{width:197px;left:67px;top:113px;background-position:0px -100px;}
        .mask4{width:226px;left:343px;top:113px;background-position:0px -150px;}
        .mask5{width:197px;left:67px;top:156px;background-position:0px -200px;}
        .mask6{width:197px;left:343px;top:156px;background-position:0px -250px;}
        .mask7{width:197px;left:67px;top:201px;background-position:0px -300px;}
        .mask8{width:197px;left:343px;top:201px;background-position:0px -350px;}
        .mask9{width:281px;left:67px;top:245px;background-position:0px -400px;}
        .mask10{width:197px;left:343px;top:245px;background-position:0px -450px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:'<div style="width:250px;height:63px;left:983px;top:516px; position:absolute;"><img src="images/focusBg-2015-12-18.gif" /></div>'}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-12-18.jpg') no-repeat;" onUnload="exit();"></body>
</html>