...
<head>
    <title>合家欢 煲好剧</title>
    <style>
        .mask {width:255px;height:321px;top:232px;position:absolute;background:transparent url('images/mask-2016-09-16.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:95px;}
        .mask2 {left:304px;}
        .mask3 {left:513px;}
        .mask4 {left:722px;}
        .mask5 {left:930px;}
        .maskLink {width:402px;height:82px;left:440px;top:574px;position:absolute;background:transparent url('images/mask-2016-09-16.gif') no-repeat 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items:[{name:'链接',style:'maskLink',playType:-3,link:'http://192.168.98.65:10001/IPTVGameEPG/index.jsp?recoCode=LTR_10199'}]},
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 ) {
                        if( index == -1 || index == 1 ) {
                            ...
                            blocked = focus < focusable[blocked].items.length - 1 ? 1 : focusable.length - 1;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>