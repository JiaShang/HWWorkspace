...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104741";
...
<title>狂野竞速大飚客</title>
<style>
    .mask {position:absolute;width:265px; height:183px;background:transparent url('images/mask-2014-12-18.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1 {left:135px; top:73px;}
    .mask2 {left:910px; top:73px;}
    .mask3 {left:47px; top:259px;}
    .mask4 {left:971px; top:259px;}
    .mask5 {left:127px; top:444px;}
    .mask6 {left:902px; top:444px;}
...
<script language="javascript" type="text/javascript">
    ...
    var focusable = focusable ? focusable : [
        { focus:0, items : [
            <%
                String[] actions = "[0,0,0,2,0,0,0,1]|[0,1,0,3,0,0,0,1]|[0,0,0,4,0,2,0,3]|[0,1,0,5,0,2,0,3]|[0,2,0,4,0,4,0,5]|[0,3,1,0,0,4,0,5]".split("\\|");
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-12-18.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>