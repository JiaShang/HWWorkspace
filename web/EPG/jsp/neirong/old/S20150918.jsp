...
<%
    ...
    final String[] types = {"10000100000000090000000000105521"};
...
<head>
    <title>浓情金秋送好礼</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-09-18.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{width:63px;height:63px;left:621px;top:453px;background-position:0px 0px;}
        .mask2{width:280px;height:49px;left:922px;top:408px;background-position:0px -70px;}
        .mask3{width:280px;height:49px;left:922px;top:474px;background-position:0px -130px;}
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    Vod vod = vodList.get(0);
                        String str = "{ mid:'" + vod.getId() + "'," +
                                  "style:'mask mask1'," +
                                  "action:[0,0,0,0,0,0,0,1]," +
                                 "playType:" + vod.getIsSitcom() ;
                            str += "}" ;
                        str += ",{playType:-3,link:'http://chongqingtvb-utc.wasu.cn/a?f=tvb_hot1&profile=CHONGQSCENARIO',style:'mask mask2',action:[0,1,0,2,0,0,0,1]},{playType:-3,link:'http://192.168.9.120/chongqing_TV/index.htm',style:'mask mask3',action:[0,1,-1,0,0,0,0,2]}";
                        value += str;
                    value += "]},";
                }
                out.write(value);
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,2,-1,0,-1,0,-1,1]},
                {name:'返回',style:'btnReturn',action:[0,2,-1,0,-1,0,-1,1]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-09-18.jpg') no-repeat;" onUnload="exit();"></body>
</html>