...
<%
    ...
    final String[] types = {"10000100000000090000000000105580"};
...
<head>
    <title>国庆之后电影看什么？</title>
    <style>
        .mask {width:200px;height:268px;position:absolute;background:transparent url('images/mask-2015-06-02.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {left:643px;top:68px;}
        .mask2 {left:834px;top:68px;}
        .mask3 {left:1026px;top:68px;}
        .mask4 {left:50px;top:360px;}
        .mask5 {left:241px;top:360px;}
        .mask6 {left:433px;top:360px;}
        .mask7 {left:625px;top:360px;}
        .mask8 {left:816px;top:360px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            <%
            value = "";
            final String[][] actions = {"[0,0,0,6,0,0,0,1]|[0,1,0,7,0,0,0,2]|[0,2,-1,0,0,1,0,2]|[0,3,0,3,0,3,0,4]|[0,4,0,4,0,3,0,5]|[0,5,0,5,0,4,0,6]|[0,0,0,6,0,5,0,7]|[0,1,0,7,0,6,-1,0]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,2,-1,0,0,7,-1,2]},
                {name:'返回',style:'btnReturn',action:[0,2,-1,1,-1,0,-1,2]}
            ]}
        ];
        var backUrl = '<%= backUrl %>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-10-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>