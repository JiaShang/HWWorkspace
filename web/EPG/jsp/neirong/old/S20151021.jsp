...
<%
    ...
    final String[] types = {"10000100000000090000000000105602"};
...
<head>
    <title>时间都去哪儿了</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-10-21.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:344px;height:72px;left:752px;top:200px;background-position: 0px 0px;}
        .mask2 {width:314px;height:72px;left:835px;top:327px;background-position: 0px -80px;}
        .mask3 {width:229px;height:72px;left:835px;top:364px;background-position: 0px -160px;}
        .mask4 {width:252px;height:72px;left:835px;top:401px;background-position: 0px -240px;}
        .mask5 {width:252px;height:72px;left:835px;top:439px;background-position: 0px -320px;}
        .mask6 {width:213px;height:72px;left:660px;top:491px;background-position: 0px -400px;}
        .mask7 {width:213px;height:72px;left:660px;top:532px;background-position: 0px -480px;}
        .mask8 {width:213px;height:72px;left:660px;top:576px;background-position: 0px -560px;}

        .mask9 {width:183px;height:145px;left:1048px;top:492px;background:transparent url('images/focus-2015-10-21.png') no-repeat fixed;background-position: 0px 0px;}
        .flowed {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0, items : [
                {playType:-3,link:'http://192.168.35.153:8080/720p/huodong.jsp',style:'mask mask9'}
            ]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus == 0 && index == 11 || focus != 4 && index == -1 ) || blocked == 1 && index == 1) return;
                    if( blocked == 0 ) {
                        if( index == 11 || index == -11 ) {
                            focus += index > 0 ? -1 : 1 ;
                            if( focus > focusable[blocked].items.length - 1) {blocked = focusable.length - 1; focus = 0; }
                        }  else if( index == -1 ) {
                            focus += 1;
                        } else {
                            blocked = 1; focus = 0;
                        ...
                        if( index == 11 || index == -1 ) {
                            blocked = 0; focus = index == 11 ? 4 : focusable[blocked].focus;
                        }  else {
                            blocked = focusable.length - 1; focus = 0;
                        }
                    } else {
                        blocked = 0;
                        focus = index == 11 ? ( blocked = 1, focus = 0 ) : focusable[blocked].items.length - 1;
                    }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,
                before:'<div id="movieDiv" style="position:absolute;width:183px;height:145px;left:1044px;top:492px;background:transparent url(\'images/focus-2015-10-21.gif\') no-repeat fixed;"></div>'}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-10-21.jpg') no-repeat;" onUnload="exit();"></body>
</html>