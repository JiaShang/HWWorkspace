...
<%
    ...
    final String[] types = {"10000100000000090000000000105864"};
...
<head>
    <title>寒假补剧班之韩流追剧</title>
    <style>
        .mask {height:29px;left:543px;position:absolute;background:transparent url('images/mask-2016-01-27.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1{width:137px;top:141px;background-position: 0px -200px;}
        .mask2{width:137px;top:175px;background-position: 0px -200px;}
        .mask3{width:191px;top:209px;background-position: 0px -230px;}
        .mask4{width:191px;top:242px;background-position: 0px -230px;}
        .mask5{width:191px;top:276px;background-position: 0px -230px;}
        .mask6{width:137px;top:310px;background-position: 0px -200px;}
    ...
    <script language="javascript" type="text/javascript">
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     //规则的行列模式光标移动代码，光标移动通过 arrows[下，右]控制
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div style="width:173px;height:192px;left:549px;top:145px;position:absolute;background: transparent url(images/mask-2016-01-27.png) fixed 0px 0px;"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-01-27.jpg') no-repeat;" onUnload="exit();"></body>
</html>