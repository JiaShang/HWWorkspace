...
<%
    ...
    final String[] types = {"10000100000000090000000000107283"};
...
<head>
    <title>致敬悬疑推理巅峰之作</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-02-24.png') no-repeat;background-position: 0px 0px;}
        ...
        .scrollBar{position:absolute;width:6px;left:802px;}
        .scrollBarTop,.scrollBarBottom{width:6px;left:0px;height:3px; border:none;}
        .scrollBarTop {top:0px;background-position: 0px 0px;}
        .scrollBarMiddle{width:6px;left:0px;border:none;top:3px;background-position: -10px 0px; background-repeat: repeat-y;}
        .scrollBarBottom{bottom:0px;background-position: 0px -37px;}

        .flowedItem {padding:0px 8px; width:343px;height:42px; font-size: 20px; left:438px;line-height: 20px;overflow: hidden; position: absolute;word-break:keep-all;white-space:nowrap; text-align: center;}
        .item1 { top:301px; }
        .item2 { top:343px; }
        .item3 { top:385px; }
        .item4 { top:427px; }
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            var h = Math.ceil( pageCount * 1.0 / items.length * 233);
            var le = 233 - h;
            ...
            $("scrollBar").style.top = Math.ceil( focus * 1.0 / (items.length - 1) * le  + 301 ) + "px";
            for(var i = flowCursorIndex, j = 1; i < flowCursorIndex + pageCount; i ++, j++) {
                var item = items[i];
                $("flowedItem" + j).className = "flowedItem item" + j;

                if( i == focus && blocked == index ){
                    $("flowedItem" + j).style.color = "#FF0030";
                    ...
                    $("flowedItem" + j).style.color = "#B1795A";
                }
            }
        }
        function init(){
            ...
            $.buildUserInterface = function(option){
                ...
                if(typeof option.flowed != 'undefined' ) {
                    html += "<div id='scrollBar' class='scrollBar'><div class='mask scrollBarTop'></div><div id='scrollBarMiddle' class='mask scrollBarMiddle'></div><div class='mask scrollBarBottom'></div></div><div id='flowedItem1'></div><div id='flowedItem2'></div><div id='flowedItem3'></div><div id='flowedItem4'></div><div id='flowedItem5'></div><div id='flowedItem6'></div>";
                    focusable.flowed = [];
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-02-24.jpg') no-repeat;" onUnload="exit();"></body>
</html>