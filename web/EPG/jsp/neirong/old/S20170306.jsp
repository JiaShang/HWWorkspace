...
<%
    ...
    final String[] types = {"10000100000000090000000000107340"};
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-03-06.jpg') no-repeat;" onUnload="exit();"></body>
</html>