...
<head>
    <title>科学家的摇篮</title>
    <style>
        .mask {height:67px;position:absolute;background:transparent url('images/mask-2016-05-18.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:221px; left:550px; top:342px;background-position:0px 0px;}
        .mask2{width:221px; left:429px; top:395px;background-position:0px 0px;}
        .mask3{width:181px; left:643px; top:395px;background-position:0px -70px;}
        .mask4{width:118px; left:396px; top:454px;background-position:0px -140px;}
        .mask5{width:118px; left:569px; top:454px;background-position:0px -140px;}
        .mask6{width:118px; left:745px; top:454px;background-position:0px -140px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            {
                focus:0,items: [
                {name:'地心到底是什么样子',style:'mask mask1',action:[0,0,0,1,0,1,0,2],playType:-3,link:'http://192.168.98.67:9988/ggly-gd-hd/index.jsp?entry=video&code=cp0134000568'},
                {name:'地球的公转与自传',style:'mask mask2',action:[0,0,0,4,0,3,0,2],playType:-3,link:'http://192.168.98.67:9988/ggly-gd-hd/index.jsp?entry=video&code=cp0134000569'},
                {name:'地球的形状大小',style:'mask mask3',action:[0,0,0,4,0,1,0,5],playType:-3,link:'http://192.168.98.67:9988/ggly-gd-hd/index.jsp?entry=video&code=CP0134000567'},
                {name:'万有引力',style:'mask mask4',action:[0,1,0,3,0,3,0,4],playType:-3,link:'http://192.168.98.65:10001/IPTVGameEPG/index.jsp?recoCode=LTR_10050'},
                {name:'科学零距离',style:'mask mask5',action:[0,1,0,4,0,3,0,5],playType:-3,link:'http://192.168.49.225:8081/TICOCartoon/CQBCSecond.jsp?secondId=7&typeId=36'},
                {name:'地球的形成',style:'mask mask6',action:[0,2,0,5,0,4,0,5],playType:-3,link:'http://192.168.98.67:9988/ggly-gd-hd/index.jsp?entry=video&code=CP0134000566'}
            ]},
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-18.jpg') no-repeat;" onUnload="exit();"></body>
</html>