...
<%
    ...
    final String[] types = {"10000100000000090000000000105039"};
...
<head>
    <title>4月观影指南</title>
    <style>
        .mask {position:absolute;width:315px;height:364px;background:transparent url('images/mask-2015-04-08.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {left:-6px;top:-18px;}
        .mask2 {left:207px;top:-18px;}
        .mask3 {left:419px;top:-18px;}
        .mask4 {left:632px;top:-18px;}
        .mask5 {left:93px;top:308px;}
        .mask6 {left:310px;top:308px;}
        .mask7 {left:528px;top:308px;}
        .mask8 {left:745px;top:309px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus % 4 == 0 && index == -1 || focus == 3 && index == 1 || focus < 4 && index == 11 || focus >= 4 && index == -11 )) return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-04-08.jpg') no-repeat;" onUnload="exit();"></body>
</html>