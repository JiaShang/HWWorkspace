...
<head>
    <title></title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-09-11Rule.png') no-repeat;background-position: 0px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-09-11-Rule.jpg') no-repeat;" onUnload="exit();"></body>
</html>