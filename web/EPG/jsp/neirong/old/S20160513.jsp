...
<head>
    <title>功夫熊猫归来</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-05-13.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:269px;height:58px;left:361px;top:357px; background-position: 0px 0px ;}
        .mask2{width:269px;height:58px;left:361px;top:420px; background-position: 0px -60px ;}
        .mask3{width:269px;height:58px;left:361px;top:484px; background-position: 0px -120px ;}
        .mask4{width:269px;height:58px;left:361px;top:552px; background-position: 0px -180px ;}
        .mask5{width:543px;height:58px;left:649px;top:355px; background-position: 0px -240px ;}
        .mask6{width:543px;height:58px;left:649px;top:419px; background-position: 0px -300px ;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'疯狂动物园',style:'mask mask1',playType:-3,link:'http://192.168.42.49/epg/index/newEast.do'},
                {name:'阿宝对阵图',style:'mask mask2',playType:-3,link:'http://192.168.9.174:80/dvb_cqocn_53/welcome/home.htm?welcome=lianxianduizhentu'},
                {name:'少林大洪拳',style:'mask mask3',playType:-3,link:'http://192.168.35.153:8080/programList.jsp?columnId=13&lcn=wdg'},
                {name:'阿宝来接招',style:'mask mask4',playType:-3,link:'http://192.168.49.144:8080/GamePortal/CQBCDetail.jsp?pid=gfxm&gameId=341'},
                {name:'《功夫熊猫3》主题曲',style:'mask mask5',playType:-3,link:'http://192.168.48.217:8085/iptv/entrance.jsp?gpid=181'},
                {name:'《功夫熊猫3》大片抢先看',style:'mask mask6',playType:-3,link:'http://192.168.42.52/epg/index/hollywood.do'}
            ]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( ( focus == 0 || focus == 4 ) && index == 11 || focus <= 3 && index == -1 || focus >= 4 && index == 1 || focus == 3 && index == -11 )) return;
                    if( blocked == 0 ) {
                        ...
                        blocked = 0;
                        focus = index == 11 ? focusable[blocked].items.length -1 : 3;
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-05-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>