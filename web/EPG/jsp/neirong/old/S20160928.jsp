...
<%
    ...
    final String[] types = {"10000100000000090000000000106385"};
...
<head>
    <title>从你的全重庆路过</title>
    <style>
        .mask {width:378px;height:455px;top:202px; position:absolute;background:transparent url('images/mask-2016-09-28.png') no-repeat;}
        .mask1 {left:61px;}
        .mask2 {left:318px;}
        .mask3 {left:575px;}
        .mask4 {left:832px;}

        .item{ width:257px;height:307px;float: left;}
        .itemContainer{width:230px;height:307px; position:relative;}
        ...
        .item .image{ width:230px;height:307px;left:0px;top:-305px;position:relative; background:transparent url('images/mask-2016-09-28.png') no-repeat; }
        .item img {position:relative;width:228px;height: 305px; left:1px; top:1px;}
        .item .image {background-position: -400px 0px;}
        .text {width:228px;height:35px; font-size:22px; color:#FEE5f0; line-height:30px; position:relative; top:-345px; overflow: hidden;left:1px;text-align: center;}

        .flowed {width:1200px;left:135px;top:276px;height:307px;overflow:hidden;position: absolute;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            if( blocked == 0 ) {
                $("mask").className = "mask mask" + ( focus % pageCount + 1 );
            }
        }
        function init(){
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>