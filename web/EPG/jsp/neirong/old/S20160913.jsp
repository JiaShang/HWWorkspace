...
<%
    ...
    final String[] types = {"10000100000000090000000000106686"};
...
<head>
    <title>教你妙招防范电信诈骗</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-09-13.png') no-repeat;background-position: 0px 0px;}
        ...
        .scrollBar{position:absolute;width:8px;left:508px;}
        .scrollBarTop,.scrollBarBottom{width:8px;left:0px;height:4px; border:none;}
        .scrollBarTop {top:0px;background-position: 0px 0px;}
        .scrollBarMiddle{width:8px;left:0px;border:none;top:4px;background-position: -35px 0px;background-repeat: repeat-y;}
        .scrollBarBottom{bottom:0px;background-position: 0px -41px;}

        .flowedItem {padding:0px 16px; width:545px;height:51px; font-size: 24px; font-weight: bold; left:525px;line-height: 42px;overflow: hidden; position: absolute;word-break:keep-all;white-space:nowrap; background-repeat: no-repeat;}
        .item1 { top:342px; }
        .item2 { top:393px; }
        .item3 { top:444px; }
        .item4 { top:495px; }
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            var h = Math.ceil( 5.0 / items.length * 247);
            var le = 247 - h;
            ...
            $("scrollBar").style.top = Math.ceil( focus * 1.0 / (items.length - 1) * le  + 340 ) + "px";
            for(var i = flowCursorIndex, j = 1; i < flowCursorIndex + pageCount && i < items.length; i += 1, j++) {
                ...
                if( i == focus && blocked == index ){
                    ...
                    $("flowedItem" + j).style.color = "#000000";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>