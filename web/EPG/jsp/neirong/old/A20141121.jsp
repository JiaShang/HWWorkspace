...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104679";
...
<head>
<title>Running Man经典游戏盘点</title>
    <style>
    .mask {position:absolute;background:transparent url('images/mask-2014-11-21.png') no-repeat fixed;background-position: 0px 0px;}
    .mask1 {width:223px;height: 34px;left:531px;top:82px;background-position: 0px 0px;}
    .mask2 {width:190px;height: 30px;left:619px;top:137px;background-position: 0px -40px;}
    .mask3 {width:220px;height: 30px;left:574px;top:191px;background-position: 0px -80px;}
    .mask4 {width:221px;height: 30px;left:676px;top:244px;background-position: 0px -120px;}
    .mask5 {width:254px;height: 30px;left:179px;top:432px;background-position: 0px -160px;}
    .mask6 {width:222px;height: 30px;left:262px;top:486px;background-position: 0px -200px;}
    .mask7 {width:221px;height: 31px;left:195px;top:538px;background-position: 0px -240px;}
    .mask8 {width:285px;height: 69px;left:310px;top:590px;background-position: 0px -280px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-11-21.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>