...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2016-02-19.png') no-repeat;background-position: 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function doEnter(){
            ...
            //首页，返回
            if( blocked == focusable.length - 1 ) { goBack( true ); return;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-02-4.jpg') no-repeat;" onUnload="exit();"></body>
</html>