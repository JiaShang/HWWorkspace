...
<%
    ...
    final String[] types = {"10000100000000090000000000105561"};              //
...
<head>
    <title>青春 奋斗山城故事</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-07-30.png') no-repeat fixed;background-position: 0px 0px;}

        .image1 {width:253px;height:142px;left:90px;top:234px;position:absolute;}
        .image2 {width:253px;height:142px;left:372px;top:234px;position:absolute;}
        .image3 {width:253px;height:142px;left:653px;top:234px;position:absolute;}
        .image4 {width:253px;height:142px;left:935px;top:234px;position:absolute;}
        .image5 {width:253px;height:142px;left:90px;top:436px;position:absolute;}
        .image6 {width:253px;height:142px;left:372px;top:436px;position:absolute;}
        .image7 {width:253px;height:142px;left:653px;top:436px;position:absolute;}
        .image8 {width:253px;height:142px;left:935px;top:436px;position:absolute;}

        .mask1{width:259px;height:173px;left:87px;top:231px;background-position: 0px 0px;}
        .mask2{width:259px;height:173px;left:369px;top:231px;background-position: 0px 0px;}
        .mask3{width:259px;height:173px;left:650px;top:231px;background-position: 0px 0px;}
        .mask4{width:259px;height:173px;left:932px;top:231px;background-position: 0px 0px;}
        .mask5{width:259px;height:173px;left:87px;top:434px;background-position: 0px 0px;}
        .mask6{width:259px;height:173px;left:369px;top:434px;background-position: 0px 0px;}
        .mask7{width:259px;height:173px;left:650px;top:434px;background-position: 0px 0px;}
        .mask8{width:259px;height:173px;left:932px;top:434px;background-position: 0px 0px;}

        .text1 {width:245px;height:50px;left:94px;top:378px;overflow: hidden;position:absolute;}
        .text2 {width:245px;height:50px;left:376px;top:378px;overflow: hidden;position:absolute;}
        .text3 {width:245px;height:50px;left:657px;top:378px;overflow: hidden;position:absolute;}
        .text4 {width:245px;height:50px;left:939px;top:378px;overflow: hidden;position:absolute;}
        .text5 {width:245px;height:50px;left:94px;top:580px;overflow: hidden;position:absolute;}
        .text6 {width:245px;height:50px;left:376px;top:580px;overflow: hidden;position:absolute;}
        .text7 {width:245px;height:50px;left:657px;top:580px;overflow: hidden;position:absolute;}
        .text8 {width:245px;height:50px;left:939px;top:580px;overflow: hidden;position:absolute;}

        .title1 {width:100%;height:20px;line-height: 20px;color:#ffffff;position: absolute;top:0px;height: 0px;overflow: hidden; word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;text-align:center; }
        .title2 {width:100%;height:20px;line-height: 20px;color:#000000;position: absolute;top:28px;height: 0px;overflow: hidden; word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;text-align:center; }
        ...
        .arrowLeft {width:44px;height:47px;left:27px;top:396px;position:absolute;background:transparent url('images/mask-2015-07-30.png') no-repeat fixed -7px -180px; }
        .arrowRight {width:44px;height:47px;left:1203px;top:396px;position:absolute;background:transparent url('images/mask-2015-07-30.png') no-repeat fixed -123px -180px; }
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && (
                        ccx < 4 && index == 11 ||
                        ccx >= 4 && focus + 1 < focusable[0].items.length && ccx < 7 && index == -11 ||
                      ( focus == 0 || focus == 4 ) && index == -1 ||
                      ( focus + 1 >= focusable[0].items.length || focus + 5 >= focusable[0].items.length && ccx == 3 ) && index == 1 )
                    ) return;

                    if( blocked == 0 ) {
                        if( index == 1 ) {
                            if( ccx == 3 || ccx == 7 ) {
                                if( focus + 5 <= focusable[0].items.length ) focus += 5;
                                else focus += 1;
                            }
                            else focus += 1;
                        } else if( index == -1 ) {
                            if( ccx == 0 || ccx == 4 ) {
                                if( focus - 5 >= 0 )  focus -= 5; else focus -= 1;
                            }  else { focus -= 1; }
                        } else if( index == 11 ) focus -= 4;
                        else {
                            if( ccx == 7 || focus + 1 >= focusable[0].items.length || ccx == 3 && focus + 4 >= focusable[0].items.length  ) {
                                blocked = focusable.length - 1; focus = focusable[blocked].focus;
                            } else if( focus + 4 >= focusable[0].items.length ) {
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                var item = items[i];
                imageHtml += "<img src='" + item.picture + "' class='image" + ( i % 8 + 1 ) + "'/>";
                titleHtml += "<div class='text" + ( i % 8 + 1 ) + "'><div class='title1'>" + item.text + "</div><div class='title2'>" + item.introduce + "</div></div>"
            }
            if( flowCursorIndex >= 8 ) imageHtml += "<div class='arrowLeft'></div>";
            if( flowCursorIndex + 8 < focusable[0].items.length ) imageHtml += "<div class='arrowRight'></div>";

            $("ImageContainer").innerHTML = imageHtml;
            $("TitleContainer").innerHTML = titleHtml;

            $("mask").className = "mask mask" + ( focus % 8 + 1);
        }
        function init(){
            ...
            $.buildUserInterface({flowed:[0],popup:undefined,vote:undefined,video:undefined,position:undefined,external:{
                before:'<div style="width:1280px;height:720px;left: 0px;top:0px;position:absolute;" id="ImageContainer"></div>',
                after:'<div style="width:1280px;height:720px;left: 0px;top:0px;position:absolute;" id="TitleContainer"></div>'}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-07-30.jpg') no-repeat;" onUnload="exit();"></body>
</html>