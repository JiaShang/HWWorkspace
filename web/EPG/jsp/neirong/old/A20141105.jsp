...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104662";
...
<head>
<title>那些真假难分的“少女们”</title>
<style>
    .mask {height: 22px;width:22px;top: 507px;position:absolute;background:transparent url('images/mask-2014-11-05.png') no-repeat fixed 0px 0px; background-position: 0px 0px;}
    .mask1 {left:267px;}
    .mask2 {left:358px;}
    .mask3 {left:452px;}
    .mask4 {left:551px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-11-05.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>