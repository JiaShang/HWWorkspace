...
<%
    ...
    final String[] types = {"10000100000000090000000000107224","10000100000000090000000000107224"};
    final int[] position = {4,0,3,4};
    //TODO:每次需要修改
...
<head>
    <title>爱乐之城</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2017-02-10.png') no-repeat;background-position: 0px 0px;}
        .mask1 { height:33px;left:466px;}
        .mask11 {width:240px;top:163px;background-position: 0px 0px;}
        .mask12 {width:248px;top:200px;background-position: 0px -37px;}
        .mask13 {width:271px;top:238px;background-position: 0px -75px;}
        .mask14 {width:337px;top:276px;background-position: 0px -120px;}

        .mask2 {width:243px;height:323px;top:319px;background-position: 0px -160px;}
        .mask21 {left:457px;}
        .mask22 {left:682px;}
        .mask23 {left:907px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-02-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>