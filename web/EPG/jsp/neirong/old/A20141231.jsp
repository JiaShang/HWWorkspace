...
<style>
    ...
    .replay {width:514px;height:234px;left:715px;top:351px; background-position: 0px -100px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-12-31.jpg') no-repeat;">
<div id="mask"></div>
<div id="replay" class="mask replay"></div>
