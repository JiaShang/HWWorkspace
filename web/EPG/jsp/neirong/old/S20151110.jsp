...
<%
    ...
    final String[] types = {"10000100000000090000000000105640"};
...
<head>
    <title>光棍女神脱单求爱记</title>
    <style>
        .mask {width:72px;height:56px;left:254px;position:absolute;background:transparent url('images/mask-2015-11-10.png') no-repeat fixed;background-position: 0px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-11-10.jpg') no-repeat;" onUnload="exit();"></body>
</html>