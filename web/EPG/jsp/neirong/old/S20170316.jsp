...
<head>
    <title>减肥路上的绊脚石</title>
    <style>
        .mask {width:216px;height:41px;position:absolute;background:transparent url('images/mask-2017-03-16.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:537px;top:295px;background-position: 0px 0px;}
        .mask2 {left:537px;top:342px;background-position: 0px -50px;}
        .mask3 {left:537px;top:389px;background-position: 0px -100px;}
        .mask4 {left:537px;top:436px;background-position: 0px -150px;}
        .mask5 {left:851px;top:295px;background-position: 0px -200px;}
        .mask6 {left:851px;top:342px;background-position: 0px -250px;}
        .mask7 {left:851px;top:389px;background-position: 0px -300px;}
        .mask8 {left:851px;top:436px;background-position: 0px -350px;}
        .mask9 {left:851px;top:484px;background-position: 0px -400px;}
        .mask10 {width:63px;height:70px;left:1023px;top:594px;background-position: 0px -450px;}
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                            ...
                            str += "}" ;
                        if(j + 1 == vodList.size() ) str += ",{name:'活动',style:'mask mask10',playType:-3,link:'http://192.168.35.153:8080/huoDong_shiheni.jsp?lcn=shiheni'}";
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( index == -1 && focus <= 3 || index == 1 && focus > 3 || index == 11 && ( focus == 0 || focus == 4  ) || index == -11 && ( focus == 3 || focus + 1 >= focusable[blocked].items.length  ) ) return;
                    if( index == 11 || index == -11) focus += index > 0 ? -1 : 1;
                    else {
                        if( index == -1 && focus >= 7 ) focus = 3;
                        else focus += index * 4;
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-03-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>