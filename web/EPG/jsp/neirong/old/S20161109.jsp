...
<%
    ...
    final String[] types = {"10000100000000090000000000106644"};
...
<head>
    ...
    <style>
        ...
        .item .maskImage{background:transparent url('images/mask-2016-06-30.png') no-repeat 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    value += "{focus:0,typeId:'" + types[i] + "',items:[{text:'鉴证实录',length:8,shortText:'鉴证实录',picture:'images/item-2016-11-09-1.jpg',playType:-3,link:'http://epgServer/defaultHD/en/Category.jsp?url=http://chongqingtvb-utc.wasu.cn/a?f=72502&t=37&a=27375870'},{text:'法证先锋3',length:9,shortText:'法证先锋3',picture:'images/item-2016-11-09-2.jpg',playType:-3,link:'http://epgServer/defaultHD/en/Category.jsp?url=http://chongqingtvb-utc.wasu.cn/a?f=72502&t=37&a=10958504'},";
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += '<div class="text" ' + ( ( i == focus && blocked == index ) ? ' style="color:#b92520;"' : '' ) + '>';
            ...
            switch(item.playType){
                ...
                case -3:
                    ...
                    if( ! item.link.startWith('http') ){
                        ...
                        url += url.indexOf("?") > 0 ? '&' : '?';
                        url += 'backURL=';
                        if( url.startWith("http://epgServer") ) url = url.replace( "http://epgServer", iPanel.eventFrame.pre_epg_url );
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>