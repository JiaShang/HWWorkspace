...
<head>
    <title>最美的你和最美的城</title>
    <style>
        .mask {width:406px;height:30px;left:701px;position:absolute;background:transparent url('images/mask-2016-10-31.png') no-repeat;background-position: 0px 0px;}

        .mask1 {left:724px;top:117px;background-position: 0px 0px;}
        .mask2 {left:724px;top:150px;background-position: 0px -30px;}
        .mask3 {left:724px;top:183px;background-position: 0px -60px;}
        .mask4 {top:264px;background-position: 0px -90px;}
        .mask5 {top:297px;background-position: 0px -120px;}
        .mask6 {top:330px;background-position: 0px -150px;}
        .mask7 {top:363px;background-position: 0px -180px;}
        .mask8 {top:396px;background-position: 0px -210px;}
        .mask9 {top:429px;background-position: 0px -240px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-10-31.jpg') no-repeat;" onUnload="exit();"></body>
</html>