...
<%
    ...
    final String[] types = {"10000100000000090000000000106191"};
...
<head>
    <title>姑娘们擦亮眼</title>
    <style>
        .mask {width:353px;height:30px;position:absolute;background:transparent url('images/mask-2016-12-13.png') no-repeat;background-position: 0px 0px;}

        .mask1 {left:3px;top:455px;background-position: 0px 0px;}
        .mask2 {left:310px;top:270px;background-position: 0px -30px;}
        .mask3 {left:933px;top:397px;background-position: 0px -60px;}
        .mask4 {left:252px;top:551px;background-position: 0px -90px;}
        .mask5 {left:588px;top:587px;background-position: 0px -120px;}
        .mask6 {left:809px;top:512px;background-position: 0px -150px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            <%
            value = "";
            final String[][] actions = {"[0,1,0,3,0,0,0,1]|[0,1,0,3,0,0,0,2]|[0,2,0,5,0,1,0,2]|[0,1,0,5,0,0,0,4]|[0,4,0,4,0,3,0,5]|[0,2,-1,0,0,4,0,5]".split("\\|")};
            ...
            { focus:0, items : [
                {name:'首页',style:'btnHome',action:[0,5,-1,0,-1,0,-1,1]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-12-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>