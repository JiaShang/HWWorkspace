...
<%
    ...
    final String[] types = {"10000100000000090000000000106425"};
...
<head>
    ...
    <style>
        ...
        .item .maskImage{background:transparent url('images/mask-2016-06-29.png') no-repeat 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += '<div class="text" ' + ( ( i == focus && blocked == index ) ? ' style="color:#fff100;"' : '' ) + '>';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-29.jpg') no-repeat;" onUnload="exit();"></body>
</html>