...
<%
    ...
    final String[] types = {"10000100000000090000000000105033"};
...
<head>
    <title>家庭必备科学急救常识</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-03-30.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:326px;height:46px;left:820px;top:59px;background-position: -76px 0px;}
        .mask2 {width:480px;height:46px;left:744px;top:116px;background-position: 0px -57px;}
        .mask3 {width:390px;height:46px;left:789px;top:171px;background-position: -45px -112px;}
        .mask4 {width:458px;height:46px;left:762px;top:226px;background-position: -18px -167px;}
        .mask5 {width:326px;height:46px;left:828px;top:284px;background-position: -84px -225px;}
        .mask6 {width:421px;height:46px;left:779px;top:338px;background-position: -35px -279px;}
        .mask7 {width:261px;height:46px;left:852px;top:395px;background-position: -108px -336px;}
        .mask8 {width:364px;height:46px;left:805px;top:451px;background-position: -61px -392px;}
        .mask9 {width:307px;height:55px;left:847px;top:513px;background-position: -103px -454px;}
        ...
        var focusable = focusable ? focusable : [
            ...
            if( list != null && list.size() > 0){
                for(int i = 0; i < list.size() ; i++){
                    ...
                    if(i == 0) value += ",{text:'倍泰云健康',link:'http://192.168.9.119/beitai/index.htm',playType:-3,style:'mask mask" + (vodList.size() + 1) + "'}";
                    value += "]},";
                }
                out.write(value);
            }
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == 1 || index == -1 || focus == 0 && index == 11) ) return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-03-30.jpg') no-repeat;" onUnload="exit();"></body>
</html>