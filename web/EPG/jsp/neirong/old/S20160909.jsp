...
<%
    ...
    final String[] types = {"10000100000000090000000000106681"};
...
<head>
    ...
    <style>
        .mask {position:absolute;height:29px;background:transparent url('images/mask-2016-09-09.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:183px;left:86px;top:293px;background-position:0px 0px;}
        .mask2 {width:119px;left:118px;top:451px;background-position:0px -30px;}
        .mask3 {width:161px;left:347px;top:452px;background-position:0px -60px;}
        .mask4 {width:119px;left:118px;top:613px;background-position:0px -90px;}
        .mask5 {width:75px;left:396px;top:613px;background-position:0px -120px;}
        .mask6 {width:119px;left:615px;top:613px;background-position:0px -150px;}
        .mask7 {width:183px;height:60px;left:804px;top:585px;background-position:0px -180px;}
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                            ...
                            str += "}" ;
                            str += ( j + 1 < vodList.size()  ? "," : ",{name:'影视原声',style:'mask mask7',playType:-3,link:'http://192.168.48.217:8085/iptv/entrance.jsp?gpid=235'}");
                        value += str;
                    }
                    value += "]},";
                }
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == focusable.length - 1) { blocked = 0;focus = focusable[blocked].focus; }
                         ...
                         if( blocked == 0 && ( focus == 0 && index == 11 || ( focus == 0 || focus == 1 || focus == 3 ) && index == -1 || focus >= 3 && index == -11 ) ) return;
                         if( blocked == 0 ) {
                             if( index == -1 ) focus -= 1;
                             else if( index == 1 ) {
                                 if( focus == 0 ) focus = 2 ;
                                 ...
                                 if(index == 1 && focus >= focusable[blocked].items.length ) {
                                     blocked = focusable.length - 1; focus = 0;
                                 }
                             } else if( index == 11){
                                 if(focus == 1 || focus == 2 ) focus = 0 ;
                                 else if( focus == 3 ) focus = 1;
                                 else focus = 2;
                             } else {
                                 if( focus == 0 ) focus = 1;
                                 else if( focus <= 2 ) focus += 2;
                             }
                         }
                     }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>