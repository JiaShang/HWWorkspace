...
<head>
    ...
    <style>
        ...
        .backNormal{position:absolute;width:251px;height:52px;left:1003px;top:629px;background:transparent url('images/mask-TemplateRangle.png') no-repeat fixed 0px -250px;}
        .item .image,.item .maskImage{ width:200px;height:245px;left:0px;top:-230px;position:relative; background:transparent url('images/mask-TemplateRangle.png') no-repeat fixed; }
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:[0],popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:'<div class="backNormal"></div>'}});
