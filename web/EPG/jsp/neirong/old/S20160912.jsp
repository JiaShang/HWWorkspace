...
<%
    ...
    final String[] types = {"10000100000000090000000000106689"};
...
<head>
    <title>金秋送爽 邂逅美味</title>
    <style>
        .mask {position:absolute;height:27px;background:transparent url('images/mask-2016-09-12.png') no-repeat;background-position: 0px 0px;}

        .mask1 {width:141px;left:53px;top:205px;background-position: 0px 0px;}
        .mask2 {width:257px;left:53px;top:237px;background-position: 0px -30px;}
        .mask3 {width:99px;left:53px;top:269px;background-position: 0px -60px;}
        .mask4 {width:99px;left:53px;top:301px;background-position: 0px -90px;}
        .mask5 {width:99px;left:53px;top:334px;background-position: 0px -120px;}
        .mask6 {width:185px;left:53px;top:366px;background-position: 0px -150px;}
        .mask7 {width:171px;left:225px;top:449px;background-position: 0px -180px;}
        .mask8 {width:146px;left:225px;top:481px;background-position: 0px -210px;}
        .mask9 {width:171px;left:225px;top:514px;background-position: 0px -240px;}
        .mask10 {width:171px;left:225px;top:546px;background-position: 0px -270px;}
        .mask11 {width:198px;height:67px;left:930px;top:509px;background-position: 0px -300px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            ...
            %>
            { focus:0,items : [{name:'链接',style:'mask mask11',playType:-3,link:'http://192.168.33.75:80/TGO/themeActivity.htm?oprtCatNo=00000156'}]},
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked === 0  && ( index == -1 || focus <= 0 && index == 11 || focus + 1 >= focusable[blocked].items.length && index == -11 ) ||
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-09-12.jpg') no-repeat;" onUnload="exit();"></body>
</html>