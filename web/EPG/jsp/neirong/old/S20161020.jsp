...
<head>
    <title>侠探与机械师复活</title>
    <style>
        .mask {position:absolute;height:23px;background:transparent url('images/mask-2016-10-20.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:257px;left:27px;top:456px;background-position:0px 0px;}
        .mask2{width:111px;left:100px;top:504px;background-position:0px -30px;}
        .mask3{width:133px;left:89px;top:552px;background-position:0px -60px;}
        .mask4{width:133px;left:89px;top:600px;background-position:0px -90px;}
        .mask5{width:309px;left:336px;top:457px;background-position:0px -120px;}
        .mask6{width:133px;left:424px;top:505px;background-position:0px -150px;}
        .mask7{width:125px;left:428px;top:553px;background-position:0px -180px;}
        .mask8{width:133px;left:424px;top:601px;background-position:0px -210px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus % 4 == 0 && index == 11 || focus <= 3 && index == -1 || focus % 4 == 3 && index == -11)) return;
                    if( blocked == focusable.length - 1 ) {
                        blocked = 0; focus = focusable[blocked].focus;
                    } else {
                        if( index == 11 || index == -11 ) focus += index > 0 ? -1 : 1;
                        else if( index == -1) focus -= 4;
                        else if( index == 1 && focus <= 3 ) focus += 4;
                        else {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-10-20.jpg') no-repeat;" onUnload="exit();"></body>
</html>
