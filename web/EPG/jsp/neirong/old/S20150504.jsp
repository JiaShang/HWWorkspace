...
<%
    ...
    final String[] types = {"10000100000000090000000000105101"};
...
<head>
    <title>女英雄的革命传奇</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-05-04.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:115px;height:31px;left:49px;top:253px; background-position: 0px 0px;}
        .mask2 {width:183px;height:34px;left:475px;top:342px; background-position: 0px -40px;}
        .mask3 {width:154px;height:33px;left:972px;top:202px; background-position: 0px -80px;}
        .mask4 {width:295px;height:35px;left:220px;top:597px; background-position: 0px -120px;}
        .mask5 {width:265px;height:32px;left:509px;top:461px; background-position: 0px -160px;}
        .mask6 {width:295px;height:35px;left:954px;top:571px; background-position: 0px -200px;}
        .flowed {}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-05-04.jpg') no-repeat;" onUnload="exit();"></body>
</html>