...
<%
    ...
    final String[] types = {"10000100000000090000000000105332"};
...
<head>
    <title>暑期电影看啥哟</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-07-17.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:130px;height:37px;left:139px;top:156px; background-position: 0px 0px;}
        .mask2 {width:106px;height:35px;left:137px;top:190px; background-position: 0px -50px;}
        .mask3 {width:178px;height:40px;left:135px;top:223px; background-position: 0px -100px;}
        .mask4 {width:154px;height:38px;left:132px;top:257px; background-position: 0px -150px;}
        .mask5 {width:250px;height:45px;left:130px;top:290px; background-position: 0px -200px;}
        .mask6 {width:106px;height:35px;left:52px;top:494px; background-position: 0px -250px;}
        .mask7 {width:130px;height:35px;left:50px;top:528px; background-position: 0px -300px;}
        .mask8 {width:202px;height:41px;left:48px;top:561px; background-position: 0px -350px;}
        .mask9 {width:225px;height:55px;left:901px;top:263px; background-position: -250px 0px;}
        .mask10 {width:287px;height:62px;left:906px;top:289px; background-position: -250px -70px;}
        .mask11 {width:216px;height:54px;left:910px;top:331px; background-position: -250px -140px;}
        .mask12 {width:218px;height:43px;left:989px;top:512px; background-position: -250px -210px;}
        .mask13 {width:191px;height:41px;left:987px;top:546px; background-position: -250px -280px;}
        .mask14 {width:154px;height:39px;left:984px;top:579px; background-position: -250px -350px;}
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked < focusable.length - 2  && (
                         index == 11 && (focus == 0 || focus == 8) || //按上光标键时
                         index == -1 && focus <= 7  || //按左光标键时
                         index == 1 && focus >= 8 || //按右光标键时
                         index == -11 && focus == 7  //按下光标键时
                     ) ) return;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-07-17.jpg') no-repeat;" onUnload="exit();"></body>
</html>