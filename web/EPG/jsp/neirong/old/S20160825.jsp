...
<%
    ...
    final String[] types = {"10000100000000090000000000106643"};
...
<head>
    <title>火线缉凶生死决战</title>
    <style>
        .mask {width:240px;height:51px;position:absolute;background:transparent url('images/mask-2016-08-25.png') no-repeat;background-position: 0px 0px;}
        .mask1 {left:99px;top:306px;background-position:0px 0px;}
        .mask2 {left:99px;top:342px;background-position:0px -50px;}
        .mask3 {left:99px;top:378px;background-position:0px -100px;}
        .mask4 {left:99px;top:414px;background-position:0px -150px;}
        .mask5 {left:99px;top:449px;background-position:0px -200px;}
        .mask6 {left:479px;top:435px;background-position:0px -250px;}
        .mask7 {left:479px;top:470px;background-position:0px -300px;}
        .mask8 {left:479px;top:506px;background-position:0px -350px;}
        .mask9 {left:479px;top:540px;background-position:0px -400px;}
        .mask10 {left:440px;top:574px;background-position:0px -450px;}
        .mask11 {left:847px;top:283px;background-position:0px -500px;}
        .mask12 {left:847px;top:319px;background-position:0px -550px;}
        .mask13 {left:847px;top:355px;background-position:0px -600px;}
        .mask14 {left:847px;top:391px;background-position:0px -650px;}
        .flowed {}
        .after {}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked ==0  && ( focus % 5 == 0 && index == 11 || focus < 5 && index == -1 || focus > 10 && index == 1 || focus % 5 == 4 && index == -11 ) ) return;
                    if( blocked == 0 ) {
                        if( index == 11 || index == -11 ) {
                            focus += index > 0 ? -1 : 1;
                            if( index == -11 && focus >= focusable[0].items.length ) {
                                blocked = focusable.length -1; focus = focusable[blocked].focus;
                            }
                        }  else {
                            focus += index * 5;
                            if( index == 1 && focus >= focusable[0].items.length ) {
                                blocked = focusable.length -1; focus = focusable[blocked].focus;
                            }
                        }
                    } else if( blocked == focusable.length - 1) {
                        blocked = 0;
                        focus = index == 11 ? focusable[blocked].items.length -1 : 9;
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-25.jpg') no-repeat;" onUnload="exit();"></body>
</html>