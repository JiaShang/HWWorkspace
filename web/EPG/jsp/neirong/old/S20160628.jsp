...
<head>
    ...
    <style>
        .mask {height:45px;top:587px;position:absolute;background:transparent url('images/mask-2016-06-28.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:186px;left:886px;background-position:0px 0px;}
        .mask2{width:91px;left:1093px;background-position:-200px 0px;}
        .flowed {}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:0,item:undefined,id: 333}],video:undefined,position:undefined,external:{after:undefined,before:undefined}}); //'<div class="after"></div>'
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-06-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>