...
<head>
    <title>张艺谋的大片之梦</title>
    <style>
        .mask {width:267px;height:37px;position:absolute;background:transparent url('images/mask-2016-12-15.png') no-repeat;background-position: 0px -220px;}
        .mask1 {left:66px;top:413px;}
        .mask2 {left:66px;top:461px;}
        .mask3 {left:66px;top:509px;}
        .mask4 {left:66px;top:557px;}
        .mask5 {left:66px;top:606px;}
        .mask6 {left:357px;top:413px;}
        .mask7 {left:357px;top:461px;}
        .mask8 {left:357px;top:509px;}
        .mask9 {left:357px;top:557px;}


        .flowed {}
        .after {width:526px;height:216px;left:87px;top:418px;background-position: 0px 0px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == 11 && ( focus == 0 || focus == 5 ) || index == -1 && focus < 5 || index == -11 && ( focus == 4 || focus + 1 == focusable[blocked].items.length)  )) return;
                    if( blocked  == 0 ) {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-12-15.jpg') no-repeat;" onUnload="exit();"></body>
</html>