...
<%
    ...
    final String[] types = {"10000100000000090000000000105387"};
...
<head>
    <title>暑假补剧班之国产剧新名词大科普</title>
    <style>
        .mask {width:242px;height:41px;position:absolute;background:transparent url('images/mask-2015-08-11.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1{left:203px;top:302px;background-position: 0px 0px;}
        .mask2{left:832px;top:260px;background-position: 0px -100px;}
        .mask3{left:195px;top:544px;background-position: 0px -50px;}
        .mask4{left:826px;top:565px;background-position: 0px -150px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-08-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>