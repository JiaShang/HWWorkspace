...
<%
    ...
    final String[] types = {"10000100000000090000000000108764"};
...
<head>
    ...
    <style>
        ...
        .itemGroupContainer {width:230px;height:400px;float: left;position: relative;overflow:hidden;text-align: center;}
        .itemGroup { position:absolute; width:192px;left:19px;top:6px;height:382px;overflow: hidden;background-color: #230939;}
        .itemGroupFocus { position:absolute; width:192px;left:19px;top:3px;height:382px;overflow: hidden;background-color: #230939; border:solid 3px #FFDE00;}
        .groupTitle {width:192px;position:absolute;left:0px;top:0px;color:#998599;font-size:26px;text-align: center;overflow: hidden;height:45px;line-height: 40px;}
        .itemGroupFocus .groupTitle{color:white;}

        .groupItem1,.groupItem2,.groupItem1Focus,.groupItem2Focus {position:absolute; width:192px;left:0px;top:6px;height:38px;overflow: hidden;font-size:24px;text-align: center;overflow: hidden;line-height: 32px;word-break: keep-all;}
        .groupItem1,.groupItem2 {color:#998599;}
        .groupItem1Focus,.groupItem2Focus{color:#300b38;background-color:#FFDD00;}
        .groupItem1,.groupItem1Focus {top:288px;}
        .groupItem2,.groupItem2Focus {top:330px;}

        .groupPicture{position:absolute;left:11px;top:45px;width:169px;height:229px;overflow: hidden;}
        .groupPicture img {width:169px;height:229px;}
        .maskMarquee {width:192px;height: 38px;line-height:32px; }
        .flowed {position: absolute;width:930px;height:400px;overflow: hidden;left:191px;top:274px;overflow: hidden;}
        .after {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var groupTitle = ["80年代","90年代","00年代","10年代"];
        var flowedShow = function(index){
            ...
            var html = '';
            for(var i = 0; i < 4; i ++) {
                html += "<div class='itemGroupContainer'>";
                html += "<div class='" + (( i == focus || i + 4 == focus ) ? "itemGroupFocus" : "itemGroup") +  "'>";
                html += "<div class='groupTitle'>" + groupTitle[i] + "</div>";

                var item = items[consign[i]];
                html += "<div class='groupPicture'><img src='" + item.picture + "' /></div>";

                if( i !== focus ) {
                    item = items[i];
                    html += "<div class='groupItem1'>" +  item.shortText  + "</div>";
                }

                if( (i === focus || i + 4 === focus) && blocked == index ) //焦点
                {
                    item = items[i + 4 === focus ? i + 4 : i];
                    html += "<div class='groupItem" + ( i + 4 === focus ? "2" : "1") + "Focus'>" + ( item.shortText != item.text ? ('<marquee class="maskMarquee">' + item.text + '</marquee>') : item.text ) + "</div>";
                }

                if( i + 4 !== focus ) {
                    item = items[i + 4];
                    html += "<div class='groupItem2'>" +  item.shortText  + "</div>";
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-12-09.jpg') no-repeat;" onUnload="exit();"></body>
</html>