...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'共和国之父——孙中山',style:'mask mask11',playType:-3,link:'http://192.168.34.131:8300/video_hall/special/special_swglxh2/index.do'},
                {name:'金英光',style:'mask mask12',playType:-3,link:'http://192.168.98.67:9988/ggly-gd-hd/index.jsp?entry=recommend1&code=20170602_llhmm_album'},
                {name:'谭咏麟巡演门票等你拿',style:'mask mask13',playType:-3,link:'http://192.168.34.81/HiFi_cq/wailiu/wl/HiFi_songList.html?albumId=wl_030&type=0&wlColor=ffffff_000000'}
            ]},
            { focus:0,items : [
                {name:'谁说美女不能丑',style:'mask mask21',playType:-3,link:'http://192.168.35.17:8086/special/index?id=120&from=ztdl'},
                {name:'热剧追不停',style:'mask mask22',playType:-3,link:'http://192.168.98.65:10001/IPTVGameEPG/index.jsp?recoCode=LTR_10256'},
                {name:'从你的全重庆路过',style:'mask mask23',playType:-3,link:'http://192.168.98.65:10004/IPTVGameEPG/index.jsp?recoCode=LTR_10255'},
                {name:'从你的全重庆路过',style:'mask mask24',playType:-3,link:'http://192.168.35.153:8080/program_theme_9.jsp?id=30&type=9&lcn=jians'},
                {name:'最强综艺全收录',style:'mask mask25',playType:-3,link:'http://192.168.34.131:8300/video_hall/king_arthur.do'}
            ]},
            { focus:0,items : [
                {name:'打开火锅地图',style:'mask mask31',playType:-3,link:'http://192.168.34.73/special/muqingjie/m.php'},
                {name:'国庆音乐假期',style:'mask mask32',playType:-3,link:'http://192.168.48.217:8085/iptv/entrance.jsp?gpid=242&entry=ott'},
                {name:'一元购',style:'mask mask33',playType:-3,link:'http://192.168.33.75:80/TGO/themeActivity.htm?oprtCatNo=00000076'}
            ]},
            { focus:0,items : [
                {name:'国庆特价游',style:'mask mask41',playType:-3,link:'http://192.168.35.17:8082/Page/Index?tagId=2&currentPage=1&fromTitle=%E6%99%BA%E6%85%A7%E6%97%85%E6%B8%B8-%E9%A6%96%E9%A1%B5'},
                {name:'国庆亲子游',style:'mask mask42',playType:-3,link:'http://192.168.98.67:9988/ggly-gd-hd/index.jsp?entry=recommend1&code=20160921_gqqzy_activity'},
                {name:'礼惠国庆',style:'mask mask43',playType:-3,link:'http://192.168.33.75:80/TGO/themeActivity.htm?oprtCatNo=00000157'}
            ]},
