...
<%
    ...
    final String[] types = {"10000100000000090000000000105333"};
...
<head>
    <title>暑期补剧之仙侠来袭</title>
    <style>
        .mask {width:285px;height:117px;left:766px;position:absolute;background:transparent url('images/mask-2015-07-16.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {top:106px; background-position: 0px 0px;}
        .mask2 {top:167px; background-position: 0px -120px;}
        .mask3 {top:230px; background-position: 0px -240px;}
        .mask4 {top:294px; background-position: 0px -360px;}
        .mask5 {top:357px; background-position: -300px 0px;}
        .mask6 {top:421px; background-position: -300px -120px;}
        .mask7 {top:484px; background-position: -300px -240px;}
        .mask8 {top:546px; background-position: -300px -360px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-07-16.jpg') no-repeat;" onUnload="exit();"></body>
</html>