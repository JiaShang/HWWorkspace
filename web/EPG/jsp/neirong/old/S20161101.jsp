...
<%
    ...
    final String[] types = {"10000100000000090000000000106654"};
...
<head>
    <title>谁是荧幕最佳组合</title>
    <style>
        .mask {height:40px;position:absolute;background:transparent url('images/mask-2016-11-01.png') no-repeat;background-position: 0px 0px;}

        .mask1 {width:287px;left:364px;top:302px;background-position: 0px 0px;}
        .mask2 {width:262px;left:409px;top:365px;background-position: 0px -40px;}
        .mask3 {width:269px;left:452px;top:429px;background-position: 0px -80px;}
        .mask4 {width:306px;left:500px;top:494px;background-position: 0px -120px;}
        .mask5 {width:390px;left:542px;top:557px;background-position: 0px -160px;}

        .flowed {}
        .after {width:266px;height:342px;left:314px;top:282px;background-position:0px -200px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-01.jpg') no-repeat;" onUnload="exit();"></body>
</html>