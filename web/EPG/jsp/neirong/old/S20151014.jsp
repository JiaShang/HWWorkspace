...
<%
    ...
    final String[] types = {"10000100000000090000000000105581"};
...
<head>
    <title>天才少年养成记</title>
    <style>
        .mask {position:absolute;height:29px;background:transparent url('images/mask-2015-10-14.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:82px;left:788px;top:229px;background-position: 0px 0px;}
        .mask2 {width:110px;left:989px;top:229px;background-position: 0px -30px;}
        .mask3 {width:138px;left:760px;top:268px;background-position: 0px -60px;}
        .mask4 {width:194px;left:947px;top:268px;background-position: 0px -90px;}
        .mask5 {width:110px;left:774px;top:306px;background-position: 0px -120px;}
        .mask6 {width:110px;left:994px;top:306px;background-position: 0px -150px;}
        .mask7 {width:113px;left:777px;top:344px;background-position: 0px -180px;}
        .mask8 {width:110px;left:994px;top:344px;background-position: 0px -210px;}
        .flowed {}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-10-14.jpg') no-repeat;" onUnload="exit();"></body>
</html>