...
<head>
    <title>汪苏泷演唱会独家直播</title>
    <style>
        .mask {position:absolute;height:28px;background:transparent url('images/mask-2017-05-11.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:96px;left:81px;top:594px;background-position:0px 0px;}
        .mask2 {width:152px;left:281px;top:594px;background-position:0px -30px;}
        .mask3 {width:96px;left:81px;top:641px;background-position:0px -60px;}
        .mask4 {width:151px;left:281px;top:641px;background-position:0px -90px;}

        .ording {width:177px;height:72px;left:870px;top:458px;background-position: 0px -120px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [                        
            ...
            %>
            { focus:0,items : [{name:'订购',style:'mask ording',playType:-3,link:'http://192.168.17.53'}]},
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( blocked == 1 && index != -1 ||
                        blocked == 0 && ( index == -1 && focus % 2 == 0 || index == 11 && focus <=1 || index == -11 && focus >= 2 )) return;
                    if( index == -1 || index == 1 ) {
                        if( blocked == 1 ) {
                            blocked = 0; focus = focusable[blocked].focus;
                        } else if( index == 1 && focus % 2 == 1 ) {
        ...
        function init(){
            ...
            $.vote.focus = {}
            $.current = function (){
                return "/EPG/jsp/defaultHD/en/SaveCurrFocus.jsp?currFoucs=" + blocked + "," + focusable[0].focus + ",0&url=";
            };
            ...
            focusable[0].focus = <%= focused %>;
            focused(blocked == 1 ? 0 : <%= focused %>, true);
        }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-05-11.jpg') no-repeat;" onUnload="exit();"></body>
</html>