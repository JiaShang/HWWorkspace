...
<title>喜剧铁三角</title>
<style>
    .mask{position:absolute;background:transparent url('images/mask-2014-09-29.png') no-repeat fixed;}
    .mask1 {width:198px;height:80px;left:272px;top:234px;background-position: 0px 0px;}
    .mask2 {width:314px;height:51px;left:684px;top:287px;background-position: 0px -80px;}
    .mask3 {width:148px;height:51px;left:366px;top:378px;background-position: 0px -131px;}
    .mask4 {width:290px;height:82px;left:673px;top:378px;background-position: 0px -182px;}
    .mask5 {width:329px;height:52px;left:393px;top:477px;background-position: 0px -264px;}
    .mask6 {width:296px;height:70px;left:665px;top:512px;background-position: 0px -316px;}
    .mask7 {width:199px;height:51px;left:567px;top:624px;background-position: 0px -386px;}
...
<script language="javascript" type="text/javascript">
    ...
    var focusable = focusable ? focusable : [
        { focus:0, items : [
            <%
                String[] actions = "[0,6,0,2,0,1,0,1]|[1,1,0,3,0,0,0,0]|[0,0,0,4,0,3,0,3]|[0,1,0,5,0,2,0,2]|[0,2,0,6,0,5,0,5]|[0,3,1,1,0,4,0,4]|[0,4,0,0,1,1,1,0]".split("\\|");
        ...
        { focus:0, items : [
            {name:'首页',style:'btnHome',action:[0,6,0,0,0,6,1,1]},
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-09-29.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>