...
<%
    ...
    final String[] types = {"10000100000000090000000000105163"};
...
<head>
    <title>六一亲子合家欢</title>
    <style>
        .mask {width:163px;height:32px;position:absolute;background:transparent url('images/mask-2015-05-28.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {left:97px;top:273px;background-position: 0px 0px;}
        .mask2 {left:324px;top:337px;background-position: 0px -40px;}
        .mask3 {left:629px;top:321px;background-position: 0px -80px;}
        .mask4 {left:955px;top:244px;background-position: 0px -120px;}
        .mask5 {left:133px;top:612px;background-position: 0px -160px;}
        .mask6 {left:410px;top:509px;background-position: 0px -200px;}
        .mask7 {left:641px;top:614px;background-position: 0px -240px;}
        .mask8 {left:901px;top:510px;background-position: 0px -280px;}
        .flowed {}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-05-28.jpg') no-repeat;" onUnload="exit();"></body>
</html>