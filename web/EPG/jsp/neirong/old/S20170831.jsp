...
<%
    ...
    final String[] types = {"10000100000000090000000000108301","10000100000000090000000000108301","10000100000000090000000000108301"};
    final int[] position = {5,0,5,5,4,10};
    //TODO:每次需要修改
...
<head>
    ...
    <style>
        .mask {height:30px;width:270px;position:absolute;background:transparent url('images/mask-2017-08-31.png') no-repeat;background-position: 0px 0px;}

        .mask1 {left:83px;top:216px;background-position: 0px 0px;}
        .mask2 {left:376px;top:216px;background-position: 0px -30px;}
        .mask3 {left:83px;top:254px;background-position: 0px -60px;}
        .mask4 {left:376px;top:254px;background-position: 0px -90px;}
        .mask5 {left:83px;top:290px;background-position: 0px -120px;}

        .mask6 {left:77px;top:396px;background-position: 0px -150px;}
        .mask7 {left:208px;top:396px;background-position: 0px -180px;}
        .mask8 {left:77px;top:434px;background-position: 0px -210px;}
        .mask9 {left:208px;top:434px;background-position: 0px -240px;}
        .mask10 {left:77px;top:470px;background-position: 0px -270px;}

        .mask11 {left:353px;top:396px;background-position: 0px -300px;}
        .mask12 {left:481px;top:396px;background-position: 0px -330px;}
        .mask13 {left:353px;top:434px;background-position: 0px -360px;}
        .mask14 {left:353px;top:470px;background-position: 0px -390px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && !$.vote.tooltiped && blocked == focusable.length - 1 && focus == 1 ) focus = focus + 1;
                    ...
                    if( blocked == 0 && index == 11 && focus <= 1 || blocked != 2 && index == -1 && focus % 2 == 0 ||  index == 1 && ( blocked == 0 && focus % 2 == 1 || blocked == 2 && focus >= 1 ) || index == -11 && (blocked == 1 && focus >= 3 || blocked == 2 && focus == 3 ) ) return;
                    if( index == 1 || index == -1 ) {
                        if( index == 1 && blocked == 1 && ( focus % 2 == 1 || focus == 4 )) {
                            blocked = 2;
                            focus = focus % 2 == 1 ? focus - 1 : 3;
                        } else if( index == -1 && blocked == 2 && (focus % 2 == 0  || focus == 3 )) {
                            blocked = 1;
                            focus = focus % 2 == 0 ? focus + 1 : 4;
                        } else
                            focus += index;
                    } else if( index == -11) {
                        if( blocked == 0 && focus >= 3 ) {
                            blocked =  focus == 4 ? 1 : 2;
                            focus = 0;
                        } else if( blocked == 2 && focus == 1 )
                            focus = 3;
                        else
                            focus += blocked == 2 && focus == 2 ? 1 : 2;
                    } else {
                        if( blocked != 0 && focus <= 1 ) {
                            focus = blocked == 1 ? 4 : 3;
                            blocked = 0;
                        } else
                            focus += blocked == 2 && focus == 3 ? -1 : -2;
                    }
                }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-08-31.jpg') no-repeat;" onUnload="exit();"></body>
</html>