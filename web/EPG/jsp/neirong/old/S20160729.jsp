...
<head>
    <title>今夏邀你1元看大片</title>
    <style>
        .mask {position:absolute;}

        .item{ width:182px;height:240px;margin:0px 12px; float: left; overflow: hidden;}
        .itemContainer{width:182px;height:224px; position:relative;}
        ...
        .item .image,.item .maskImage{ width:184px;height:224px;left:0px;top:-210px;position:relative; background:transparent url('images/yiyuan/focusBg.png') no-repeat; }
        .item .image {background-position: 0px 0px;}
        .item .maskImage{background:transparent url('images/yiyuan/focusNormal.png') no-repeat; }
        .text {width:172px;height:35px; font-size:22px; color:#FEE5f0; line-height:30px; position:relative; top:-248px; overflow: hidden;left:5px;text-align: center; word-break: keep-all;white-space: nowrap;text-overflow:ellipsis;}

        .flowed {width:650px;left:50px;top:110px;height:550px;overflow:hidden;position: absolute;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {text:'奇幻森林',shortText:'奇幻森林',playType:-3,link:'http://192.168.42.52/epg/hollywood/biz_26159974/category/ccms_category_35386400/item/vod/45809.do',picture:'images/yiyuan/34.jpg'},
                {text:'赏金猎人',shortText:'赏金猎人',playType:-3,link:'http://192.168.5.229/dyyx/search_content.htm?vodId=PACKAGE201609000011-gehua',picture:'images/yiyuan/35.jpg'},
                {text:'丛林大反攻4',shortText:'丛林大反攻4',playType:-3,link:'http://192.168.42.52/epg/hollywood/biz_26159974/category/ccms_category_35386400/item/vod/45810.do',picture:'images/yiyuan/36.jpg'},
                {text:'泡沫之夏',shortText:'泡沫之夏',playType:-3,link:'http://192.168.5.229/dyyx/search_content.htm?vodId=PACKAGE201609000014-gehua',picture:'images/yiyuan/37.jpg'},
                {text:'宝贝当家',shortText:'宝贝当家',playType:-3,link:'http://192.168.5.229/dyyx/search_content.htm?vodId=PACKAGE201609000001-gehua',picture:'images/yiyuan/38.jpg'},
                {text:'恐龙当家',shortText:'恐龙当家',playType:-3,link:'http://192.168.42.52/epg/hollywood/biz_26159974/category/ccms_category_35386400/item/vod/45811.do',picture:'images/yiyuan/39.jpg'}
             ]},
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == focusable.length - 1) { blocked = 0;focus = focusable[blocked].focus; }
                        ...
                        if( index == 1 || index == -1 ) {
                            if( index == 1 && focus % columns == columns - 1 ){
        ...
        var flowedShow = function(index){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                ...
                html += '<img src="' + item.picture + '" style=" position:relative;width:164px;height: 214px; left:8px; top:6px;" />'
                html += '<div class="' + ( ( i == focus && blocked == index ) ? 'maskImage' : 'image' ) + '"></div>';
                html += '<div class="text" ' + ( ( i == focus && blocked == index ) ? ' style="color:#FDFA00;"' : '' ) + '>';
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:[0],popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:undefined,before:'<div class="backNormal"></div>'}});
            ...
            switch(item.playType){
                ...
                case -3:
                    ...
                    if( ! item.link.startWith('http') ){
                        ...
                        url = item.link;
                        url += url.indexOf("?") > 0 ? '&' : '?';
                        url += url.indexOf("gehua") > 0 ? 'backurl=' : 'backURL=';
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/yiyuan/bg-2016-07-29-7.jpg') no-repeat;" onUnload="exit();"></body>
</html>