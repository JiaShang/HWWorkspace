...
<head>
    <title>TFBOYS叫你开学了</title>
    <style>
        .mask {width:268px;height:50px;position:absolute;background:transparent url('images/mask-2016-02-22.png') no-repeat fixed;background-position: 0px -150px;}
        .maskFlowed {width:863px;height:134px;left:200px;top:173px;background-position: 0px 0px;}
        .mask1 {left:144px;top:166px;}
        .mask2 {left:144px;top:217px;}
        .mask3 {left:144px;top:265px;}
        .mask4 {left:498px;top:166px;}
        .mask5 {left:498px;top:217px;}
        .mask6 {left:498px;top:265px;}
        .mask7 {left:825px;top:212px;}
        .flowed {}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [
                {name:'写作宝典',style:'mask mask1',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=xxtbfd'},
                {name:'奥数秘籍',style:'mask mask2',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=xtas'},
                {name:'语法解码',style:'mask mask3',playType:-3,link:'http://192.168.9.174/dvb_cqocn_53/welcome/home.htm?welcome=xxyy'},
                {name:'靡靡之音',style:'mask mask4',playType:-3,link:'http://192.168.48.217:8085/iptv/entrance.jsp?gpid=136'},
                {name:'影像帝国',style:'mask mask5',playType:-3,link:'/EPG/jsp/neirong/S20160127.jsp'},
                {name:'云游天下',style:'mask mask6',playType:-3,link:'http://192.168.98.65:10001/IPTVGameEPG/index.jsp?recoCode=LTR_10140'},
                {name:'开学必备装备',style:'mask mask7',playType:-3,link:'http://192.168.33.75:80/TGO/themeActivity.htm?oprtCatNo=00000027&ret=1&backUrl=',isBackUrl:true},
            ]},
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( focus <= 2 && index == -1 || focus == 6 && index == 1 || ( focus == 0 || focus == 3 || focus == 6 ) && index == 11 || ( focus == 2 || focus == 5 ) && index == -11 ) )
                        return;
                    if( blocked == focusable.length - 1 ) { blocked = 0; focus = focusable[0].items.length - 1 ;}
                    else {
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div class="mask maskFlowed"></div>',before:undefined}});
        ...
        function doEnter(){
            ...
            switch(item.playType){
                ...
                case -2:
                    ...
                    break;
                case -3:
                    var url = $.current() + item.link;
                    if( typeof item.isBackUrl == 'boolean' && item.isBackUrl) {
                        url += encodeURIComponent(iPanel.eventFrame.pre_epg_url + "/neirong/S20160222.jsp");
                    }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-02-22.jpg') no-repeat;" onUnload="exit();"></body>
</html>