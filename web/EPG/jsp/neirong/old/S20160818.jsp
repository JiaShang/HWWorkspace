...
<head>
    ...
    <style>
        .mask {height:35px;top:543px;position:absolute;background:transparent url('images/mask-2016-08-18.png') no-repeat;background-position: 0px 0px;}

        .mask1 {width:126px;left:100px;background-position: 0px 0px;}
        .mask2 {width:126px;left:283px;background-position: 0px 0px;}
        .mask3 {width:204px;left:476px;background-position: -200px 0px;}
        .mask4 {width:126px;left:761px;background-position: 0px 0px;}
        .mask5 {width:204px;left:940px;background-position: -200px 0px;}

        .flowed {}
        .after {width:1012px;height:28px;left:123px;top:548px;position:absolute;background:transparent url('images/mask-2016-08-18.png') no-repeat 0px -50px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-08-18.jpg') no-repeat;" onUnload="exit();"></body>
</html>