...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104702";
...
<title>贺岁片哪家强</title>
<style>
    .mask {position:absolute;height:64px;background:transparent url('images/mask-2014-12-01.png') no-repeat fixed 0px 0px;}
    .mask1 {width:167px;left:200px; top:136px;background-position: 0px 0px;}
    .mask2 {width:178px;left:838px; top:132px;background-position: 0px -80px;}
    .mask3 {width:176px;left:114px; top:211px;background-position: 0px -160px;}
    .mask4 {width:215px;left:929px; top:210px;background-position: 0px -240px;}
    .mask5 {width:186px;left:37px; top:291px;background-position: 0px -320px;}
    .mask6 {width:176px;left:1004px; top:292px;background-position: 0px -400px;}
    .mask7 {width:174px;left:89px; top:443px;background-position: 0px -480px;}
    .mask8 {width:174px;left:1033px; top:433px;background-position: 0px -560px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-12-01.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>