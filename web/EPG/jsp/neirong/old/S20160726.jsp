...
<head>
    <title>心中有你 锦瑟年华</title>
    <style>
        .mask {height:30px;left:84px;position:absolute;background:transparent url('images/mask-2016-07-26.png') no-repeat;background-position: 0px 0px;}
        .mask1{width:200px;top:257px;background-position: 0px 0px;}
        .mask2{width:129px;top:291px;background-position: 0px -40px;}
        .mask3{width:136px;top:416px;background-position: 0px -80px;}
        .mask4{width:108px;top:450px;background-position: 0px -120px;}
        .mask5{width:221px;top:572px;background-position: 0px -160px;}
        .mask6{width:127px;top:606px;background-position: 0px -200px;}
        .flowed {}
        .after {}
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    focus = focus - 1;
                     ...
                     if( blocked == 0 && ( focus == 0 && index == 11 || index == -1 || focus + 1 >= focusable[blocked].items.length && index == -11 )) return;
                    if( blocked == 0 ) {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-07-26.jpg') no-repeat;" onUnload="exit();"></body>
</html>