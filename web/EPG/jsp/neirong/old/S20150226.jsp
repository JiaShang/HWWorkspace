...
<%@ page import="org.apache.abdera.protocol.Request" %>
...
<%
    ...
    final String[] types = {"10000100000000090000000000104932"};
    final int[] position = {39,0};
    //TODO:每次需要修改
...
<head>
    <title>寒假补习班英美剧</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-02-26.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:199px;height:35px;left:503px;top:245px;background-position: 0px 0px;}
        .mask2 {width:199px;height:35px;left:503px;top:245px;background-position: 0px -40px;}
        .mask3 {width:181px;height:32px;left:525px;top:280px;background-position: 0px -80px;}
        .mask4 {width:181px;height:32px;left:525px;top:280px;background-position: 0px -120px;}
        .mask5 {width:182px;height:32px;left:525px;top:311px;background-position: 0px -160px;}
        .mask6 {width:182px;height:32px;left:525px;top:311px;background-position: 0px -200px;}
        .mask7 {width:162px;height:33px;left:543px;top:343px;background-position: 0px -240px;}
        .mask8 {width:162px;height:33px;left:543px;top:343px;background-position: 0px -280px;}
        .mask9 {width:135px;height:31px;left:567px;top:376px;background-position: 0px -320px;}
        .mask10 {width:135px;height:31px;left:567px;top:376px;background-position: 0px -360px;}
        .mask11 {width:202px;height:33px;left:500px;top:406px;background-position: 0px -400px;}
        .mask12 {width:202px;height:33px;left:500px;top:406px;background-position: 0px -440px;}
        .mask13 {width:240px;height:36px;left:462px;top:438px;background-position: 0px -480px;}
        .mask14 {width:240px;height:36px;left:462px;top:438px;background-position: 0px -520px;}
        .mask15 {width:191px;height:32px;left:548px;top:523px;background-position: 0px -560px;}
        .mask16 {width:191px;height:32px;left:548px;top:523px;background-position: 0px -600px;}
        .mask17 {width:191px;height:32px;left:548px;top:523px;background-position: 0px -640px;}
        .mask18 {width:237px;height:35px;left:502px;top:553px;background-position: 0px -680px;}
        .mask19 {width:237px;height:35px;left:502px;top:553px;background-position: 0px -720px;}
        .mask20 {width:237px;height:35px;left:502px;top:553px;background-position: 0px -760px;}
        .mask21 {width:177px;height:31px;left:524px;top:588px;background-position: 0px -800px;}
        .mask22 {width:177px;height:31px;left:524px;top:588px;background-position: 0px -840px;}
        .mask23 {width:181px;height:32px;left:563px;top:619px;background-position: 0px -880px;}
        .mask24 {width:181px;height:32px;left:563px;top:619px;background-position: 0px -920px;}
        .mask25 {width:181px;height:32px;left:563px;top:619px;background-position: 0px -960px;}
        .mask26 {width:202px;height:34px;left:571px;top:651px;background-position: 0px -1000px;}
        .mask27 {width:202px;height:34px;left:571px;top:651px;background-position: 0px -1040px;}
        .mask28 {width:202px;height:34px;left:571px;top:651px;background-position: 0px -1080px;}
        .mask29 {width:202px;height:34px;left:571px;top:651px;background-position: 0px -1120px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var saved = [[0,0,2],[2,0,2],[4,0,2],[6,0,2],[8,0,2],[10,0,2],[12,0,2],[14,0,3],[17,0,3],[20,0,2],[22,0,3],[25,0,4]];
        var savedIndex = 0;
        //可获得焦点的区域个数
                ...
                for(int i = 0; i < list.size() ; i++){
                    ...
                    for( int j = 0; j < vodList.size() ; j++ ){
                        ...
                        String str = "{ mid:'" + vod.getId() + "'," +
                              ...
                              "shortText:\"" + StringUtil.limitStringLength(vod.getName(), i == 0 ? 28 : popItemMaxCharLength) + "\"" + "," +
                                  "style:'mask mask" + (j + 1) + "'" + "," +
                                 //"action:" + actions[i][j] + "," +
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if(
                    ...
                    blocked == focusable.length - 1 && (/*focus == 0 && index == -1 ||*/  index == 11 || index == -11 || focus == 1 && index == 1 ) ||
                    //如果焦点在投票上,按上下左右键时
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if(blocked == focusable.length - 1) { blocked = 0; focus = saved[savedIndex][0] + saved[savedIndex][1]; }
                    else {
                        if( savedIndex == 0 && index == 11 || savedIndex == savedIndex.length - 1 && index == -11 || focus == saved[savedIndex][0] && index == -1 ) return;

                        if(index == -1 ) saved[savedIndex][1]--;
                        else if( index == 11 )savedIndex --;
                        else if( index == -11 ) savedIndex ++;
                        else if( index == 1 ){
                            if( saved[savedIndex][1] + 1 >= saved[savedIndex][2] ) { blocked = focusable.length - 1; focus = focusable[blocked].focus; }
                            else saved[savedIndex][1]++;
                        }

                        if(blocked == 0) focus = saved[savedIndex][0] + saved[savedIndex][1];
                    }
                    //TODO:光标移动
                }
                ...
                //compute savedIndex;
                for(var xz = 0; xz < saved.length; xz ++){
                    if(focus < saved[xz][0] || focus >= saved[xz][0] + saved[xz][2]) continue;
                    savedIndex = xz;
                    saved[savedIndex][1] = focus - saved[xz][0];
                    break;
                }
            }
        ...
        var flowedShow = function(index){
            ...
            //每页显示数量
            var size = 16.0;
            startedFlowed = Math.floor(focus / size) * size;
            var html = '';
            var length = items.length - startedFlowed >= size ? size : items.length - startedFlowed;
            for(var i = 0; i < length; i += 1) {
                var current = startedFlowed + i;
                //TODO：这里需要写代码
            }
        ...
        function init(){
            ...
            $.vote.show = function(){
                ...
                $.vote.currentVisibility = $("mask").style.visibility;
            ...
            $.vote.hidden = function(className){
                ...
                $.vote.tooltiped = false;
                $.vote.current = undefined;
                $("mask").style.visibility = $.vote.currentVisibility;
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-02-26.jpg') no-repeat;" onUnload="exit();"></body>
</html>