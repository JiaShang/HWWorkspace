...
<%
    ...
    if(  typeId == null || typeId.trim().length() == 0 )
        typeId = "10000100000000090000000000104480";
...
<title>夏日出走吧</title>
<style>
    .maskOne {position:absolute;width:206px;height:258px;background:transparent url('images/mask-2014-09-01.png') no-repeat fixed 0px 0px;}
    .maskTwo {position:absolute;width:222px;height:284px;background:transparent url('images/mask-2014-09-01.png') no-repeat fixed 0px -258px;}
    .mask1 {top:186px; left:60px;}
    .mask2 {top:163px; left:228px;}
    .mask3 {top:138px; left:401px;}
    .mask4 {top:115px; left:569px;}
    .mask5 {top:407px; left:437px;}
    .mask6 {top:381px; left:628px;}
    .mask7 {top:356px; left:814px;}
    .mask8 {top:331px; left:1002px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2014-09-01.jpg') no-repeat;">
<div id="mask"></div>
</body>
</html>