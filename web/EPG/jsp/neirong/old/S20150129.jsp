...
<%
    ...
    final String[] types = {"10000100000000090000000000104901"};
...
<title>二月观影指南</title>
<style>
    .mask {position:absolute;background:transparent url('images/mask-2015-01-29.png') no-repeat fixed;background-position: 0px 0px;}

    .maskText1 {width:268px;height:31px;left:55px;top:216px;background-position: -55px -216px;}
    .maskText2 {width:268px;height:31px;left:55px;top:312px;background-position: -55px -312px;}
    .maskText3 {width:268px;height:31px;left:55px;top:408px;background-position: -55px -408px;}
    .maskText4 {width:268px;height:31px;left:55px;top:504px;background-position: -55px -504px;}
    .maskText5 {width:268px;height:31px;left:55px;top:600px;background-position: -55px -600px;}
    .maskText6 {width:331px;height:31px;left:368px;top:216px;background-position: -368px -216px;}
    .maskText7 {width:331px;height:31px;left:368px;top:312px;background-position: -368px -312px;}
    .maskText8 {width:331px;height:31px;left:368px;top:408px;background-position: -368px -408px;}
    .maskText9 {width:331px;height:31px;left:368px;top:504px;background-position: -368px -504px;}
    .maskText10 {width:331px;height:31px;left:368px;top:600px;background-position: -368px -600px;}
    .maskText11 {width:175px;height:31px;left:744px;top:216px;background-position: -744px -216px;}
    .maskText12 {width:175px;height:31px;left:744px;top:312px;background-position: -744px -312px;}
    .maskText13 {width:175px;height:31px;left:744px;top:408px;background-position: -744px -408px;}
    .maskText14 {width:175px;height:31px;left:744px;top:504px;background-position: -744px -504px;}
    .maskText15 {width:175px;height:31px;left:744px;top:600px;background-position: -744px -600px;}
    .maskVote {width:53px;height:26px;background-position: -845px -349px;}
...
<script language="javascript" type="text/javascript">
        ...
        if( list != null && list.size() > 0){
            for(int i = 0; i < list.size() ; i ++){
                ...
                for( int j = 0; j < vodList.size() ; j++ ){
                    ...
                    str += "},{text:'" + vod.getName() + "'," +
                         "playType:-2}" + ( j + 1 < vodList.size()  ? "," : "");
                    value += str;
                }
                value += "]},";
                out.write(value);
    ...
    function focused(index,initilized){
        ...
        if(typeof index == "number" && !initilized){
            ...
            if(
                ...
                blocked == focusable.length - 1 && (index == -11 || focus == 1 && index == 1 || index == 11 ) ||
                //如果焦点在投票上,按上下左右键时
            ...
            if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                ...
                //每次都需要修改的地方
                if( blocked == focusable.length - 1 && index == -1 && focus == 0 ) {
                    blocked = 0; focus = focusable[blocked].focus;
                }  else if(blocked == 0 ) {
                    if(focus <= 9 && index == -1 || focus % 10 == 0 && index == 11 || focus % 10 == 9 && index == -11 ) return;
                    if( index == 1 ) { if( focus <= 20 ) { focus += 10; } else { blocked = focusable.length - 1;focus = focusable[blocked].focus; } }
                    else if( index == -1 ) focus -= 10;
        ...
        if( blocked == 0 ){
            var col = Math.floor(focus / 10);
            var row = Math.floor(focus % 10 / 2);
            if(focus % 2 == 0){
                $("mask").style.left = "";
                $("mask").style.top = "";
                $("mask").className = "mask maskText" + Math.floor(focus / 2  + 1);
            } else {
                $("mask").style.left = focus == 1 ? "158px" : (col == 0 ? "141px" : (col == 1 ? "469px" : "844px"));
                $("mask").style.top = (row * 96 + 253) + "px";
                $("mask").className = "mask maskVote";
            }
        }
    }
    function goBack(){
    ...
    function init(){
        ...
        //vote:[0,0] ,投票ID,0:0
        //popup:是否包含弹出对话框
        $.buildUserInterface({popup:undefined,vote:[{blocked:0,item:undefined,id: 196}],video:undefined,position:undefined});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-01-29.jpg') no-repeat;" onUnload="exit();"></body>
</html>