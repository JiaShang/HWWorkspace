...
<%
    ...
    final String[] types = {"10000100000000090000000000106520"};
...
<head>
    <title>世界足坛年终盘点</title>
    <style>
        .mask {height:155px;position:absolute;background:transparent url('images/mask-2017-01-24.png') no-repeat;background-position: 0px 0px;}
        .mask1 {width:457px;left:92px;top:215px;background-position: 0px 0px;}
        .mask2 {width:572px;left:35px;top:275px;background-position: 0px -155px;}
        .mask3 {width:572px;left:35px;top:335px;background-position: 0px -310px;}
        .mask4 {width:436px;left:103px;top:395px;background-position: 0px -465px;}
        .mask5 {width:428px;left:107px;top:455px;background-position: 0px -620px;}
        .mask6 {width:391px;left:125px;top:515px;background-position: 0px -930px;}
        .mask7 {width:341px;left:144px;top:575px;background-position: 0px -775px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2017-01-24.jpg') no-repeat;" onUnload="exit();"></body>
</html>