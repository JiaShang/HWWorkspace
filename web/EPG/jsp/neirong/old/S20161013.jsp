...
<%
    ...
    final String[] types = {"10000100000000090000000000106741"};
    final int[] position = {13,0};
    //TODO:每次需要修改
    int focused = 4, area = 0;
    final int popItemMaxCharLength = 36;

    String backUrl = "";
    String fromEPG = "";
    String value = "";
    String isKorean = "true";
...
<head>
    <title>釜山行主演大起底</title>
    <style>
        .mask {width:184px;height:37px;position:absolute;background:transparent url('images/mask-2016-10-13.png') no-repeat;background-position: 0px 0px;}
        .mask1{left:231px;top:406px;}
        .mask2{left:231px;top:449px;}
        .mask3{left:231px;top:490px;}

        .mask4{left:594px;top:383px;}
        .mask5{left:594px;top:425px;}
        .mask6{left:594px;top:467px;}
        .mask7{left:594px;top:509px;}

        .mask8{width:268px;left:958px;top:343px;background-position:0px -50px;}
        .mask9{width:268px;left:958px;top:380px;background-position:0px -50px;}
        .mask10{width:268px;left:958px;top:417px;background-position:0px -50px;}
        .mask11{width:268px;left:958px;top:456px;background-position:0px -50px;}
        .mask12{width:268px;left:958px;top:495px;background-position:0px -50px;}
        .mask13{width:268px;left:958px;top:534px;background-position:0px -50px;}

        .flowed {}
        .after {position:absolute;background:transparent url('images/focusBg-2016-10-13.png') no-repeat;background-position: 0px 0px;width:969px;height:212px;left:248px;top:352px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && ( index == 11 && ( focus == 0 || focus == 3 || focus == 7 ) || index == -11 && ( focus == 2 || focus == 6 ) || index == -1 && focus <= 2 || index == 1 && focus >= 7 )) return;
                    if( blocked == focusable.length -1 ){
                        blocked = 0; focus = focusable[blocked].focus;
                    } else {
                        if( index == 11 || index == -11 ) {
                            if( index == -11 && focus + 1 >= focusable[blocked].items.length ) {
                            ...
                            if( focus == 12 ) focus = 6;
                            else if( focus == 7 ) focus = 3;
                            else if( focus == 6 ) focus = 2;
                            else if( focus > 7 && focus <= 11 ) focus -= 5;
                            else focus -= 3;
                        }
                    }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,external:{after:'<div class="after"></div>',before:undefined}}); //
        ...
        function goBack(keyBack){
            ...
            if(typeof iPanel != 'undefined' && blocked == focusable.length - 1 && focus == 0 && iPanel.eventFrame.systemId ) {
            ...
            switch(item.playType){
                ...
                case 0://去掉基本包检验 baseFlag=0
                    if( iPanel.eventFrame.systemId === 2 ) {
                        iPanelGatewayHelper.play(String(item.id)); return;
                    } else {
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-10-13.jpg') no-repeat;" onUnload="exit();"></body>
</html>