...
<%
    ...
    final String[] types = {"10000100000000090000000000105782"};
...
<head>
    <title>职场不相信眼泪</title>
    <style>
        .mask {width:213px;height:33px;position:absolute;background:transparent url('images/mask-2015-12-24.png') no-repeat fixed;background-position: 0px -320px;}
        .mask1 {left:634px;top:257px;}
        .mask2 {left:634px;top:297px;}
        .mask3 {left:634px;top:337px;}
        .mask4 {left:634px;top:377px;}
        .mask5 {left:634px;top:417px;}
        .mask6 {left:634px;top:457px;}
        .mask7 {left:634px;top:497px;}
        .mask8 {left:634px;top:537px;}
        .mask9 {left:890px;top:257px;}
        .mask10 {left:890px;top:297px;}
        .mask11 {left:890px;top:337px;}
        .mask12 {left:890px;top:377px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked === 0 && ( ( focus == 0 || focus == 8 ) && index == 11 || focus == 7 && index == -11 || focus <= 7 && index == -1 || focus >= 8 && index == 1) ) return;
                    if( blocked == 0 ) {
                        ...
                        blocked = 0;
                        focus = index == -1 ? 7 : focusable[blocked].items.length - 1;
                        if( focus > focusable[blocked].items.length - 1) focus = focusable[blocked].items.length - 1;
                    }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:'<div style="position:absolute;width:432px;height:309px;left:643px;top:259px;background:translate url(images/mask-2015-12-24.png)"></div>',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-12-24.jpg') no-repeat;" onUnload="exit();"></body>
</html>