...
<%
    ...
    final String[] types = {"10000100000000090000000000105000"};
...
<head>
    <title>穿越烧脑大集合</title>
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-03-20.png') no-repeat fixed;background-position: 0px 0px;}

        .mask1 {width:168px;height:30px;background-position:-67px -275px;left:125px; top:462px;}
        .mask2 {width:123px;height:29px;background-position:-93px -320px;left:151px; top:507px;}
        .mask3 {width:146px;height:29px;background-position:-78px -364px;left:136px; top:551px;}
        .mask4 {width:309px;height:29px;background-position:0px -408px;left:58px; top:595px;}
        .mask5 {width:193px;height:257px;background-position:0px 0px;left:418px; top:38px;}
        .mask6 {width:193px;height:257px;background-position:0px 0px;left:625px; top:38px;}
        .mask7 {width:193px;height:257px;background-position:0px 0px;left:831px; top:38px;}
        .mask8 {width:193px;height:257px;background-position:0px 0px;left:1038px; top:38px;}
        .mask9 {width:193px;height:257px;background-position:0px 0px;left:418px; top:315px;}
        .mask10 {width:193px;height:257px;background-position:0px 0px;left:625px; top:315px;}
        .mask11 {width:193px;height:257px;background-position:0px 0px;left:831px; top:315px;}
        .mask12 {width:193px;height:257px;background-position:0px 0px;left:1038px; top:315px;}
        ...
        function focused(index,initilized){
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked == 0 && (focus < 4 && index == -1 || focus >=4 && ( focus < 8 && index == 11 || focus >= 8 && focus != focusable[0].items.length -1 && index == -11 || (focus == 7 || focus == focusable[0].items.length -1 ) && index == 1 ) || focus == 0 && index == 11 || focus == 3 && index == -11 ) ) return;
                    if( blocked == focusable.length - 1) { blocked = 0; focus = focusable[blocked].items.length - 1; }
                    else if( blocked == 0 ){
                        if( focus < 4 ) {
                            if( index == 1 ){
                                saved[0] = focus;
                            ...
                            if( index == 11 || index == -11 ) {
                                ...
                                if( ( focus == 4 || focus == 8 ) && index == -1 ) { saved[1] = focus; focus = saved[0]; }
                                else focus += index;
                            }
                        }
                    }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-03-20.jpg') no-repeat;" onUnload="exit();"></body>
</html>