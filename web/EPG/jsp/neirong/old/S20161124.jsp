...
<%
    ...
    final String[] types = {"10000100000000090000000000106924"};
...
<head>
    ...
    <style>
        ...
        .flowed {width:1200px;left:96px;top:363px;height:245px;overflow:hidden;position: absolute;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2016-11-24.jpg') no-repeat;" onUnload="exit();"></body>
</html>