...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2015-06-24.png') no-repeat fixed;background-position: 0px 0px;}
        .mask1 {width:295px;height:192px;left:41px;top:409px; background-position: 0px -30px;}
        .mask2 {width:295px;height:192px;left:341px;top:409px; background-position: 0px -30px;}
        .mask3 {width:295px;height:192px;left:641px;top:409px; background-position: 0px -30px;}
        .mask4 {width:295px;height:192px;left:941px;top:409px; background-position: 0px -30px;}

        .maskLink {width:210px;height:50px;left:1005px;top:349px;background-position: -400px -30px;}
        .maskRole {width:193px;height:28px;left:677px;top:612px;background-position: -650px -30px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [//点击立即进入TVB专区
            { focus:0,items : [{name:'中奖名单',style:'mask maskLink',playType:-3,link:'/EPG/jsp/neirong/S20150624-1.jsp'}]},
            <%
            value = "";
            ...
            %>
            { focus:0,items : [{name:'点击立即进入TVB专区',style:'mask maskRole',playType:-3,link:'http://chongqingtvb-utc.wasu.cn/index.jsp'}]},
            ...
            if(typeof index == "number" && !initilized){
                ...
                if( index == 1 && ( !$.vote.tooltiped && blocked == focusable.length - 2 && focus == 1 || blocked == focusable.length - 1 && focus == 0 ))
                    ...
                    if( blocked === 0 && index != -11 ||
                        ...
                        blocked === 1 && ( focus <= 0 && index == -1 || focus >= 3 && index == 1  || focus != 3 && index == 11 || focus <= 1 && index == -11 ) )
                    return;
                    if( blocked === 0 ) {
                        blocked = 1; focus = 3;
                    } else if( blocked === 2 ) {
                        if( index == 11 ) { blocked = 1; focus = 2; }
                        ...
                        else if( index === 11 ) { blocked = 0; focus = focusable[blocked].items.length - 1; }
                        else if( index === -11 ) { blocked = focus == 2 ? 2 : focusable.length - 1; focus = 0; }
                    }
                }
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:[{blocked:1,item:undefined,id: 219}],video:undefined,position:undefined,external:{after:'<div style="width:1026px;height:25px;position: absolute;left: 107px;top:564px;background:transparent url(images/mask-2015-06-24.png) no-repeat fixed 0px 0px;">',before:undefined}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2015-06-24.jpg') no-repeat;" onUnload="exit();"></body>
</html>