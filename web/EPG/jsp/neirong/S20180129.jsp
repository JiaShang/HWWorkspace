...
<%
    ...
    final String[] types = {"10000100000000090000000000109030"};
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function focused(index,initilized){
            ...
            document.body.style.backgroundImage = 'url("images/bg-2018-01-29-' + (focus + 1) + '.jpg")';
        }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2018-01-29-<%= focused + 1 %>.jpg') no-repeat;" onUnload="exit();"></body>
</html>