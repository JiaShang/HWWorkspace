...
--%>
<%
    //乡愁故里 古镇偏岩 10000100000000090000000000112226
    ...
    bodyLeft = "images/bg-2019-08-02-left.jpg";
    bodyTop = "images/bg-2019-08-02-top.jpg";
    bodyRight = "images/bg-2019-08-02-right.jpg";
    bodyBottom = "images/bg-2019-08-02-bottom.jpg";
...
<head>
    ...
    <style>
        ...
        .item{position:absolute;width:<%=itemWidth%>px;height:<%=itemHeight%>px;left:<%=markMarginRight + markWidth%>px;top:0px;text-align: left;font-size: <%=fontSize%>;line-height:<%=itemHeight - focusBorderWidth * 3 + 1%>px;color: <%=markColor%>; font-weight: bold }
        .itemPlayFocusedText,.itemPlayText,.itemFocusText,.itemText{width:<%= itemWidth - 30 %>px;padding:0px 8px;float: left;word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;overflow: hidden;font-weight: bold;}
