...
<%
    ...
    String picture = column == null ? "images/bg-2018-07-31-detail.jpg" : inner.pictureUrl("images/bg-2018-07-31-detail.jpg",column.getPosters(),"7");
...
<head>
    ...
    <style>
        ...
        .item .container,.focusItem .container{width:<%=w %>px;height:<%=ih %>px;overflow:hidden;background: transparent url('images/mask-2018-07-31-detail.png') no-repeat left top; background-position: 0px -150px;}
        ...
        .focusItem .container{color:#<%=fc%>; background-position: -30px -30px;}
        .item .container .inner,.focusItem .container .inner{margin:4px 0px 0px 10px;text-align: <%= al%>;}
        .focusItem .marquee{margin:0px 0px 0px 10px;font-size:<%=fs %>px;line-height:<%= ih-6 %>px;width: <%=w - 20%>}
        .scrollBar,#scrollBarContainer{position:absolute;width:6px;}
        .page,.count{width:30px;height:30px;font-size:20px;left:1053px;top:310px;position:absolute;overflow:hidden;color:white;text-align: center;}
        .count{top:340px;}
    </style>
