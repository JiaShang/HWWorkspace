...
<%
    ...
    infos.add(new ColumnInfo("10000100000000090000000000109366", 0, 0));
    infos.add(new ColumnInfo("10000100000000090000000000109368", 0, 99));
...
<head>
    ...
    <style>
        ...
        .mask21{width:231px;height:150px;left:562px;top:138px;}
        .mask22{width:231px;height:150px;left:788px;top:138px;}
        .mask23{width:231px;height:150px;left:1017px;top:138px;}
        .mask24{width:232px;height:160px;left:561px;top:306px;}
        .mask25{width:232px;height:160px;left:789px;top:306px;}
        .mask26{width:232px;height:160px;left:1018px;top:306px;}
...
<div style="background:transparent url('images/bg-2018-04-13.png') no-repeat;width:1280px;height:720px;left:0px;top:0px;position:absolute;"></div>
<div id='mask'></div>
    ...
    var initialize = {
        ...
        init        :   function(){
            ...
            var obj = { focus:this.focused.length > 1 ? Number( this.focused[1] ) : 0,items:
                [
                    {name:'塞事详请',linkto:'/EPG/jsp/neirong/S20180413Detail.jsp',style:'mask mask2 mask21'},
                    {name:'最美开州',linkto:'/EPG/jsp/neirong/S20180413Column.jsp?typeId=10000100000000090000000000109367&lt=580&tp=110&w=540&ih=39&mr=16&fs=22&hm=1&al=0&pg=10&bc=C51F00&fc=FFFFFF&cl=ffffff&sc=1160,110,530,8e8e8e,e03034',style:'mask mask2 mask22'},
                    {name:'感受马拉松乐趣',linkto:'/EPG/jsp/neirong/S20180413Act.jsp',style:'mask mask2 mask23'},
        ...
        counter : function(){
            var liveId = typeof iPanel.eventFrame.systemId === 'undefined' ? 408 : 407;
            var replayId = !cursor.focusable[0].items[0].replay ? (typeof iPanel.eventFrame.systemId === 'undefined' ? 410 : 409) : 0;
