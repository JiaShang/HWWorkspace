...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-09-11.jpg') no-repeat;" onUnload="exit();">
<div id="mask"></div>
...
<script language="javascript" type="text/javascript">
    ...
    var initialize = {
        ...
        init        :   function(){
            ...
            cursor.enabled = "2019-09-13 12:00:00" < now && now <= "2019-09-18 12:00:00" ;
            cursor.row = 2;
            cursor.column = 4;
            ...
            cursor.focusable[1] = {focus : 0 ,items:[ {name:'活动详情',linkto:'/EPG/jsp/neirong/S20190911Role.jsp'}]};
            cursor.call('show');
