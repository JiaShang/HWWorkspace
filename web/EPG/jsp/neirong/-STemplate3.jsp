...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var focusable = focusable ? focusable : [
            { focus:0,items : [{name:'活动细则',style:'mask maskRole',playType:-3,link:'/EPG/jsp/neirong/STemplate3Rule.jsp?typeId=<%= typeId%>'}]},
            <%
            value = "";
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:[1],popup:undefined,vote:[{blocked:1,item:undefined,id: <%= StringUtils.isEmpty(voteId) ? "-1" : voteId %>}],video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:'<div class="ruleNormal"></div><div class="backNormal"></div>'}});
