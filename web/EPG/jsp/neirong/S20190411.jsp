...
<%
    String typeId = "10000100000000090000000000111393";
    infos.add(new ColumnInfo(typeId, 0, 99));

    int vodId = 0;
    Vod vod = new Vod();
    List<Vod> vods = inner.getList("10000100000000090000000000111392",1,0,vod);
    if( vods != null && vods.size() > 0) {
        vodId = vods.get(0).getId();
    }

    Column column = inner.getDetail("10000100000000090000000000111391",new Column());
    String bodyLeft = "images/bg-2019-04-11-left.png",
           bodyTop = "images/bg-2019-03-22-top.jpg",
           bodyRight = "images/bg-2019-03-22-right.jpg",
           bodyBottom = "images/bg-2019-04-11-bottom.png";
    if( column != null ) {
...
<head>
    <title><%=column == null ? "巅峰对决权力回归" : column.getName()%></title>
    <style>
    ...
    var initialize = {
        ...
        showUI : function(){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                var item = items[i];
                var picture = cursor.pictureUrl(item.posters,2,'');
