...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        init : function(){
            ...
            var links = [
                {name:'流星花园',posters:{"1":["images/item-2018-06-22-1.jpg"]},linkto:'http://192.168.17.42:8100/cq_coshipdemo/detail.jsp?arg=3491703&resultUrl=http://192.168.17.42:8100/cq_coshipdemo/index.jsp'},
                {name:'忽而今夏',posters:{"1":["images/item-2018-06-22-2.jpg"]},linkto:'http://192.168.17.42:8100/cq_coshipdemo/detail.jsp?arg=3492483&resultUrl=http://192.168.17.42:8100/cq_coshipdemo/index.jsp'},
                {name:'致我们单纯的小美好',posters:{"1":["images/item-2018-06-22-3.jpg"]},linkto:'http://192.168.17.42:8100/cq_coshipdemo/detail.jsp?arg=3418758&resultUrl=http://192.168.17.42:8100/cq_coshipdemo/index.jsp'}
            ];
