...
<%
    ...
    bodyTop = inner.pictureUrl("images/bg-2018-09-30-top.jpg", column.getPosters(), "7",0 );
    bodyLeft = inner.pictureUrl("images/bg-2018-09-30-left.jpg", column.getPosters(), "7",1 );
    bodyRight = inner.pictureUrl("images/bg-2018-09-30-right.jpg", column.getPosters(), "7",2 );
    bodyBottom = inner.pictureUrl("images/bg-2018-09-30-bottom.jpg", column.getPosters(), "7",3 );
