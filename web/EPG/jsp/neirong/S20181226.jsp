...
<%
    ...
    bodyTop = inner.pictureUrl("images/bg-2018-12-26-top.jpg", column.getPosters(), "7",0 );
    bodyLeft = inner.pictureUrl("images/bg-2018-12-26-left.jpg", column.getPosters(), "7",1 );
    bodyRight = inner.pictureUrl("images/bg-2018-12-26-right.jpg", column.getPosters(), "7",2 );
    bodyBottom = inner.pictureUrl("images/bg-2018-12-26-bottom.jpg", column.getPosters(), "7",3 );
