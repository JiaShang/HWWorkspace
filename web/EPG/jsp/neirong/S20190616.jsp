...
<%
    ...
    String picture = column == null ? "images/bg-2019-06-16.png" : inner.pictureUrl("images/bg-2019-06-16.png",column.getPosters(),"7");
...
<head>
    ...
    <title><%=column == null ? "100张荣昌万灵古镇门票免费抢" : column.getName()%></title>
    <style>
    ...
    cursor.initialize({
        ...
        select:function(){
            ...
            if(blocked === cursor.voteBlocked ) {
                ...
                if( current >= '2019-07-01 00:00:00') {
