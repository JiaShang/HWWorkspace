...
<%
    String typeId = "10000100000000090000000000112549";
    List<Column> columns = inner.getList(typeId, 1, 0 , new Column());
    if( columns == null || columns.size() == 0 ){
        Column column = new Column();
        column.setId("10000100000000090000000000112550");
        columns.add(column);
    }

    Column column = inner.getDetail(typeId,new Column());
    String body = "images/bg-2019-09-09.png";
    ...
    var initialize = {
        data        : [<%
                ...
                for ( int i = 0; i < 1; i++) {
                    ...
                    result = inner.getVodList( info.getId(), 0, 6 );
        ...
        init        :   function(){
            ...
            cursor.focusable[1] = {
                focus : 0,
                items : [
                    {name : "交通", "linkto":"/EPG/jsp/neirong/S20190909Traf.jsp"},
                    {name : "场馆", "linkto":"/EPG/jsp/neirong/S20190909Area.jsp"}
                ]
            };
            cursor.focusable[2] = {
                focus : 0,
                items : [
                    {name : "走进文博", "linkto":"/EPG/jsp/neirong/S20190909Txt.jsp?typeId=10000100000000090000000000112551&index=2"},
                    {name : "文旅视界", "linkto":"/EPG/jsp/neirong/S20190909Txt.jsp?typeId=10000100000000090000000000112552&index=3"},
                    {name : "一元购", "linkto":"http://192.168.17.235:82/tgo?to=theme-activity?activityNo=1060&sp_code=wenbohui&backUrl=others"}
                ]
            };
            cursor.focusable[3] = {
                focus : 0,
                items : [
                    {name : "文博头条(更多)", "linkto":"/EPG/jsp/neirong/S20190909Txt.jsp?typeId=10000100000000090000000000112550&index=1"}
                ]
            };
