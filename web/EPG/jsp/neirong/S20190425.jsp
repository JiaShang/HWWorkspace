...
<%
    String typeId = "10000100000000090000000000111523";
    ...
    String body = "images/bg-2019-04-25.png";
...
<head>
    ...
    <style>
        ...
        .majorContainer,.majorContainerFocus{width:479px;height:59px;float: left;overflow: hidden;background:transparent url('images/mask-2019-04-25.png') no-repeat;background-position: 0px 0px;}
        ...
        .flowedContainer,.flowedContainerFocus{width:882px;height:63px;float:left;overflow: hidden;background:transparent url('images/mask-2019-04-25.png') no-repeat;background-position: 0px 0px;}
        ...
        .mask{position:absolute;background:transparent url('images/mask-2019-04-25.png') no-repeat;background-position: 0px 0px;}

        .mask1{width:151px;height:127px;background-position: -600px -700px;}
        .mask11{}
        .mask12{}
        .mask13{}
        .mask14{}
        ...
        .title{width:200px;height: 60px; position: absolute; left:250px;top:165px; background:transparent url('images/mask-2019-04-25.png') no-repeat;background-position: 0px 0px;}
        .title1{background-position: 0px -945px; }
        .title2{background-position: 0px -1020px; }
        .title3{background-position: -200px -945px; }
        .title4{background-position: -200px -1020px; }
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:transparent url('images/translateBg.png') no-repeat;"  onUnload="exit();">
    ...
    <div id="listBody" style="position:absolute;width:1280px;height:720px;left:0px;top:0px;overflow: hidden;">
        ...
        <div id='mask'></div>
        <div class='mask icons' id='icons' style="background-position:-450px -950px;"></div>
    </div>
...
<script language="javascript" type="text/javascript">
    ...
    var initialize = {
        ...
        showItems : function(blocked){
            ...
            if( blocked >= 2 ) {
                $("flowed").style.backgroundImage = 'url("images/focusBg-2019-04-25.jpg")';
