...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000109363";
...
<head>
    ...
    <style>
        ...
        .linkMask {position:absolute;width:164px;height:57px;left:978px;top:256PX;background: transparent url('images/mask-2018-04-14.png') no-repeat 0px 0px;}

        .focusBg {position: absolute;width:1280px;height:720px;left:0px;top:0px;background: transparent url('images/focusBg-2018-04-14.png') no-repeat 0px 0px;}
    </style>
    <script language="javascript" type="text/javascript" src="player/common.js"></script>
</head>
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2018-04-14.jpg') no-repeat;" onUnload="exit();">
<div id='flowed' class='flowed'></div>
<div id='mask' class='linkMask' style="visibility: hidden"></div>
<div id='focusBg' class='focusBg' style="visibility: hidden"></div>
</body>
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        move : function(index){
            ...
            if( blocked === 0 && ( index === -11 || index === -1 && focus <= 0 || index === 1 && focus + 1 >= items.length) || blocked == 1 && (index != -11 || cursor.dialogShowed)) return;
            if( blocked === 0 ) {
                if(index == 1 || index == -1){
                    focus += index;
                } else {
        ...
        select:function(){
            if( cursor.blocked === 1 ) {
                ...
                top.window.location.href = "http://sources.chid.biz/index.html";
                return;
            }
            cursor.call('selectAct');
        },
        goBack:function(){
            if( cursor.blocked === 1 && cursor.dialogShowed ) {
                cursor.dialogShowed = false;
