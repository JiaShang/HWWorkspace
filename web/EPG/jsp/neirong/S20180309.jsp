...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000109181";
...
<head>
    ...
    <style>
        ...
        .linkMask {position:absolute;width:301px;height:97px;left:585px;top:286PX;background: transparent url('images/mask-2018-03-09.png') no-repeat 0px 0px;}
    </style>
    <script language="javascript" type="text/javascript" src="player/common.js"></script>
</head>
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2018-03-09.jpg') no-repeat;" onUnload="exit();">
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        init : function(){
            ...
            cursor.focusable[i].items = [{name:"漫威宇宙之黑豹",linkto:'http://192.168.18.166:82/test.html'}];
            cursor.call('show');
        },
        move : function(index){
            //上 11，下 -11，左 -1，右 1
