...
<%
    ...
    String picture = column == null ? "images/bg-2019-03-20.png" : inner.pictureUrl("images/bg-2019-03-20.png",column.getPosters(),"7");
...
<head>
    ...
    <style>
        ...
        .mask{position:absolute;background: transparent url("images/mask-2019-03-20.png") no-repeat left top;}
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        showVoteTooltip : function(message){
            ...
            $("voteResultDialog").style.backgroundImage = 'url("images/forcusBg-2019-03-20-' + message + '.png")';
        ...
        select:function(){
            ...
            if(blocked === cursor.voteBlocked ) {
                ...
                if( current >= '2019-04-01 23:59:59') {
