...
<%
    ...
    bodyTop = inner.pictureUrl("images/bg-2019-01-31-top.jpg", column.getPosters(), "7",0 );
    bodyLeft = inner.pictureUrl("images/bg-2019-01-31-left.jpg", column.getPosters(), "7",1 );
    bodyRight = inner.pictureUrl("images/bg-2019-01-31-right.jpg", column.getPosters(), "7",2 );
    bodyBottom = inner.pictureUrl("images/bg-2019-01-31-bottom.jpg", column.getPosters(), "7",3 );
