...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000112768";
    ...
    String maskPic = column == null ? "" : inner.pictureUrl("images/mask-2019-09-30.png",column.getPosters(),"4");
    String[] sc = {};
...
<head>
    ...
    <style>
        ...
        .title{position:absolute;background: transparent url("<%=maskPic%>") no-repeat; background-position: 0px 0px;}
        .title1 {width:220px;height:72px;left:684px;top:71px;background-position: 0px 0px}
        .title2 {width:220px;height:72px;left:928px;top:71px;background-position: -250px 0px}

        .title1Focus {background-position: 0px -100px}
        .title2Focus {background-position: -250px -100px}
    </style>
...
<%}%>
    ...
    <div id="title2" class="title title2"></div>
    ...
    cursor.initialize({
        ...
        show:function(){
            ...
            if( blocked == 0 ) {
                ...
                $("title1").className = "title title1";
                $("title2").className = "title title2 title2Focus";
            }
            <% if( sc.length >= 5 ) { %>
