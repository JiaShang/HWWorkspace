...
<head>
    ...
    <style>
        .mask {width:59px;height:437px;top:214px;position:absolute;background:transparent url('images/mask-2019-07-01-Vote-1.png') no-repeat;background-position: -700px 0px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-07-01-3.jpg') no-repeat;" onUnload="exit();">
<div id="mask"></div>
