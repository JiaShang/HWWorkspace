...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000112047";
    infos.add(new ColumnInfo(typeId, 0, 199));
    //获取当前栏目的详细信息
    Column column = new Column();
    column = inner.getDetail(typeId,column);
    int voteId = inner.getInteger("VOTEID",0);
%>
<html>
<head>
    ...
    <style>
        .mask {width:59px;height:437px;top:214px;position:absolute;background:transparent url('images/mask-2019-07-01-Vote-2.png') no-repeat;background-position: -700px 0px;}
        .after {width:1170px;height:600px;left:83px;top:200px;position:absolute; background-position: 0px 500px; }
        .item {width:286px;height:249px;overflow:hidden;float: left;position:relative}
        ...
        .image {width:244px;height:130px;position:absolute;left:5px;top:5px;overflow: hidden;}
        ...
        .text .vote span{}
        .focusVote{width:256px;height:51px;background-position:-400px -200px;left:0px;top:181px;}
        .voteBtn{width:256px;height:51px;background-position:-700px -201px;left:0px;top:181px;overflow:hidden;}
        ...
        .mask1{width:148px;height: 63px;left:71px;top:113px;background-position: 0px -300px;}
        .tooltip{width: 1280px;height:720px;position:absolute;left:0px;top:0px;}
    </style>
    <script language="javascript" type="text/javascript" src="player/common.js"></script>
</head>
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-07-01-4.jpg') no-repeat;" onUnload="exit();">
<div id="mask"></div>
    ...
    var initialize = {
        data        : [<%
            ...
            for ( int i = 0; i < infos.size(); i++) {
                ...
                html += inner.resultToString(result).replaceAll("2019风云球王U9组-","");
        ...
        init        :   function(){
            ...
            cursor.enabled = now < "2019-07-13 23:59:59";
            cursor.row = 2;
            cursor.column = 4;
