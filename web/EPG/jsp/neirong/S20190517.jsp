...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000111721";
...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2019-05-17.png') no-repeat;background-position: 0px 0px;}
        ...
        .after{width:1143px;height:461px;left:69px;top:222px;position:absolute;background:transparent url('images/mask-2019-05-17.png') no-repeat;background-position: 0px 0px;}
    </style>
    <script language="javascript" type="text/javascript" src="player/common.js"></script>
</head>
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-05-17.jpg') no-repeat;" onUnload="exit();">
<div id="mask"></div>
