...
<head>
    ...
    <style>
        ...
        .focusItem .container{color:#<%=fc%>; background: url("shang/images/20191106focus.png");}
...
<div id= "bg" style="width:1280px;height:720px;left:0px;top:0px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(picture) ? "none" : (" url('" + picture + "')")%> no-repeat;"></div>
<%if( sc.length >= 5 ){%>
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        smallVideo: function () {
            ...
            cursor.fullmode = false;
            player.setPosition(65,238, 610,398);  //(x,y,width,height)  ,
        },
        select      :   function(){
            if( cursor.fullmode ) return;
            if( cursor.blocked === 1 && cursor.fullmode === false ) return cursor.call('fullVideo');
