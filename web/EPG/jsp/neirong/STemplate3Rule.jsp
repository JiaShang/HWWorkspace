...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function init(){
            ...
            $.buildUserInterface({flowed:undefined,popup:undefined,vote:undefined,video:undefined,position:undefined,gatewayCheck:undefined,external:{after:undefined,before:'<div class="backNormal"></div>'}});
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('<%= Utils.pictureUrl("", column.getPosters(), "7", 1 , request) %>') no-repeat;" onUnload="exit();"></body>
</html>