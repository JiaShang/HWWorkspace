...
<head>
    ...
    <style>
        ...
        .title{width:200px;height: 45px; position: absolute; left:100px;top:185px; background:transparent url('images/mask-2019-09-09.png') no-repeat;background-position: 0px 0px;}

        .flowedContainerFocus .item .marquee {width:985px;height:69px;line-height:60px;font-size: 24px;}
        .title1 {background-position: -400px 0px;}
        .title2 {background-position: -400px -50px;}
        .title3 {background-position: -400px -100px;}
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-09-09-txt.jpg') no-repeat;" onUnload="exit();">
