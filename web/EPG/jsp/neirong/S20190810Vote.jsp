...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000112320";
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2019-08-10-VoteBg.jpg') no-repeat;" onUnload="exit();">
<div id="mask"></div>
...
<script language="javascript" type="text/javascript">
    ...
    var initialize = {
        ...
        init        :   function(){
            ...
            cursor.focusable[1] = {focus : 0 ,items:[ {name:'活动详情',linkto:'/EPG/jsp/neirong/S20190815.jsp'}]};
        ...
        select : function(){
            ...
            if( blocked == 0 ) {
                ...
                if( now <= "2019-09-09 00:00:00") return cursor.call('showTooltip',1);
                if( now > "2019-10-01 23:59:59" ) return cursor.call('showTooltip',3);
                var focus = cursor.focusable[blocked].focus;
                var items = cursor.focusable[blocked].items;
        ...
        show        :   function(){
            ...
            for(var i = flowCursorIndex; i < flowCursorIndex + length; i += 1) {
                var item = items[i];
                html += '<div class="item">';
                html += '<div class="image"><img src="' + cursor.pictureUrl(item.posters,0,'images/defaultImg.png') + '"/></div>';
