...
<%
    String typeId = "10000100000000090000000000111441";
    ...
    String body = "images/bg-2019-04-17.png";
...
<head>
    ...
    <style>
        ...
        .majorContainer,.majorContainerFocus{width:479px;height:59px;float: left;overflow: hidden;background:transparent url('images/mask-2019-04-17.png') no-repeat;background-position: 0px 0px;}
        ...
        .flowedContainer,.flowedContainerFocus{width:882px;height:63px;float:left;overflow: hidden;background:transparent url('images/mask-2019-04-17.png') no-repeat;background-position: 0px 0px;}
        ...
        .mask{position:absolute;background:transparent url('images/mask-2019-04-17.png') no-repeat;background-position: 0px 0px;}

        .mask1{}
        .mask11{width:288px;height:127px;background-position: -600px -550px;}
        .mask12{width:151px;height:127px;background-position: -600px -700px;}
        .mask13{width:151px;height:127px;background-position: -600px -700px;}
        ...
        .title{width:1000px;height: 45px; position: absolute; left:250px;top:165px; background:transparent url('images/mask-2019-04-17.png') no-repeat;background-position: 0px 0px;}
        .title1{background-position: 0px -945px; }
        .title2{background-position: 0px -1000px; }
        .title3{background-position: 0px -1050px; }
...
<script language="javascript" type="text/javascript">
    ...
    var initialize = {
        ...
        showItems : function(blocked){
            ...
            if( blocked >= 2 ) {
                $("flowed").style.backgroundImage = 'url("images/focusBg-2019-04-17.jpg")';
