...
<%
    ...
    String picture = column == null ? "images/bg-2019-11-08-List.jpg" : inner.pictureUrl("images/bg-2019-11-08-List.jpg",column.getPosters(),"7");
...
<head>
    ...
    <style>
        ...
        .item .container,.focusItem .container{width:<%=w %>px;height:<%=ih %>px;overflow:hidden;background: transparent url("images/translateBg.png") no-repeat left top;}
        ...
        .focusItem {width:<%=w %>px;height:<%=ih + mr %>px; background: transparent url("images/mask-2019-11-08.png") no-repeat left top;background-position:  0 -646px;}
        ...
        .title{width:400px;height: 49px; position: absolute; left:132px;top:154px; background:transparent url('images/mask-2019-09-09.png') no-repeat;background-position: 0px 0px;}
    </style>
