...
<%
    ...
    bodyTop = inner.pictureUrl("images/bg-2018-11-05-top.jpg", column.getPosters(), "7",0 );
    bodyLeft = inner.pictureUrl("images/bg-2018-11-05-left.jpg", column.getPosters(), "7",1 );
    bodyRight = inner.pictureUrl("images/bg-2018-11-05-right.jpg", column.getPosters(), "7",2 );
    bodyBottom = inner.pictureUrl("images/bg-2018-11-05-bottom.jpg", column.getPosters(), "7",3 );
    ...
    var initialize = {
        ...
        init : function(){
            ...
            for( var i = 0 ; i < cursor.focusable[0].items.length; i ++){
                var txt = cursor.focusable[0].items[i].name.replace('为了民族复兴 英雄烈士谱——','');
