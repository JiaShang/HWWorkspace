...
<%
    String typeId = "10000100000000090000000000112780";
    ...
    var initialize = {
        ...
        init        :   function(){
            ...
            for( var i = 0;i < cursor.focusable[2].items.length; i ++ ){
                var link = "/EPG/jsp/neirong/S20190929Txt.jsp?typeId=" + cursor.focusable[2].items[i].id;
                cursor.focusable[2].items[i].linkto = link;
            }
            cursor.focusable[3] = {
                focus : 0,
                items : [
                    {name : "头条(更多)", "linkto":"/EPG/jsp/neirong/S20190929Txt.jsp?typeId=" + cursor.focusable[0].typeId}
                ]
            };
