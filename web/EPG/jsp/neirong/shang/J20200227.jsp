...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114126";
...
<div id="list">
    <div id="list0" class="list0">
        ...
        <div id="listName0" class="listName">爱在重庆有线</div>
    </div>
    <div id="list1" class="list0">
        <img id="listImg1" class="listImg"/>
        <div id="listName1" class="listName" style="left: 225px;">因为有爱</div>
    </div>
    <div id="list2" class="list0">
        <img id="listImg2" class="listImg"/>
        <div id="listName2" class="listName" style="left: 450px;">因为有家</div>
    </div>
    <div id="list3" class="list0">
        <img id="listImg3" class="listImg"/>
        <div id="listName3" class="listName" style="left: 675px;">因为有你</div>
    </div>
    <div id="list4" class="list0">
        <img id="listImg4" class="listImg"/>
        <div id="listName4" class="listName" style="left: 900px;">因为有心</div>
    </div>
</div>
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        move: function (index) {
            ...
            if (focus === 0) return;
            if (focus > 1 && index === -1 || focus < 5 && index === 1) {
