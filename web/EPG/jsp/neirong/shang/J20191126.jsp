...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000113303";
...
<div style="width:1280px;height:720px;left:0px;top:0px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(picture) ? "url(images/J20191126bg.png)" : (" url('" + picture + "')")%> no-repeat;"></div>
<%if( sc.length >= 5 ){%>
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        trafficNum      :function(){
            var url="http://192.168.18.249:8080/voteNew/external/clickCount.ipanel?icid="+iPanel.cardId+"&classifyID=470&content=1";
