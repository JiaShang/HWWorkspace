...
<%
    ...
    blockedCount = !isNumber( inner.get("blockedCount") ) ? 1 : Integer.valueOf(inner.get("blockedCount"));
    if(blockedCount == 1){
        infos.add(new ColumnInfo(typeId, 0, 99));
    }else {
        List<Column> columns = inner.getList(typeId, blockedCount, 0 , new Column());
