...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000116661";
    ...
    String picture = column == null ? "images/J20020803ListBg.jpg" : inner.pictureUrl("images/J20020803ListBg.jpg",column.getPosters(),"7");
//    picture = "images/J20020803ListBg.jpg";
%>
<html>
<head>
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        move : function(index){
            ...
            $('listName' + listBox.focusPos).style.color = "#000000";
        ...
        show:function(){
           ...
           // alert("listBox.focusPos==="+listBox.focusPos+",,,listBox.position==="+listBox.position);
            $("focus").style.top = String(listBox.focusPos*46+140)+"px";
            $('listName' + listBox.focusPos).style.color = "#ea0a03";
    ...
    function initList() {
        ...
        listBox.startShow();
        initScroll(listBox.dataSize,10,listBox.listPage)
    }
    -->
</script>
</head>
