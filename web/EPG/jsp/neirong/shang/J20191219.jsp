...
<%
    ...
    String picture = column == null ? "" : inner.pictureUrl("images/J20191219Bg.png",column.getPosters(),"7");
    String titlePic = "";
    String[] sc = {};
...
<%}%>
    <div id="title" style="width:467px;height:60px;left:125px;top:555px;position:absolute;overflow:hidden; background:transparent no-repeat;" ></div>
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        show:function(){
            ...
            $("title").style.backgroundImage = "url(images/J20191219Title"+String(blocked)+".png)";
            <% if( sc.length >= 5 ) { %>
