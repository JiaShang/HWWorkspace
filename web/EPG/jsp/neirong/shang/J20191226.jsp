...
<%
    ...
    if( isEmpty( picture ) ) {
        ...
        picture = isEmpty( picture ) ? "images/J20200305Bg.jpg" : "images/" + picture;
    }
   // picture = "images/J20191226Bg.jpg";
...
<head>
    ...
    <style>
        ...
        .page{width:100px;left:590px;top:690px;height:24px;font-size:24px; color:#<%=cl%>;text-align: center;line-height:20px;position:absolute;}
        .number{color:#<%=fc%>;}
    </style>
