...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function initList(){
            ...
            listBox = new showList(6,listData.length,0,127,window);
            listBox.showType =0 ;
...
<div id="focus" style="position: absolute;width: 319px;height: 197px;left: 148px;top: 178px; overflow:hidden; background: url('images/J20200414ListFocus.png') no-repeat; visibility: visible; z-index: 1;" ></div>
