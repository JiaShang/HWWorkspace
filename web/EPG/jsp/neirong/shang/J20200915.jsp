...
<div id="focus" style="position: absolute;width: 511px;height: 234px;left: 685px;top: 300px; overflow:hidden; background: url('images/J20200915Focus0.png') no-repeat;" ></div>
</body>
    ...
    cursor.initialize({
        ...
        init: function () {
            ...
            cursor.focusable[0].items[1] = {
                'name':'活动详情',
                'linkto':'/EPG/jsp/neirong/shang/Jpicture.jsp?typeId=10000100000000090000000000117947&direct=1'
            }
            cursor.call('show');
        ...
        show : function(){
            var focus = cursor.focusable[0].focus;
            $("focus").style.backgroundImage = "url(images/J20200915Focus"+String(focus)+".png)";
        }
    });
    -->
</script>
