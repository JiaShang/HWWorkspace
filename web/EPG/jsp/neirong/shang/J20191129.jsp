...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000113334";
...
<div id="bg" style="width:1280px;height:720px;left:0px;top:0px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(picture) ? "url()" : (" url(s)")%> no-repeat;"></div>
</body>
