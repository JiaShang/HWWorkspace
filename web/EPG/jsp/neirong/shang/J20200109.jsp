...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000113727";
...
<body leftmargin="0" topmargin="0" style="  overflow:hidden; background: transparent <%= isEmpty(picture) ? "url(images/J20200109Bg.jpg)":" url('" + picture + "')" %> no-repeat;" onUnload="exit();">
<div id="focus" style="position: absolute;width: 371px;height: 202px;left: 82px;top: 442px; overflow:hidden; background: url('images/J20200109Focus.png') no-repeat;visibility: hidden;" ></div>
<div id="data" style="position: absolute;width: 1096px;height: 214px;left: 90px;top: 420px; overflow:hidden; background: url('images/J20200109Data.png') no-repeat;" ></div>
</body>
    ...
    cursor.initialize({
        ...
        init: function () {
            ...
            cursor.focusable[1].items[0] = {
                'name':'查看图片',
                'linkto':'/EPG/jsp/neirong/shang/J20200109List.jsp?typeId=' + cursor.focusable[1].typeId
            }
            setTimeout(function(){
        ...
        show : function(){
            var blocked = cursor.blocked;
            $("focus").style.left = String(blocked*372+82)+"px";
        }
    });
    -->
</script>
