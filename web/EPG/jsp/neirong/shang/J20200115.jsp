...
<script language="javascript" type="text/javascript">
    ...
    show:function(){
        ...
        $("focus").style.top =String(listBox.focusPos*49+287)+"px";
...
<div id="focus" style="width:467px;height:37px;left:139px;top:288px;position:absolute;overflow:hidden; background:transparent url(images/J20200115Focus.png) no-repeat;" ></div>
