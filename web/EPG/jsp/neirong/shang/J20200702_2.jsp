        ...
        cursor.initialize({
            ...
            init: function () {
                ...
                cursor.focusable[0].items[3] = {
                    'name':'声临其境第三季',
                    'linkto':'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=5e07bfa3334d4bedac312eedb2d0e6e9'
                }
                cursor.focusable[0].items[4] = {
                    'name':'好玩的城市',
                    'linkto':'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=5b44160647e5f2a75e43db7e9ed4356e'
                }
