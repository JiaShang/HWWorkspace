            ...
            show : function(){
                for (var i = 0; i < row; i++) {
                    for (var j = 0; j < ct; j++) {
                        ...
                        $("list"+String(id)).style.top = <%=tp %>+i*(<%=ht + mh +60 %>)+"px";
        ...
        function initList(){
            ...
            listBox.haveData = function(List){
                if ( typeof listData[List.dataPos].posters == "undefined"){
                    ...
                    if (typeof listData[List.dataPos].posters['5'] != 'undefined'){   //海报图
                        $("listImg"+String(List.idPos)).src = listData[List.dataPos].posters['5'][0];
                    }else if (typeof listData[List.dataPos].posters['99'] != 'undefined'){   //广告图
                        $("listImg"+String(List.idPos)).src = listData[List.dataPos].posters['99'][0];
                    }else if (typeof listData[List.dataPos].posters['1'] != 'undefined'){   //其他图
