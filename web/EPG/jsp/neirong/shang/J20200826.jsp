...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000117320";
...
<div id="focus" style="position: absolute;width: 747px;height: 106px;left: 430px;top: 515px; overflow:hidden; background: url('images/J20200826Focus0.png') no-repeat;" ></div>
</body>
    ...
    cursor.initialize({
        ...
        init: function () {
            ...
            cursor.focusable[0].items[0] = {
                'name':'查看图片',
                'linkto':'/EPG/jsp/neirong/shang/J20200109List.jsp?typeId=' + cursor.focusable[0].typeId
            }
            cursor.call('show');
        },
        move : function(index){
        ...
        show : function(){
            var blocked = cursor.blocked;
            $("focus").style.backgroundImage = "url(images/J20200826Focus"+String(blocked)+".png)";
        }
    });
    -->
</script>
