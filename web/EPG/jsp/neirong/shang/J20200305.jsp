...
//    }
    ...
    String picture = column == null ? "" : inner.pictureUrl("images/J20200305Bg.png",column.getPosters(),"7");
//    picture = "images/J20200305Bg.png";
    String titlePic = "";
    String[] sc = {};
...
<script language="javascript" type="text/javascript">
    ...
    show:function(){
        ...
        $("focus").style.top =String(listBox.focusPos*56+290)+"px";
...
<div id="focus" style="width:493px;height:63px;left:90px;top:290px;position:absolute;overflow:hidden; background:transparent url(images/J20200305Focus.png) no-repeat;" ></div>
<div id="scrollLower" style="position: absolute;z-index: 1 ">
    <div id="scrollUpper" style="position: absolute; top: 0px; height: 100px;  width: 6px;z-index: 2;"></div>
</div>
