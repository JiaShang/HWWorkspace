...
<script language="javascript" type="text/javascript">
    ...
    nextVideo   :   function () {
        ...
        if(listBox.focusPos < 6 ){
            ...
            if(listBox.focusPos == 6){
                listBox.changeList(-6);
            }else if (listBox.focusPos == 7) {
            ...
            var item = cursor.focusable[blocked].items[listBox.position];
    ...
    prepareVideo : function(){
        ...
        if(cursor.playIndex == 7){
            var item = cursor.focusable[blocked].items[6];
        }else {
            var item = cursor.focusable[blocked].items[cursor.palyIndex];
        }
        cursor.call("playMovie",item);
    },
    ...
    move : function(index){
        ...
        cursor.moveTimer = setTimeout(function(){
            ...
            <% } else {%>
            var focus = cursor.focusable[blocked].focus;
            if( focus!=7 && (cursor.palyBlocked != blocked || cursor.playIndex != focus )) {
