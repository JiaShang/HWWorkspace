...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000116760";
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        init: function () {
            ...
            //     'name':'查看图片',
            //     'linkto':'http://125.62.26.188/goods-detail?prodNo=1300112171'
            // }

        },
        select: function () {
            // alert("iPanel.HD30Adv=="+iPanel.HD30Adv+",,,,HD30==="+HD30+",,,cursor.HD30==="+cursor.HD30);
            if (iPanel.HD30Adv || HD30){
                if (typeof cursor.focusable[0].items[0].posters != 'undefined' && typeof cursor.focusable[0].items[0].posters['99'] != 'undefined') {
                    var namePos = cursor.focusable[0].items[0].name.indexOf("&name=");
                    var name = cursor.focusable[0].items[0].name.substring(namePos + 6);
                    var linkTo = cursor.focusable[0].items[0].name.substring(0, namePos);
                    cursor.focusable[0].items[0] = {
                        'name': name,
                        'linkto': linkTo
                    };
                    ...
                    cursor.focusable[0].items[0] = {
                        'name':'3.0 链接',
                        'linkto':'http://125.62.26.188/goods-detail?prodNo=1300112492'
                    }
                }
            }else{
                cursor.focusable[0].items[0] = {
                    linkandr : "com.jlt.uhome,com.jlt.uhome.activity.ProxyActivity,data###109%0%0%0%1%0",
                    linkP60Apk :"-n com.jlt.uhome/.activity.ProxyActivity -e data 109%0%0%0%1%0"
                };
            }
