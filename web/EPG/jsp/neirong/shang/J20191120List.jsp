    ...
    cursor.initialize({
        ...
        switch (index) {
            ...
            case -1:    //左
                ...
                break;
            case 1:     //右
                if( listBox.focusPos != 2 && listBox.focusPos != 5){
                    listBox.changeList(1);
                }
                break;
        }
...
<body leftmargin="0" topmargin="0" style="  overflow:hidden; background: transparent url(images/J20191120ListBg.jpg) no-repeat;" onUnload="exit();">
...
<div id="scroll" style="position: absolute;width: 24px;height: 92px;left: 1206px;top: 150px; overflow:hidden; background: url('images/J20191120ListScroll.png') no-repeat; visibility: visible;" ></div>
<div id="enlargedPic" style="position: absolute;left: 0px; top: 0px;width: 1280px;height: 720px;visibility: hidden;overflow: hidden; background: transparent no-repeat; z-index: 2;"></div>
