...
<div id="focus" style="width:497px;height:72px;left:<%=focusLeft %>px;top:<%=focusTop %>px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(focusPic) ? "none" : (" url(images/J" + focusPic + "Focus.png)")%> no-repeat;" ></div>
