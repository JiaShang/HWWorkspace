...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114285";
    ...
    String rulePic = "";
    if( column != null ) {
        picture = inner.pictureUrl("images/J20200213Bg.jpg", column.getPosters(), "7");
        rulePic = inner.pictureUrl("images/J20200213Rule.jpg", column.getPosters(), "4");
    }
...
<head>
    ...
    <style>
        ...
        .listButton{
            ...
            color: #ffffff;
            font-size:22px;
            background: url("images/J20200213Praise0.png");
            overflow: hidden;
            text-align: left;
            line-height: 30px;
            padding-left: 10px;
    ...
    var startTime = new Date("2020-03-16 0:0:0").getTime();
    var endTime = new Date("2020-03-23 0:0:0").getTime();
    cursor.initialize({
        data: [<%
                String html = "";
        ...
        show : function(){
            ...
            if(cursor.blocked == 0){
                if (focusPic ==1 ){
                    ...
                    $("listButton"+String(listBox.focusPos)).style.backgroundImage = "url(images/J20200213Praise0.png)";
                    $("listButton"+String(listBox.focusPos)).style.color = "#ffffff";
                }else {
                    $("focus").style.visibility = "hidden";
                    $("listButton"+String(listBox.focusPos)).style.backgroundImage = "url(images/J20200213Praise1.png)";
                    $("listButton"+String(listBox.focusPos)).style.color = "#000000";
                }
                $("rule").style.backgroundImage = "url(images/J20200213Rule0.png)";
            }else {
                $("listButton"+String(listBox.focusPos)).style.backgroundImage = "url(images/J20200213Praise0.png)";
                $("rule").style.backgroundImage = "url(images/J20200213Rule1.png)";
                $("focus").style.visibility = "hidden";
                $("listButton"+String(listBox.focusPos)).style.color = "#ffffff";
            }
        },
    ...
    function initList(starPos){
        ...
        listBox.haveData = function(List){
            ...
            $("listButton"+List.idPos).style.backgroundImage = "url(images/J20200213Praise0.png)";
        }
...
<body leftmargin="0" topmargin="0" style="  overflow:hidden; background: transparent <%= isEmpty(picture) ? "url(images/J20200213Bg.jpg)" : (" url(" + picture + ")")%> no-repeat;" onUnload="exit();">
...
<div id="rule" style="position: absolute;left: 1000px; top: 135px;width: 141px;height: 34px;visibility: visible;overflow: hidden; background: url('images/J20200213Rule0.png') no-repeat;"></div>
