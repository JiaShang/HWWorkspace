...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114286";
...
<head>
    ...
    <style>
        .listName{
            position: absolute;
            color: #8b0000;
            /*background-image: url("images/J20200310_2Focus10.png");*/
            font-size:24px;
            overflow: hidden;
            line-height: 43px;
            width: 497px;
...
<body leftmargin="0" topmargin="0" style="  overflow:hidden; background: transparent <%= isEmpty(picture) ? "url(images/J20200310_2Bg.jpg)" : (" url('" + picture + "')")%> no-repeat;" onUnload="exit();">
<div id="list">
    <div id="list0" class="list0">
        <img id="listImg0" class="listImg"/>
        <div id="listName0" class="listName" style="background-image: url('images/J20200310_2Focus00.png');"></div>
    </div>
    <div id="list1" class="list0">
        <img id="listImg1" class="listImg"/>
        <div id="listName1" class="listName" style="top: 135px;background-image: url('images/J20200310_2Focus10.png');"></div>
    </div>
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        move: function (index) {
            ...
            if (focus === 0) return;
            if (focus == 2 && index === 11 || focus == 1 && index === -11) {
        ...
        show: function () {
            ...
            var focus = cursor.focusable[blocked].focus;
            $("listName"+String(focus-1)).style.backgroundImage = "url(images/J20200310_2Focus"+String(focus-1)+"1.png)";
            $("listName"+String(focus-1)).style.height = '89px';
        },
        loseFocus: function () {
            var blocked = cursor.blocked;
            var items = cursor.focusable[blocked].items;
            // if (items.length <= 0) return;
            var focus = cursor.focusable[blocked].focus;
            $("listName"+String(focus-1)).style.backgroundImage = "url(images/J20200310_2Focus"+String(focus-1)+"0.png)";
            $("listName"+String(focus-1)).style.height = '83px';
        },
        nextVideo: function () {
