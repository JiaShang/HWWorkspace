...
<%
    ...
    String picture = column == null ? "" : inner.pictureUrl("images/J20191226_3Bg.png",column.getPosters(),"7");
    //picture =  "images/J20191226_3Bg.png";
    String titlePic = "";
    String[] sc = {};
...
<div style="width:1280px;height:720px;left:0px;top:0px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(picture) ? "url(images/J20191219Bg.png)" : (" url('" + picture + "')")%> no-repeat;"></div>
<%if( sc.length >= 5 ){%>
    <div id='scrollBarContainer' class='scrollBarContainer'><div id='scrollBar'></div></div>
<%}%>
    <div id="title" style="width:446px;height:64px;left:145px;top:575px;position:absolute;overflow:hidden; background:transparent no-repeat;" ></div>
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        show:function(){
            ...
            $("title").style.backgroundImage = "url(images/J20191226_3Title"+String(blocked)+".png)";
            <% if( sc.length >= 5 ) { %>
