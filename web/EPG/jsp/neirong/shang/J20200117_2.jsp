    ...
    cursor.initialize({
        ...
        show:function(){
            ...
            if(listBox.focusPos<5){
                $("focus").style.top =String(listBox.focusPos*<%=ih + mr %>+240)+"px";
            }else {
                $("focus").style.top =String(listBox.focusPos*<%=ih + mr %>+244-listBox.focusPos)+"px";
            }
...
<div id="focus" style="width:467px;height:37px;left:137px;top:240px;position:absolute;overflow:hidden; background:transparent url(images/J20200115Focus.png) no-repeat;" ></div>
