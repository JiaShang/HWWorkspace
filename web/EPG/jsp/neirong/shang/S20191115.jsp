...
<%
    ...
    String maskPic = column == null ? "" : inner.pictureUrl("images/S20191115listPos.png",column.getPosters(),"4");
    String[] sc = {};
...
<head>
    ...
    <style>
        ...
        .title1 {width:468px;height:73px;left:684px;top:71px;background-position: 0px 0px}
        .title2 {width:468px;height:73px;left:928px;top:71px;background-position: -77px 0px}

        .title1Focus {background-position: 0px 0px}
        .title2Focus {background-position: -74px -228px}
    </style>
