...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000115741";
        ...
        cursor.initialize({
            ...
            init: function () {
                ...
                cursor.focusable[0].items[3] = {
                    'name':'快乐大本营 2020',
                    'linkto':'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=5e10ac572718753729436a8998a75acb'
                }
                cursor.focusable[0].items[4] = {
                    'name':'天天向上2020',
                    'linkto':'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=5e11eecf3bacb5d55e15bbb15dbcfefb'
                }
            ...
            show : function(){
                ...
                $("focus").style.left = String(98+listBox.focusPos*223)+"px";
            },
            getFocus : function(){
                var bc = "<%=bc %>";
                if( bc == "transparent"){
                ...
                $("focus").style.left = String(98+listBox.focusPos*222)+"px";
