...
<div id="list">
    <div id="list0" class="list">
        ...
        <div id="listName0" class="listName" style="left: 47px;"></div>
    </div>
    <div id="list1" class="list">
        <img id="listImg1" class="listImg"/>
        <div id="listName1" class="listName" style="left: 217px;"></div>
    </div>
    <div id="list2" class="list">
        <img id="listImg2" class="listImg"/>
        <div id="listName2" class="listName" style="left: 387px;"></div>
    </div>
    <div id="list3" class="list">
        <img id="listImg3" class="listImg"/>
        <div id="listName3" class="listName" style="left: 547px;"></div>
    </div>
    <div id="list4" class="list">
        <img id="listImg4" class="listImg"/>
        <div id="listName4" class="listName" style="left: 722px;"></div>
    </div>
    <div id="list5" class="list">
        <img id="listImg5" class="listImg" />
        <div id="listName5" class="listName" style="left: 889px;"></div>
    </div>
    <div id="list6" class="list" >
        <img id="listImg6" class="listImg" />
        <div id="listName6" class="listName" style="left: 1060px;"></div>
    </div>
</div>
</body>
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        if(blocked >=2 ){
            if( index == -11 || (index == -1 && focus <=0)  || (index == 1 && focus >= items.length-1)) return;
        }
