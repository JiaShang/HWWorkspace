...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000113904";
    ...
    String picture = column == null ? "" : inner.pictureUrl("images/J20200121_2Bg.png",column.getPosters(),"7");
    String titlePic = "";
    String[] sc = {};
...
<head>
    ...
    <style>
        ...
        .title{
            ...
            color: #f4bfc7;
            position: relative;
            background-image: url('images/J20200121_2Title0.png');
            font-size: 36px;
            text-align: center;
            overflow: hidden;
...
<script language="javascript" type="text/javascript">
    ...
    show:function(){
        ...
        $("title"+ String(blocked)).style.color = "#f4d9a4";
        $("title"+ String(blocked)).style.backgroundImage = "url(images/J20200121_2Title1.png)";
    ...
    loseFocus:function(){
        ...
        var items = cursor.focusable[blocked].items;
        if( items.length <= 0 ) return;
        $("title"+ String(blocked)).style.color = "#f4bfc7";
        $("title"+ String(blocked)).style.backgroundImage = "url(images/J20200121_2Title0.png)";
...
<div id="title" style="width:540px;height:72px;left:705px;top:85px;position:absolute;overflow:hidden; background:transparent no-repeat;" >
    <div id="title0" class="title" style="top: 0px;left: 0px;">相声小品</div>
    <div id="title1" class="title" style="top: -66px;left: 180px;">精彩歌曲</div>
    <div id="title2" class="title" style="top: -132px;left: 360px;">魔术杂技</div>
</div>
