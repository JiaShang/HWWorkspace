...
<%
    ...
    String picture = column == null ? "images/J20200623Bg.jpg" : inner.pictureUrl("",column.getPosters(),"7");
//    picture = "images/J20200623Bg.jpg";
    String[] sc = {};
    ...
    <script language="javascript" type="text/javascript">
        ...
        cursor.initialize({
            ...
            init: function () {
                ...
                //     'name':'向往的生活第四季',
                //     'linkto':'http://192.168.17.155/nn_cms/web_template/index.html?nns_page_name=movie_detail&nns_video_id=5eaebb552158401307b184628e646428'
                // }
            ...
            show : function(){
                ...
                if (listBox.focusPos == 0){
                    ...
                    $("focus1").style.left = String(98+(listBox.focusPos-1)*222)+"px";
                }
            },
            getFocus : function(){
                var bc = "<%=bc %>";
                ...
                if (listBox.focusPos == 0){
                    ...
                    $("focus0").style.visibility = "hidden";
                    $("focus1").style.visibility = "visible";
                    $("focus1").style.left = String(90+(listBox.focusPos-1)*254)+"px";
                }
            },
            loseFocus : function(){
                var bo = "<%=bo %>";
...
<div id="focus0" style="position: absolute;width: 130px;height: 150px;left: 90px;top: 285px; overflow:hidden; background: url('images/J20200623Focus0.png') no-repeat; visibility: hidden; z-index: 1;" ></div>
<div id="focus1" style="position: absolute;width: 230px;height: 137px;left: 90px;top: 458px; overflow:hidden; background: url('images/J20200623Focus1.png') no-repeat; visibility: hidden; z-index: 1;" ></div>
