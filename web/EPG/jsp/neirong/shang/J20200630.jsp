...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000115842";
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        cursor.initialize({
            ...
            show : function(){
                $("focus").style.left = String(165+(listBox.focusPos%3)*427)+"px";
                $("focus").style.top = String(290+Math.floor(listBox.focusPos/3)*270)+"px";
            },
        });
        function initList(){
...
<div id="focus" style="position: absolute;width:96px;height: 96px;left: 165px;top: 290px; overflow:hidden; background: url('images/J20200630_2Focus.png') no-repeat; visibility: visible; z-index: 1;" ></div>
