...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114141";
...
//    }
    ...
    String picture = column == null ? "" : inner.pictureUrl("images/J20200220Bg.png",column.getPosters(),"7");
//    picture = "images/J20200220Bg.png";
    String titlePic = "";
    String[] sc = {};
    Integer w = null, h = null, ih = null, fs = null, lft = null,tp = null,   pg = null, mr = null;
    ...
    pg = !isNumber( inner.get("pg") ) ? 6 : Integer.valueOf(inner.get("pg"));

    lft = !isNumber( inner.get("lft")) ? 73 : Integer.valueOf(inner.get("lft"));
...
<script language="javascript" type="text/javascript">
    ...
    move : function(index){
        ...
        if( index == 11 && listBox.position > 0){
            ...
            cursor.call('loseFocus');
            listBox.changeList(1);
        }else if(index == -1 && listBox.currPage > 1){
            cursor.call('loseFocus');
            listBox.changePage(-1);
        }else if(index == 1 && listBox.currPage < listBox.listPage){
            cursor.call('loseFocus');
            listBox.changePage(1);
        }
    ...
    show:function(){
        ...
        $("listName"+String(listBox.focusPos)).style.backgroundColor ="#ffff00";
        $("listName"+String(listBox.focusPos)).style.color ="#000000";
    ...
    loseFocus:function(){
        ...
        $("listName"+String(listBox.focusPos)).style.color ="#ffffff";
...
<div id="scrollLower" style="position: absolute;z-index: 1 ">
    <div id="scrollUpper" style="position: absolute; top: 0px; height: 80px;left: -12px; width: 25px;z-index: 2;"></div>
</div>
