...
<div id="bg" style="width:1280px;height:720px;left:0px;top:0px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(picture) ? "url(images/J20191114Button.png)" : (" url(images/J20191114Button.png)")%> no-repeat;"></div>
</body>
