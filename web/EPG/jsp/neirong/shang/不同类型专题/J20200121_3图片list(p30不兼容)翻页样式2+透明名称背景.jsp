...
<head>
    ...
    cursor.initialize({
        ...
        show : function(){
            ...
            $("listName"+ String(listBox.focusPos)).style.backgroundColor = "rgba(251,186,84,1)";
        },
        loseFocus : function(){
            $("list"+ String(listBox.focusPos)).style.backgroundColor = "transparent";
            $("listName"+ String(listBox.focusPos)).style.backgroundColor = "rgba(0,0,0,0.6)";
        },
    });
    function initList(){
        ...
        listBox.haveData = function(List){
            ...
            $("listName"+ String(List.idPos)).style.backgroundColor = "rgba(0,0,0,0.6)";
