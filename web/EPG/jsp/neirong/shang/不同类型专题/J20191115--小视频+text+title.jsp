...
<head>
    ...
    <style>
        ...
        .title1 {width:464px;height:73px;left:684px;top:71px;background-position: 0px 0px}
        .title2 {width:464px;height:73px;left:684px;top:71px;background-position: 0px -77px}
...
<%}%>
    <div id="title1" style="position: absolute;width: 468px;height: 73px;left: 684px;top: 71px; background: url('images/J20191115title0.png') no-repeat;" ></div>
    <div id="title2" ></div>
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        show:function(){
            ...
            $("title1").style.backgroundImage="url(images/J20191204title"+blocked+".png)";
