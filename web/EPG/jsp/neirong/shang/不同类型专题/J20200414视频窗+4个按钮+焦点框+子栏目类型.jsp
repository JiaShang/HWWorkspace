...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114655";
...
<div id="focus" style="width:247px;height:92px;left:147px;top:545px;position:absolute;overflow:hidden; background:transparent url(images/J20200414Focus.png) no-repeat;" ></div>
<div id="list">
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
            ...
            for (var i = 0; i < this.data.length; i++) {
                ...
                if( i != 0){
                    cursor.focusable[i].items[0]={
                        'linkto':'/EPG/jsp/neirong/shang/J20200414List.jsp?typeId=' + cursor.focusable[i].typeId+'&blocked='+i
                    };
                }
            }
            cursor.call('show');
        ...
        move: function (index) {
            ...
            if (blocked > 1 && index === -1 || blocked < 4 && index === 1) {
        ...
        show: function () {
            ...
            // var focus = cursor.focusable[blocked].focus;
            $("focus").style.left = String(147+245*(blocked-1))+"px";
        },
        loseFocus: function () {
            var blocked = cursor.blocked;
            var items = cursor.focusable[blocked].items;
