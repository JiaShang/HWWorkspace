...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114282";
    ...
    String picture = column == null ? "images/J20020310ListBg.jpg" : inner.pictureUrl("images/J20020310ListBg.jpg",column.getPosters(),"7");
%>
<html>
<head>
    ...
    cursor.initialize({
        ...
        show:function(){
           ...
           // alert("listBox.focusPos==="+listBox.focusPos+",,,listBox.position==="+listBox.position);
            $("focus").style.top = String(listBox.focusPos*52+270)+"px";
...
<div id="focus" style="position: absolute;width: 966px;height: 44px;left: 150px;top:270px;background:transparent url('images/J20191211ListFocus.png') no-repeat;overflow:hidden; visibility: visible;"></div>
<div id="scrollLower" style="position: absolute; left: 1140px; top: 240px; width: 5px; background-color: #325c8e; visibility: hidden; height: 380px;">
    <div id="scrollUpper" style="position: absolute; top: 0px; height: 100px; background-color: #0194da; width: 5px;z-index: 1;"></div>
</div>

<div id="list" style="position: absolute;width: 1000px;height: 400px;left: 70px;top: 250px;">
    <div id="list0" class="list" style="top: 15px;">
        <img id="listImg0" class="listImg"/>
        <div id="listName0" class="listName"></div>
    </div>
    <div id="list1" class="list" style="top: 66px;">
        <img id="listImg1" class="listImg"/>
        <div id="listName1" class="listName"></div>
    </div>
    <div id="list2" class="list" style="top: 117px;">
        <img id="listImg2" class="listImg"/>
        <div id="listName2" class="listName"></div>
    </div>
    <div id="list3" class="list" style="top: 171px;">
        <img id="listImg3" class="listImg"/>
        <div id="listName3" class="listName"></div>
    </div>
    <div id="list4" class="list" style="top: 221px;">
        <img id="listImg4" class="listImg"/>
        <div id="listName4" class="listName"></div>
    </div>
    <div id="list5" class="list" style="top: 275px;">
        <img id="listImg5" class="listImg"/>
        <div id="listName5" class="listName"></div>
    </div>s
    <div id="list6" class="list" style="top: 325px;">
        <img id="listImg6" class="listImg"/>
        <div id="listName6" class="listName"></div>
    </div>
    <div id="list7" class="list" style="top: 376px;">
