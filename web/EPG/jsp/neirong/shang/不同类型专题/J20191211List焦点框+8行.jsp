...
<%
    ...
    String picture = column == null ? "images/J20191211ListBg.png" : inner.pictureUrl("images/J20191211ListBg.png",column.getPosters(),"7");
%>
<html>
<head>
    ...
    cursor.initialize({
        ...
        show:function(){
           ...
           // alert("listBox.focusPos==="+listBox.focusPos+",,,listBox.position==="+listBox.position);
            $("focus").style.top = String(listBox.focusPos*47+250)+"px";
...
<div id="focus" style="position: absolute;width: 966px;height: 44px;left: 150px;top:250px;background:transparent url('images/J20191211ListFocus.png') no-repeat;overflow:hidden; visibility: visible;"></div>
<div id="scrollLower" style="position: absolute; left: 1140px; top: 240px; width: 5px; background-color: #c9d4db; visibility: hidden; height: 400px;">
    <div id="scrollUpper" style="position: absolute; top: 0px; height: 100px; background-color: #366c94; width: 5px;z-index: 1;"></div>
</div>

<div id="list" style="position: absolute;width: 1000px;height: 400px;left: 70px;top: 230px;">
