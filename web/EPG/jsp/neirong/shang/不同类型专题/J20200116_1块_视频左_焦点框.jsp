...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000113780";
...
//    }
    ...
    String picture = column == null ? "" : inner.pictureUrl("images/J20200115Bg.png",column.getPosters(),"7");
    //picture = "images/J20200115Bg.png";
    String titlePic = "";
    String[] sc = {};
    Integer scrollFlag = null;
    ...
    scrollFlag = !isNumber( inner.get("scrollFlag") ) ? 0 : Integer.valueOf(inner.get("scrollFlag"));
...
<script language="javascript" type="text/javascript">
    ...
    show:function(){
        ...
        $("focus").style.top =String(listBox.focusPos*<%=ih + mr %>+<%=tp-10%>)+"px";
...
<div id="focus" style="width:497px;height:72px;left:<%=lt-20%>px;top:<%=tp-10%>px;position:absolute;overflow:hidden; background:transparent url(images/J20200116Focus.png) no-repeat;" ></div>
