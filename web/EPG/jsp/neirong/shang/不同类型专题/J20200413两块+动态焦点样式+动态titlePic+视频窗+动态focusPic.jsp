...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114642";
    ...
    String[] sc = {};
    Integer w = null, h = null, ih = null, fs = null, lt = null,tp = null, pg = null, mr = null,blocked = null,focusLeft = null, focusTop = null,titleLeft = null, titleTop = null,titleStep = null, cat = null,maxTitleLen = null;
...
<div style="width:1280px;height:720px;left:0px;top:0px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(picture) ? "url(images/J20200413Bg.png)" : (" url('" + picture + "')")%> no-repeat;"></div>
<div id="title" style="width:500px;height:57px;left:<%=titleLeft %>px;top:<%=titleTop %>px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(titlePic) ? "none" : (" url(images/J" + titlePic + "Title"+blocked+".png)")%> no-repeat;visibility: hidden;" ></div>
<div id="focus" style="width:497px;height:72px;left:<%=focusLeft %>px;top:<%=focusTop %>px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(focusPic) ? "none" : (" url(images/J" + focusPic + "Focus.png)")%> no-repeat no-repeat;" ></div>
