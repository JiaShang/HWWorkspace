...
<div id="focus" style="position: absolute;width: 141px;height: 546px;left: 698px;top: 260px; overflow:hidden; background: url('images/J20200731Focus.png') no-repeat;" ></div>
<div id="focus1" style="position: absolute;width: 67px;height: 163px;left: 1173px;top: 105px; overflow:hidden; background: url('images/J20200731Focus1.png') no-repeat;" ></div>
        ...
        show: function () {
            ...
            if (focusArea == 0){
                if (blocked == 0){
                    ...
                    $("focus").style.left = String(698+134*(blocked-1))+"px";
                }
