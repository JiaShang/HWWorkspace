...
<script language="javascript" type="text/javascript">
    ...
    show:function(){
        ...
        $("focus").style.top =String(listBox.focusPos*60+147)+"px";
...
<div id="focus" style="width:497px;height:72px;left:705px;top:147px;position:absolute;overflow:hidden; background:transparent url(images/J20200303Focus.png) no-repeat;" ></div>
