...
<script language="javascript" type="text/javascript">
    ...
    function initList() {
        ...
        listBox = new showList(16, listData.length, focus, 127, window);
        listBox.showType = 1;
        ...
        listBox.startShow();
        initScroll(listBox.dataSize,16,listBox.listPage);
