...
<script language="javascript" type="text/javascript">
    ...
    var endHour = 22;
    var endMin = 0;
    var startDay = "2020-08-25";
    var endDay = "2020-09-29";
    <%--var blocked = <%= blocked%>;--%>
    cursor.initialize({
        data : [<%
            String html = "";
...
<div id="tooltip" style="position: absolute;left: 0px; top: 0px;width: 1280px;height: 720px;visibility: visible;overflow: hidden; background: no-repeat;z-index: 2;">
    ...
    <div id="phone" style="position: absolute;left: 420px; top: 305px;width: 400px;height: 50px;visibility: visible;overflow: hidden; background: no-repeat;z-index: 2;color: #ffffff;font-size: 26px;">
    </div>
