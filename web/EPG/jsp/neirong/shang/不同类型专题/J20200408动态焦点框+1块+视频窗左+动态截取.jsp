...
<%
    ...
    if( isEmpty(typeId ) ) typeId = "10000100000000090000000000114202";
...
//    String focusPic = "";
    String[] sc = {};
    Integer w = null, h = null, ih = null, fs = null, lt = null,tp = null,   pg = null, mr = null,   focusLeft = null, focusTop = null, cat = null,maxTitleLen = null;
    String cl = null, bc = null,fc = null,bg=null,al=null,hm = null,focusPic = null;
    ...
    sc = isEmpty( inner.get( "sc" )) ? new String[5] : inner.get("sc").split("\\,");

    pg = isEmpty( inner.get("pg") ) ? list.get(0).size() : Integer.valueOf( inner.get("pg") );
    focusPic = isEmpty( inner.get("focusPic") ) ? "20200326" : inner.get("focusPic");
...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        show:function(){
            ...
            $("focus").style.top =String(listBox.focusPos*(<%=ih %>+<%=mr %>)+<%=focusTop %>)+"px";
...
<div id="title" style="width:440px;height:72px;left:685px;top:75px;position:absolute;overflow:hidden; background:transparent no-repeat;visibility: hidden;" ></div>
<div id="focus" style="width:497px;height:72px;left:<%=focusLeft %>px;top:<%=focusTop %>px;position:absolute;overflow:hidden; background:transparent <%= isEmpty(focusPic) ? "images/J20200303Focus.png" : (" url(images/J" + focusPic + "Focus.png)")%> no-repeat;" ></div>
...
<div id="list" style="position: absolute;width: <%=w %>px;height:<%= h %>px;left: <%=lt%>px;top: <%=tp%>px;">
    ...
    <div id="list8" class="list" style="top: 387px;">
