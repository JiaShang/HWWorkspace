...
<head>
    ...
    <style>
        .mask {position:absolute;background:transparent url('images/mask-2018-01-19.png') no-repeat;background-position: 0px 0px;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        var voteSwitch = "2018-12-25 09:00:00" <= currentDate && currentDate < "2018-12-29 12:00:00";
        ...
        function init(){
            ...
            $.vote = function (){
                ...
                if( blocked == focusable.length - 1 && focusable[focusable.length - 1].focus == focusable[focusable.length - 1].items.length - 1 ) { goBack(); return; }
                    ...
                    //投票，每天投指定票数，每个限投N票
                    //addVote6.ipanel?icid=1111111111&phone=00000000000&classifyID=400&content="+wrapContent+"&voteCount=10&contentNum=1
...
<body leftmargin="0" topmargin="0" style="overflow:hidden; background:black url('images/bg-2018-01-19.jpg') no-repeat;" onUnload="exit();"></body>
</html>