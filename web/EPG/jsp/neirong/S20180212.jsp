...
<script language="javascript" type="text/javascript">
    ...
    cursor.initialize({
        ...
        init : function(){
            ...
            var links = [
                {name:'拜见宫主大人',posters:{"1":["images/item-2018-02-12-1.jpg"]},linkto:'http://192.168.17.57:9888/sohuepg/detail?id=806&type=TVDRAMA&source=ak'},
                {name:'火星研究院',posters:{"1":["images/item-2018-02-12-2.jpg"]},linkto:'http://192.168.17.74/youku/search_load.htm?vodId=PACKAGEP201711000001-youku'},
                {name:'小手牵小狗 2017',posters:{"1":["images/item-2018-02-12-3.jpg"]},linkto:'http://192.168.17.74/youku/search_load.htm?vodId=PACKAGEP201708000816-youku'},
                {name:'花儿与少年3·冒险季',posters:{"1":["images/item-2018-02-12-4.jpg"]},linkto:'http://192.168.17.74/youku/search_load.htm?vodId=PACKAGEP201705000241-youku'}
            ]
